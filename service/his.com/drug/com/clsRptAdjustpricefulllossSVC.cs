...
namespace com.digitalwave.iCare.middletier.MedicineStoreService
{
    ...
    [ObjectPooling(true)]
    public class clsRptAdjustpricefulllossSVC : com.digitalwave.iCare.middletier.clsMiddleTierBase
    {
        #region 获取药库名称
        /// <summary>
        /// 获取药库名称
        ...
        public long m_mthGetStorageName(out DataTable m_objTable)
        {
            ...
            string strSql = @"select a.medstorename_vchr storagename,a.deptid_chr medstoreid from t_bse_medstore a
                              union all
                              select b.storagename_vchr storagename,b.storageid_chr medstoreid from t_bse_storage b";
            try
            {
        ...
        public long m_mthSelectAdjustprice(DateTime strBegin, DateTime strEnd, string m_strStorageid, string m_strTypeid, string strMedid, out DataTable m_dtResult)
        {
                    ...
                    if (string.IsNullOrEmpty(strMedid))
                    {
                        strSql = @"select 1 usebyds,i.medicineid_chr,h.medstorename_vchr storagename,g.medicinename_vch,
                         ...
                         union all
                            ...
                            select 0 usebyds,d.medicineid_chr,c.storagename_vchr storagename,b.medicinename_vch,
                                   b.medspec_vchr,b.opunit_vchr,d.productorid_chr,
                                   
                                   0 opoldretailprice_int,
                                   0 opnewretailprice_int,
                                   0 packqty_dec,
                                   0 ipcurrentgross_int,
                                   
                                   b.currentgross_int,b.oldretailprice_int oldprice,
                                   b.newretailprice_int newprice,
                                   a.examdate_dat,b.reason_vchr
                            from t_ms_adjustprice a,t_ms_adjustprice_detail b,t_bse_storage c,
                                 t_bse_medicine d,t_aid_medicinetype e
            ...
            else if (m_strStorageid == "0001" || m_strStorageid == "0002")
            {
                if (m_strTypeid == "0000")
                {
                    if (string.IsNullOrEmpty(strMedid))
                    {
                        strSql = @"select 0 usebyds,d.medicineid_chr,c.storagename_vchr storagename,b.medicinename_vch,
                                   b.medspec_vchr,b.opunit_vchr,d.productorid_chr,
