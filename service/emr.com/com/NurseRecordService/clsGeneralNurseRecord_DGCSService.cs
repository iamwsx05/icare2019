...
namespace com.digitalwave.clsGeneralNurseRecord_DGCSService
{
    /// <summary>
    ...
    [ObjectPooling(true)]
    public class clsGeneralNurseRecord_DGCSService : clsDiseaseTrackService
    {
        public clsGeneralNurseRecord_DGCSService()
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        #region SQL语句
        /// <summary>
        /// 从generalnurserecord_dgcsrecord获取指定病人的所有没有删除记录的时间。
        ...
        private const string c_strGetTimeListSQL = @"select createDate, opendate
														from generalnurserecord_dgcsrecord
													where inpatientid = ?
														and inpatientdate = ?
														and status = 0";

        /// <summary>
        /// 从generalnurserecord_dgcsrecord中获取指定时间的表单,获取已经存在记录的主要信息
        ...
        /// <summary>
        /// 从generalnurserecord_dgcsrecord获取删除表单的主要信息。
        /// </summary>
        ...
        /// <summary>
        /// 添加记录到generalnurserecord_dgcsrecord
        /// </summary>
        private const string c_strAddNewRecordSQL = @"insert into  generalnurserecord_dgcsrecord
                        ...
                        recorddate,sequence_int) 
						values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
							   ?,?,?,?,?)";//25

        /// <summary>
        /// 添加记录到generalnurserecord_dgcscontent
        /// </summary>
        private const string c_strAddNewRecordContentSQL = @"insert into  generalnurserecord_dgcscontent
        ...
        private const string c_strAddNewEductionInfoSQL = @"insert into nurserecordeductioninfo
                        ...
                        values(?,?,?,?,?,?,?,?,?,?)";
        /// <summary>
        /// 修改记录到generalnurserecord_dgcsrecord
        /// </summary>
        private const string c_strModifyRecordSQL = @"update generalnurserecord_dgcsrecord 
			set temperature=?,temperaturexml=?,heartrate=?,heartratexml=?,respiration=?,
				respirationxml=?,bloodpress=?,bloodpressxml=?,spo2=?,spo2xml=?,
                mind=?,custom=?,customxml=?,customname=?,sequence_int=?
				where inpatientid=? and inpatientdate=? and opendate=? and status=0";//18

        /// <summary>
        /// 修改记录到generalnurserecord_dgcscontent
        /// </summary>
        private const string c_strModifyRecordContentSQL = c_strAddNewRecordContentSQL;


        /// <summary>
        /// 设置generalnurserecord_dgcsrecord中删除记录的信息
        /// </summary>
        private const string c_strDeleteRecordSQL = @"update generalnurserecord_dgcsrecord
        ...
        private const string c_strDeleteInceptSQL = @"update nurserecordinceptinfo
													...
													where inpatientid = ?
														...
														and status = 1";
        /// <summary>
        /// 更新generalnurserecord_dgcsrecord中FirstPrintDate
        /// </summary>
        private const string c_strUpdateFirstPrintDateSQL = @"update generalnurserecord_dgcsrecord
																set firstprintdate = ?
															where inpatientid = ?
																and inpatientdate = ?
																and opendate = ?
        ...
        /// <summary>
        /// 从generalnurserecord_dgcsrecord获取指定病人的所有指定删除者删除的记录时间。
        ...
        /// <summary>
        /// 从generalnurserecord_dgcsrecord获取指定病人的所有已经删除的记录时间。
        /// 用 InPatientID ,InPatientDate ,Status = 1 查得所有可用的CreateDate和OpenDate时间
        /// </summary>
            ...
            out clsTrackRecordContent p_objRecordContent)
        {
            ...
            string c_strGetRecordContentSQL = @"select t1.inpatientid,
                                                           ...
                                                           t2.mind_right,
                                                           t2.custom_right
                                                      from generalnurserecord_dgcsrecord t1, generalnurserecord_dgcscontent t2
                                                     where t1.inpatientid = t2.inpatientid
                                                       ...
                                                       and t2.modifydate = (select max(modifydate)
                                                                              from generalnurserecord_dgcscontent
  ...
  from nurserecordeductioninfo where inpatientid = ? and inpatientdate =? and opendate =? and formid =? and status = 1";
            ...
            try
            {
                ...
                objDPArr1[3].Value = "frmGeneralNurseRecord_DGCSRec";
                ...
                objDPArr2[3].Value = "frmGeneralNurseRecord_DGCSRec";
                //生成DataTable
                DataTable dtbValue = new DataTable();
                ...
                {
                    #region 设置结果
                    clsGeneralNurseRecordContent_DGCS objRecordContent = new clsGeneralNurseRecordContent_DGCS();
            ...
            clsHRPTableService p_objHRPServ)
        {
            ...
            clsGeneralNurseRecordContent_DGCS objRecordContent = (clsGeneralNurseRecordContent_DGCS)p_objRecordContent;
            try
            {
                //获取IDataParameter数组
                IDataParameter[] objDPArr = null;
                p_objHRPServ.CreateDatabaseParameter(25, out objDPArr);
                ...
                objDPArr[20].Value = objRecordContent.m_strCUSTOM;
                objDPArr[21].Value = objRecordContent.m_strCUSTOMXML;
                objDPArr[22].Value = objRecordContent.m_strCUSTOMNAME;
                objDPArr[23].DbType = DbType.DateTime;
                objDPArr[23].Value = objRecordContent.m_dtmRECORDDATE;
                objDPArr[24].Value = lngSequence.ToString();
                ...
                IDataParameter[] objDPArr2 = null;
                p_objHRPServ.CreateDatabaseParameter(12, out objDPArr2);
                ...
                objDPArr2[11].Value = objRecordContent.m_strCUSTOM_RIGHT;
            ...
            out clsPreModifyInfo p_objModifyInfo)
        {
            ...
            /// </summary>
            string c_strCheckLastModifyRecordSQL = clsDatabaseSQLConvert.s_StrTop1 + @" t2.modifydate,t2.modifyuserid from generalnurserecord_dgcsrecord t1,generalnurserecord_dgcscontent t2
            ...
            clsHRPTableService p_objHRPServ)
        {
            ...
            try
            {
                ...
                //获取IDataParameter数组
                IDataParameter[] objDPArr = null;
                p_objHRPServ.CreateDatabaseParameter(18, out objDPArr);
                ...
                objDPArr[11].Value = objRecordContent.m_strCUSTOM;
                objDPArr[12].Value = objRecordContent.m_strCUSTOMXML;
                objDPArr[13].Value = objRecordContent.m_strCUSTOMNAME;
                objDPArr[14].Value = lngSequence;
                objDPArr[15].Value = objRecordContent.m_strInPatientID;
                objDPArr[16].DbType = DbType.DateTime;
                objDPArr[16].Value = objRecordContent.m_dtmInPatientDate;
                objDPArr[17].DbType = DbType.DateTime;
                objDPArr[17].Value = objRecordContent.m_dtmOpenDate;
            ...
            out string p_strFirstPrintDate)
        {
            ...
            /// </summary>
            string c_strGetModifyDateAndFirstPrintDateSQL = clsDatabaseSQLConvert.s_StrTop1 + @" a.firstprintdate,b.modifydate from generalnurserecord_dgcsrecord a,
					generalnurserecord_dgcscontent b where inpatientid = ? and a.inpatientdate= ? and a.opendate= ? and 
            ...
            string p_strColumnName)
        {
            ...
            try
            {
                string strSQL = @"update generalnurserecord_dgcsrecord set " + p_strColumnIndex + @"=? 
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngUpdateDetail(clsGeneralNurseRecordContent_DGCSDetail p_objRecordContent,
            clsHRPTableService p_objHRPServ)
        {
            //检查参数                              
            if (p_objRecordContent == null || p_objRecordContent.m_strINPATIENTID == null || p_objHRPServ == null)
            ...
            try
            {
                string strSQL = @"update generalnurserecord_dgcsdetail 
        ...
        public long m_lngGetDetail(DateTime dtmRecordDate, string strInPatientID, out string strRecordContent, out string strRecordCotentXML)
        {
            ...
            try
            {
                string strSQL = @"select t.recordcontent_right, t.recordcontentxml
									from generalnurserecord_dgcsdetail t
								where recorddate = ?
									and inpatientid = ?
									and status = 0";
                //获取IDataParameter数组
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngAddNewDetail(clsGeneralNurseRecordContent_DGCSDetail p_objRecordContent)
        {
            //检查参数                              
            ...
            try
            {
                string strSQL = @"insert into generalnurserecord_dgcsdetail (inpatientid,inpatientdate,opendate,
        ...
        /// <returns></returns>
        [AutoComplete]
        public long m_lngModifyDetail(clsGeneralNurseRecordContent_DGCSDetail p_objRecordContent)
        {
            long lngRes = 0;
            clsHRPTableService p_objHRPServ = new clsHRPTableService();
            try
            {
                ...
                if (p_objRecordContent == null || p_objRecordContent.m_strINPATIENTID == null)
                    return (long)enmOperationResult.Parameter_Error;
                string strSQL = @"update generalnurserecord_dgcsdetail set opendate=?,
        ...
        public long m_lngGetRecordContent(string p_strInPatientID, string p_strInPatientDate, string p_strRecordDate,
            out clsGeneralNurseRecordContent_DGCSDetail p_objRecordContent)
        {
            long lngRes = 0;
            p_objRecordContent = null;
            clsHRPTableService p_objHRPServ = new clsHRPTableService();
            try
            {
                ...
                if (lngRes > 0 && dtbValue.Rows.Count == 1)
                {
                    p_objRecordContent = new clsGeneralNurseRecordContent_DGCSDetail();
            ...
            string p_strDelID)
        {
            ...
            try
            {
                string strSQL = @" update generalnurserecord_dgcsdetail set status=1,deactiveddate=?,deactivedoperatorid=?
