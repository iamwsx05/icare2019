...
namespace com.digitalwave.DiseaseTrackService
{
 ...
 public   class clsEMR_intbloodsugarwatchServ : clsDiseaseTrackService
    {
        #region SQL语句
        /// <summary>
        /// 从T_EMR_intbloodsugarwatch获取指定病人的所有没有删除记录的时间。
 ...
 where t.registerid_chr = ?
   and t.status_int = 1";
        ...
        /// <summary>
        /// 从T_EMR_intbloodsugarwatch中获取指定时间的表单,获取已经存在记录的主要信息
 ...
 where t.registerid_chr = ?
   ...
   and t.status_int = 1";
        ...
        /// <summary>
        /// 从t_emr_intbloodsugarwatch获取删除表单的主要信息。
