...
namespace com.digitalwave.clsRecordsService
{
    ...
    [ObjectPooling(true)]
    public class clsGeneralNurseRecord_DGCSMainService : clsRecordsService
    {
        public clsGeneralNurseRecord_DGCSMainService()
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        private const string c_strGetRecordContentSQL = @"select f_getempnamebyno(t1.createuserid) as createusername,												    
                                                                   ...
                                                                   t3.mind_right,
                                                                   t3.custom_right
														from generalnurserecord_dgcsrecord t1,
															 generalnurserecord_dgcscontent t3
 ...
 order by t.recorddate";
        ...
        public long m_lngGetRecordContent(string p_strInPatientID,
            ...
            out clsGeneralNurseRecordContent_DGCS[] p_objTansDataInfo)
        {
            ...
            try
            {
                ...
                {
                    p_objTansDataInfo = new clsGeneralNurseRecordContent_DGCS[dtbValue.Rows.Count];
                    clsGeneralNurseRecordContent_DGCS objRecordContent = null;
                    ...
                    for (int j = 0; j < dtbValue.Rows.Count; j++)
                    {
                        ...
                        while (j < dtbValue.Rows.Count && DateTime.Parse(dtbValue.Rows[j]["OPENDATE_MAIN"].ToString()).Date == dtmOpenDate)
                        {
                            ...
                            objRecordContent = new clsGeneralNurseRecordContent_DGCS();
        ...
        {
            clsGeneralNurseRecordContent_DGCS[] p_objGeneralNurseRecordArr = null;
            clsGeneralNurseRecordContent_DGCSDetail[] p_objGeneralNurseDetailArr = null;
            ...
            if (p_strInPatientID == null || p_strInPatientID == "" || p_strInPatientDate == null || p_strInPatientDate == "" || p_objHRPServ == null)
                return (long)enmOperationResult.Parameter_Error;
            clsGeneralNurseRecordContent_DGCSDataInfo objDataInfo = new clsGeneralNurseRecordContent_DGCSDataInfo();
            ...
            try
            {
                ...
                objDPArr1[2].Value = "frmGeneralNurseRecord_DGCSRec";
                ...
                objDPArr3[2].Value = "frmGeneralNurseRecord_DGCSRec";
                #endregion 
                ...
                if (lngRes > 0 && dtbContent.Rows.Count > 0)
                {
                    ...
                    //签名一次查出加快速度。
                    long lngdd = m_lngGetSignOne(dinosaurs, p_strInPatientID.Trim(), p_strInPatientDate, "generalnurserecord_dgcsrecord", out sing);
                    ...
                    p_objGeneralNurseRecordArr = new clsGeneralNurseRecordContent_DGCS[dtbContent.Rows.Count];
                    for (int i = 0; i < dtbContent.Rows.Count; i++)
                    {
                        ...
                        //objDPArr3[3].Value = "frmGeneralNurseRecord_DGCSRec";
                ...
                {
                    clsGeneralNurseRecordContent_DGCSDetail objDetail = null;
                    p_objGeneralNurseDetailArr = new clsGeneralNurseRecordContent_DGCSDetail[dtbDetail.Rows.Count];
                    ...
                    //签名一次查出加快速度。
                    long lngdd = m_lngGetSignOne(dinosaursDetail, p_strInPatientID.Trim(), p_strInPatientDate, "generalnurserecord_dgcsdetail", out singDetail);
                    #endregion 
                    ...
                    {
                        objDetail = new clsGeneralNurseRecordContent_DGCSDetail();
                ...
                {
                    objDataInfo.m_objRecordContent = new clsGeneralNurseRecordContent_DGCS();
            ...
            out clsPreModifyInfo p_objModifyInfo)
        {
            ...
            string strSQL = clsDatabaseSQLConvert.s_StrTop1 + @" t2.modifydate,t2.modifyuserid from 
											generalnurserecord_dgcsrecord t1,generalnurserecord_dgcscontent t2
