...
namespace com.digitalwave.clsGeneralNurseRecordWK_CSService
{
    /// <summary>
    /// 一般患者护理记录(茶山外科)
    /// </summary>
    ...
    [ObjectPooling(true)]
    public class clsGeneralNurseRecordWK_CSService : clsDiseaseTrackService
    {
        public clsGeneralNurseRecordWK_CSService()
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        #region SQL语句
        /// <summary>
        /// 从generalnurserecordwk_csrecord获取指定病人的所有没有删除记录的时间。
        ...
        /// <summary>
        /// 从generalnurserecordwk_csrecord中获取指定时间的表单,获取已经存在记录的主要信息
        ...
        /// <summary>
        /// 从generalnurserecordwk_csrecord获取删除表单的主要信息。
        ...
        /// <summary>
        /// 添加记录到generalnurserecordwk_csrecord
        /// </summary>
        private const string c_strAddNewRecordSQL = @"insert into  generalnurserecordwk_csrecord
						...
						bloodpress,bloodpressxml,spo2,spo2xml,mind,
                        ...
                        custom2,custom2xml,custom2name,recorddate,sequence_int) 
						values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
							   ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";//38

        /// <summary>
        /// 添加记录到generalnurserecordwk_cscontent
        /// </summary>
        private const string c_strAddNewRecordContentSQL = @"insert into  generalnurserecordwk_cscontent
                        ...
                        spo2_right,mind_right,pupil_sizeleft_right,pupil_sizeright_right,
        ...
        private const string c_strAddNewEductionInfoSQL = @"insert into nurserecordeductioninfo
                        ...
                        values(?,?,?,?,?,?,?,?,?,?,?)";
        /// <summary>
        /// 修改记录到generalnurserecordwk_csrecord
        /// </summary>
        private const string c_strModifyRecordSQL = @"update generalnurserecordwk_csrecord 
			set temperature=?,temperaturexml=?,heartrate=?,heartratexml=?,respiration=?,
				respirationxml=?,bloodpress=?,bloodpressxml=?,spo2=?,spo2xml=?,
        ...
        /// <summary>
        /// 修改记录到generalnurserecordwk_cscontent
        /// </summary>
        private const string c_strModifyRecordContentSQL = c_strAddNewRecordContentSQL;

        /// <summary>
        /// 设置generalnurserecordwk_csrecord中删除记录的信息
        /// </summary>
        ...
        /// <summary>
        /// 更新generalnurserecordwk_csrecord中FirstPrintDate
        /// </summary>
        ...
        /// <summary>
        /// 从generalnurserecordwk_csrecord获取指定病人的所有指定删除者删除的记录时间。
        ...
        /// <summary>
        /// 从generalnurserecordwk_csrecord获取指定病人的所有已经删除的记录时间。
      ...
      t1.cap,
       ...
       t2.custom_right,
        t2.custom2_right
  from generalnurserecordwk_csrecord t1, generalnurserecordwk_cscontent t2
 where t1.inpatientid = t2.inpatientid
   ...
   and t2.modifydate = (select max(modifydate)
                          from generalnurserecordwk_cscontent
  ...
  from nurserecordeductioninfo where inpatientid = ? and inpatientdate =? and opendate =? and formid =? and status = 1";
            ...
            try
            {
                ...
                objDPArr2[3].Value = "frmGeneralNurseRecordWK_CSRec";
                //生成DataTable
                DataTable dtbValue = new DataTable();
            ...
            clsHRPTableService p_objHRPServ)
        {
            ...
            try
            {
                ...
                objDPArr[19].Value = objRecordContent.m_strMind;

                objDPArr[20].Value = objRecordContent.m_strPupilSizeLeft;
                objDPArr[21].Value = objRecordContent.m_strPupilSizeLeftXML;
                objDPArr[22].Value = objRecordContent.m_strPupilSizeRight;
                objDPArr[23].Value = objRecordContent.m_strPupilSizeRightXML;
                objDPArr[24].Value = objRecordContent.m_strPupilReflectLeft;
                objDPArr[25].Value = objRecordContent.m_strPupilReflectRight;               
                objDPArr[26].Value = objRecordContent.m_strPiWen;
                objDPArr[27].Value = objRecordContent.m_strColor;
                objDPArr[28].Value = objRecordContent.m_strZhangLi;
                objDPArr[29].Value = objRecordContent.m_strCap;
                objDPArr[30].Value = objRecordContent.m_strCUSTOM;
                objDPArr[31].Value = objRecordContent.m_strCUSTOMXML;
                objDPArr[32].Value = objRecordContent.m_strCUSTOMNAME;

                objDPArr[33].Value = objRecordContent.m_strCUSTOM2;
                objDPArr[34].Value = objRecordContent.m_strCUSTOM2XML;
                objDPArr[35].Value = objRecordContent.m_strCUSTOM2NAME;

                objDPArr[36].DbType = DbType.DateTime;
                objDPArr[36].Value = objRecordContent.m_dtmRECORDDATE;

                objDPArr[37].Value = lngSequence;
                ...
                IDataParameter[] objDPArr2 = null;
                p_objHRPServ.CreateDatabaseParameter(21, out objDPArr2);
                ...
                objDPArr2[15].Value = objRecordContent.m_strPiWen;
                objDPArr2[16].Value = objRecordContent.m_strColor;
                objDPArr2[17].Value = objRecordContent.m_strZhangLi;
                objDPArr2[18].Value = objRecordContent.m_strCap;
                objDPArr2[19].Value = objRecordContent.m_strCUSTOM_RIGHT;
                objDPArr2[20].Value = objRecordContent.m_strCUSTOM2_RIGHT;
                ...
                if (objRecordContent.m_objInpectArr != null)
                {
                    for (int i = 0; i < objRecordContent.m_objInpectArr.Length; i++)
                    {
                        ...
                        objDPArr3[2].Value = "frmGeneralNurseRecordWK_CSRec";
            ...
            out clsPreModifyInfo p_objModifyInfo)
        {
            ...
            /// </summary>
            string c_strCheckLastModifyRecordSQL = clsDatabaseSQLConvert.s_StrTop1 + @" t2.modifydate,t2.modifyuserid from generalnurserecordwk_csrecord t1,generalnurserecordwk_cscontent t2
            ...
            clsHRPTableService p_objHRPServ)
        {
            ...
            try
            {
                ...
                objDPArr[10].Value = objRecordContent.m_strMind;

                objDPArr[11].Value = objRecordContent.m_strPupilSizeLeft;
                objDPArr[12].Value = objRecordContent.m_strPupilSizeLeftXML;
                objDPArr[13].Value = objRecordContent.m_strPupilSizeRight;
                objDPArr[14].Value = objRecordContent.m_strPupilSizeRightXML;
                objDPArr[15].Value = objRecordContent.m_strPupilReflectLeft;
                objDPArr[16].Value = objRecordContent.m_strPupilReflectRight;

                objDPArr[17].Value = objRecordContent.m_strPiWen;
                objDPArr[18].Value = objRecordContent.m_strColor;
                objDPArr[19].Value = objRecordContent.m_strZhangLi;
                objDPArr[20].Value = objRecordContent.m_strCap;

                objDPArr[21].Value = objRecordContent.m_strCUSTOM;
                objDPArr[22].Value = objRecordContent.m_strCUSTOMXML;
                objDPArr[23].Value = objRecordContent.m_strCUSTOMNAME;

                objDPArr[24].Value = objRecordContent.m_strCUSTOM2;
                objDPArr[25].Value = objRecordContent.m_strCUSTOM2XML;
                objDPArr[26].Value = objRecordContent.m_strCUSTOM2NAME;
            ...
            out string p_strFirstPrintDate)
        {
            ...
            /// </summary>
            string c_strGetModifyDateAndFirstPrintDateSQL = clsDatabaseSQLConvert.s_StrTop1 + @" a.firstprintdate,b.modifydate from generalnurserecordwk_csrecord a,
					generalnurserecordwk_cscontent b where inpatientid = ? and a.inpatientdate= ? and a.opendate= ? and 
 ...
 where t1.inpatientid = t2.inpatientid
   ...
   and t2.modifydate = (select max(modifydate)
            ...
            string p_strColumnName)
        {
            ...
            try
            {
                string strSQL = @"update generalnurserecordwk_csrecord set " + p_strColumnIndex + @"=? 
            ...
            clsHRPTableService p_objHRPServ)
        {
            ...
            try
            {
                string strSQL = @"update generalnurserecordwk_csdetail 
        ...
        public long m_lngAddNewDetail(clsGeneralNurseRecordContent_CSDetail p_objRecordContent)
        {
            ...
            try
            {
                string strSQL = @"insert into generalnurserecordwk_csdetail (inpatientid,inpatientdate,opendate,
        ...
        public long m_lngModifyDetail(clsGeneralNurseRecordContent_CSDetail p_objRecordContent)
        {
            ...
            try
            {
                ...
                if (p_objRecordContent == null || p_objRecordContent.m_strINPATIENTID == null)
                    return (long)enmOperationResult.Parameter_Error;
                string strSQL = @"update generalnurserecordwk_csdetail set opendate=?,
            ...
            string p_strDelID)
        {
            ...
            try
            {
                string strSQL = @" update generalnurserecordwk_csdetail set status=1,deactiveddate=?,deactivedoperatorid=?
