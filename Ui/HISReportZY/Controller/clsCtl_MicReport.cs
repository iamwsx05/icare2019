                    ...
                    for (int i = 0; i < lstAntiApp.Count; i++)
                    {
                        ...
                        for (int iG = 0; iG < lstGSS.Count; iG++)
                        {
                            ...
                            if (drrAntiType.Length > 0)
                                sPer = (Convert.ToDecimal(drrAntiTypeS.Length) / drrAntiType.Length).ToString("0.00%");
                            if (drrAntiType.Length > 0)
                                mPer = (Convert.ToDecimal(drrAntiTypeM.Length) / drrAntiType.Length).ToString("0.00%");
                            if (drrAntiType.Length > 0)
                                rPer = (Convert.ToDecimal(drrAntiTypeR.Length) / drrAntiType.Length).ToString("0.00%");
