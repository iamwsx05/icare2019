...
{
	/// <summary>
	/// frmDeptDocWorkLoadNew 的摘要说明。
	/// </summary>
	public class frmDeptDocWorkLoadNew :com.digitalwave.GUI_Base.frmMDI_Child_Base
	{
		...
		{
			this.objController=new com.digitalwave.iCare.gui.HIS.clsControlDeptDocWorkLoadNew();
		...
		private void frmDoctorWorkLoadReport_Load(object sender, System.EventArgs e)
		{
			...
			m_cobType.SelectedIndex = 0;
			((clsControlDeptDocWorkLoadNew)this.objController).m_mthLoadDepartment();
		...
		{
			((clsControlDeptDocWorkLoadNew)this.objController).m_mthGetDocByDepID();
		}
		...
		private void btFind_Click(object sender, System.EventArgs e)
		{
			...
			//			{
			//			((clsControlDeptDocWorkLoadNew)this.objController).m_mthGetMultWorkLoadData(0);
			//			}
			//			if(this.radioButton4.Checked)
			//			{
			//				((clsControlDeptDocWorkLoadNew)this.objController).m_mthGetMultWorkLoadData(2);
			//			}
			this.myPrintPreViewControl1.Document=this.printDocument1;
		}
		...
		{
			((clsControlDeptDocWorkLoadNew)this.objController).m_mthPrint(e);
		}
		...
		private void printDocument1_BeginPrint(object sender, System.Drawing.Printing.PrintEventArgs e)
		{
			...
			((clsControlDeptDocWorkLoadNew)this.objController).m_mthBeginPrint();
		}
