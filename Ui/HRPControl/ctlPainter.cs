...
namespace com.digitalwave.Utility.Controls
{
	...
	/// 画图工具
	/// </summary>
	public class ctlPainter : System.Windows.Forms.UserControl
	{
		#region  Define
...
//		private bool m_blnCanResizeImage = true;
		...
		private System.Windows.Forms.PictureBox m_picMain;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ctlPainter));
			...
			this.m_picMain = new System.Windows.Forms.PictureBox();
			this.gpbTools.SuspendLayout();
			this.groupBox1.SuspendLayout();
			this.m_gpbEdit.SuspendLayout();
			this.m_pnlEdit.SuspendLayout();
			...
			// ppgPicSize
			// 
			this.ppgPicSize.CommandsBackColor = System.Drawing.Color.FromArgb(((System.Byte)(51)), ((System.Byte)(102)), ((System.Byte)(153)));
			this.ppgPicSize.CommandsForeColor = System.Drawing.SystemColors.ActiveCaptionText;
			this.ppgPicSize.CommandsVisibleIfAvailable = true;
			this.ppgPicSize.HelpVisible = false;
			this.ppgPicSize.LargeButtons = false;
			...
			this.ppgPicSize.Text = "propertyGrid1";
			this.ppgPicSize.ToolbarVisible = false;
			this.ppgPicSize.ViewBackColor = System.Drawing.Color.FromArgb(((System.Byte)(51)), ((System.Byte)(102)), ((System.Byte)(153)));
			...
			// m_cmdColor
			// 
			this.m_cmdColor.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(255)), ((System.Byte)(128)), ((System.Byte)(0)));
			...
			// imageIcon
			// 
			this.imageIcon.ImageSize = new System.Drawing.Size(24, 24);
			...
			this.m_gpbEdit.Size = new System.Drawing.Size(576, 420);
			...
			this.m_pnlEdit.Controls.Add(this.m_picMain);
			...
			this.m_pnlEdit.Size = new System.Drawing.Size(570, 395);
			...
			this.groupBox2.Controls.Add(this.gpbTools);
			this.groupBox2.Controls.Add(this.groupBox1);
			this.groupBox2.Controls.Add(this.m_gpbEdit);
			this.groupBox2.Dock = System.Windows.Forms.DockStyle.Fill;
			this.groupBox2.Font = new System.Drawing.Font("宋体", 12F);
			this.groupBox2.ForeColor = System.Drawing.Color.Black;
			this.groupBox2.Location = new System.Drawing.Point(0, 0);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(592, 496);
			...
			// m_picMain
			// 
			this.m_picMain.BackColor = System.Drawing.Color.White;
			this.m_picMain.ContextMenu = this.ctmModify;
			this.m_picMain.Location = new System.Drawing.Point(20, 20);
			this.m_picMain.Name = "m_picMain";
			this.m_picMain.Size = new System.Drawing.Size(276, 284);
			this.m_picMain.TabIndex = 0;
			this.m_picMain.TabStop = false;
			this.m_picMain.Visible = false;
			this.m_picMain.Resize += new System.EventHandler(this.p_picSender_Resize);
			this.m_picMain.Paint += new System.Windows.Forms.PaintEventHandler(this.pic1_Paint);
			this.m_picMain.MouseUp += new System.Windows.Forms.MouseEventHandler(this.pic1_MouseUp);
			this.m_picMain.MouseMove += new System.Windows.Forms.MouseEventHandler(this.pic1_MouseMove);
			this.m_picMain.MouseDown += new System.Windows.Forms.MouseEventHandler(this.pic1_MouseDown);
			// 
			// ctlPainter
			// 
			...
			this.Name = "ctlPainter";
			this.Size = new System.Drawing.Size(592, 496);
			this.gpbTools.ResumeLayout(false);
			this.groupBox1.ResumeLayout(false);
			this.m_gpbEdit.ResumeLayout(false);
			this.m_pnlEdit.ResumeLayout(false);
...
//		[Description("设置当前图片"),DefaultValue( null ),DesignerSerializationVisibility( DesignerSerializationVisibility.Content )]
		...
		[Browsable(false)]
		public Image m_BmpCurImage
		{
//			get
//			{
//				return m_objGetPicValue();
//			}
			set
			{
				if(value != null)
				{
					m_intImageWidth = value.Width;
					m_intImageHeight = value.Height;
...
//				imgBack = new Bitmap(p_imgOriginal,m_intDefaultWidth,m_intDefaultHeight);
			...
			m_picMain.Tag = objPic;
			m_mthSetPicEvent(m_picMain,objPic);
			blnIfPaint = true;
			m_picMain.Invalidate();
		}
...
//			clsPictureBoxValue[] objPicValueArr = null;
			...
			m_arlPic.Clear();
			clsPictureBoxValue objPic = null;
//			foreach(Control ctlSub in m_pnlEdit.Controls)
//			{
//				if(ctlSub.GetType().Name=="PictureBox")
//				{					
					if(m_picMain.Tag!=null)
					{
						objPic = (clsPictureBoxValue)m_picMain.Tag;
						
						//将底图和面图合成
						Image imgTemp = new Bitmap(m_picMain.Width,m_picMain.Height);
...
//							g1.DrawImage(objPic.m_imgBack,0,0,objPic.intOriginalWidth,objPic.intOriginalHeight);
						...
						objPic.m_imgBack = new Bitmap(imgTemp,m_intImageWidth,m_intImageHeight);
						objPic.m_imgFront = null;
						objPic.m_bytImage = m_bytImageToBinary(objPic.m_imgBack);
						objPic.intHeight = m_intImageHeight;
						objPic.intWidth = m_intImageWidth;
						objPic.clrBack = m_picMain.BackColor;
//						m_arlPic.Add(objPic);
						g1.Dispose();
					}
//				}
