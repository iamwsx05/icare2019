...
{
    /// <summary>
    /// 检验数据采集控制类--读取文本模式 李泳潮 2012-01-12
    /// </summary>
   public class clsLISDataAcquisitionBase_TXT:infLISDataAcquisition_TXT
   {
       #region 变量
       ...
       #endregion
       public clsLISDataAcquisitionBase_TXT()
       {
           m_objLogger = new clsLogText();
           m_objDomain = new clsDcl_DataAcquisition();
       }
       #region infLISDataAcquisition_TXT 成员
       ...
       public clsLIS_Equip_DB_ConfigVO m_objDeviceConfigVO
        {
            ...
            set
            {
                ...
                {
                     //文件目录
                    m_strFilePath = _objDeviceConfigVO.strOTHER_PRAM_VCHR;
                }
            }
        }
         /// <summary>
        /// 所属窗体
        /// </summary>
        public System.Windows.Forms.Form m_frmParent
        {
            get
            {
                return _frmParent;
       ...
       /// <returns></returns>
        public long m_lngStartWork()
        {
            ...
            switch (m_objDeviceConfigVO.strONLINE_MODULE_CHR)
            {
                ...
                case"4":
                case"5":
                    if (string.IsNullOrEmpty(m_objDeviceConfigVO.strOTHER_PRAM_VCHR))
                    {
