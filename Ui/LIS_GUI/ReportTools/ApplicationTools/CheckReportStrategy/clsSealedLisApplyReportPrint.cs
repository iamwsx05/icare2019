...
namespace com.digitalwave.iCare.gui.LIS
{
    ...
    /// </summary>
    public class clsSealedLisApplyReportPrint
    {
        ...
        clsApplyReportPrintTool m_objReportPrint;
        ...
        #region 构造函数
        public clsSealedLisApplyReportPrint()
        {
            m_mthInit();
        }

        public clsSealedLisApplyReportPrint(string p_strApplicationID)
        {
            m_mthInit();
        ...
        private void m_mthInit()
        {
            ...
            { }
            m_objReportPrint = new clsApplyReportPrintTool();
        ...
        public void m_mthReport(int Moudle)
        {
            ...
            if (this.m_strBarCode != null && this.m_strBarCode.Trim() != "")
            {
                ...
                clsBarcodeBmp objBar = new clsBarcodeBmp();
                objBar.GetBarcode(this.m_strBarCode, BarcodeXStyle.Code128, out BmpFile);
            ...
            {
                ItemName = ItemName.Substring(0, 15) + @"~r~n" + ItemName.Substring(15);
            }
        ...
        void printDocBarcode_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            string bedNo = string.Empty;    // m_objReportInfo.m_strBedNO + "床";
