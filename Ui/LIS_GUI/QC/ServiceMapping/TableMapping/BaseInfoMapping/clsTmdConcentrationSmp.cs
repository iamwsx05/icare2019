...
{
    public class clsTmdConcentrationSmp
    {

        public static clsTmdConcentrationSmp s_object
        {
            get
            {
                return new clsTmdConcentrationSmp();
            }
        }
        ...
        public long m_lngFind(out clsLisConcentrationVO[] p_objRecordArr)
        {
            long lngRes = 0;
            p_objRecordArr = null;
            try
