...
namespace com.digitalwave.iCare.gui.LIS
{
    ...
    internal class frmHandInputReport : frmMDI_Child_Base
    {
        ...
        /// 发光MA 4000 是否启用双向
        /// </summary>
        bool isMAGLU4000TwoWay { get; set; }
        ...
        private void frmHandInputReport_Load(object sender, System.EventArgs e)
        {
            ...
            string parm6010 = clsPublic.m_strGetSysparm("6010");
            this.isMAGLU4000TwoWay = clsPublic.ConvertObjToDecimal(parm6010) == 1 ? true : false;
        ...
        private void m_mthShowDeviceRelation(clsLISInfoVO p_objInfo, bool p_blnForceImportData)
        {
            ...
            if (!string.IsNullOrEmpty(objInfo.m_objAppMainVO.m_strApplication_Form_NO) && objInfo.m_objAppMainVO.m_strApplication_Form_NO.StartsWith("57"))     // HJ500  
            {
                ...
                (this.isMAGLUMITwoWay && (objInfo.m_objAppMainVO.m_strApplication_Form_NO.StartsWith("65") || objInfo.m_objAppMainVO.m_strApplication_Form_NO.EndsWith("+65"))) ||
                (this.isMAGLU4000TwoWay && (objInfo.m_objAppMainVO.m_strApplication_Form_NO.StartsWith("56") || objInfo.m_objAppMainVO.m_strApplication_Form_NO.EndsWith("+56")))))    // Ottoman(59), AU680(51) MAGLUMI(65)
            {
                ...
                if (formNo.StartsWith("56"))
                {
                    isMA4000 = true;
                }
                if ((formNo.StartsWith("59") || formNo.StartsWith("51") || formNo.StartsWith("65") || formNo.StartsWith("56"))  && formNo.IndexOf('+') > 0)
                {
                ...
                else if (formNo.EndsWith("+56"))
                {
                    isMAGLUMI = true;
                    formNo = formNo.Replace("+56", "");
                }
            ...
            if (isMA4000 && isMAGLU4000TwoWay && isHaveData == false)
            {
                long lngRes = this.m_objController.m_lngGetDeviceRelationAndData(objInfo.m_objAppMainVO.m_strAPPLICATION_ID, objInfo.m_objSampleVO.m_intSTATUS_INT, p_blnForceImportData, out objDRVOArr);
                if (lngRes <= 0)
                {
