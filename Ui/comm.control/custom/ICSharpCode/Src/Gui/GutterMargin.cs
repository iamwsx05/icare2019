...
namespace ICSharpCode.TextEditor
{
	...
	public class GutterMargin : AbstractMargin, IDisposable
	{
		...
		static GutterMargin()
		{
            //Stream cursorStream = Assembly.GetCallingAssembly().GetManifestResourceStream("Common.Controls.Custom.ICSharpCode.Resources.RightArrow.cur");
            RightLeftCursor = Cursors.Cross; //new Cursor(cursorStream);
			//cursorStream.Close();
		}
