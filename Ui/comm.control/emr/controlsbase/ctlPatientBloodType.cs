...
namespace Common.Controls.Emr
{
    ...
    public class ctlPatientBloodType : ctlBasePatientInfoControl, IRuntimeDesignControl, IFormCtrl
    {
        public override EnumPatientInfoType InfoType
        {
            get
            {
                return EnumPatientInfoType.血型;
            }
        }
        ...
        /// 项目代码(名称)
        /// </summary>
        private string _ItemName = "PatientBloodType";
        /// <summary>
        /// 项目代码(名称)
        /// </summary>
        ...
        /// 项目标题(描述)
        /// </summary>
        private string _ItemCaption = "血型";
        /// <summary>
        /// 项目标题(描述)
        /// </summary>
