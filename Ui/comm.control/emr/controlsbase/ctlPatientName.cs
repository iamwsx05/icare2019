...
namespace Common.Controls.Emr
{
    ...
    public class ctlPatientName : ctlBasePatientInfoControl, IRuntimeDesignControl, IFormCtrl
    {
        public override EnumPatientInfoType InfoType
        {
            get
            {
                return EnumPatientInfoType.姓名;
            }
        }
        ...
        /// 项目代码(名称)
        /// </summary>
        private string _ItemName = "PatientName";
        /// <summary>
        /// 项目代码(名称)
        /// </summary>
        ...
        /// 项目标题(描述)
        /// </summary>
        private string _ItemCaption = "姓名";
        /// <summary>
        /// 项目标题(描述)
        /// </summary>
