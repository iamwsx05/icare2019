...
namespace Common.Controls.Emr
{
    ...
    public class ctlPatientHomeAddr : ctlBasePatientInfoControl, IRuntimeDesignControl, IFormCtrl
    {
        public override EnumPatientInfoType InfoType
        {
            get
            {
                return EnumPatientInfoType.家庭地址;
            }
        }
        ...
        /// 项目代码(名称)
        /// </summary>
        private string _ItemName = "PatientHomeAddr";
        /// <summary>
        /// 项目代码(名称)
        /// </summary>
        ...
        /// 项目标题(描述)
        /// </summary>
        private string _ItemCaption = "家庭地址";
        /// <summary>
        /// 项目标题(描述)
        /// </summary>
