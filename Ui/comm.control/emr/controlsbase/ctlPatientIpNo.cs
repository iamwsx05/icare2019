...
namespace Common.Controls.Emr
{
    ...
    public class ctlPatientIpNo : ctlBasePatientInfoControl, IRuntimeDesignControl, IFormCtrl
    {
        public override EnumPatientInfoType InfoType
        {
            get
            {
                return EnumPatientInfoType.住院号;
            }
        }
        ...
        /// 项目代码(名称)
        /// </summary>
        private string _ItemName = "PatientIpNo";
        /// <summary>
        /// 项目代码(名称)
        /// </summary>
        ...
        /// 项目标题(描述)
        /// </summary>
        private string _ItemCaption = "住院号";
        /// <summary>
        /// 项目标题(描述)
        /// </summary>
