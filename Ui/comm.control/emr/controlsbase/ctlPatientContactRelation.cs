...
namespace Common.Controls.Emr
{
    ...
    public class ctlPatientContactRelation : ctlBasePatientInfoControl, IRuntimeDesignControl, IFormCtrl
    {
        public override EnumPatientInfoType InfoType
        {
            get
            {
                return EnumPatientInfoType.与联系人关系;
            }
        }
        ...
        /// 项目代码(名称)
        /// </summary>
        private string _ItemName = "PatientContactRelation";
        /// <summary>
        /// 项目代码(名称)
        /// </summary>
        ...
        /// 项目标题(描述)
        /// </summary>
        private string _ItemCaption = "与联系人关系";
        /// <summary>
        /// 项目标题(描述)
        /// </summary>
