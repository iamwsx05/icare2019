...
namespace Common.Controls.Emr
{
    ...
    public class ctlPatientHeight : ctlBasePatientInfoControl, IRuntimeDesignControl, IFormCtrl
    {
        public override EnumPatientInfoType InfoType
        {
            get
            {
                return EnumPatientInfoType.身高;
            }
        }
        ...
        /// 项目代码(名称)
        /// </summary>
        private string _ItemName = "PatientHeight";
        /// <summary>
        /// 项目代码(名称)
        /// </summary>
        ...
        /// 项目标题(描述)
        /// </summary>
        private string _ItemCaption = "身高";
        /// <summary>
        /// 项目标题(描述)
        /// </summary>
