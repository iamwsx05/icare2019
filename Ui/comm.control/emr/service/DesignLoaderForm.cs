...
namespace Common.Controls.Emr
{
    ...
    /// 
    /// </summary>
    public class DesignLoaderForm : BasicDesignerLoader
    {
        IDesignerHost Host;
        ...
        public List<EntityFormCtrl> _data;

        public int InitWidth { get; set; }
        public int InitHeight { get; set; }
        public bool FormFlag { get; set; }

        public DesignLoaderForm(IDesignerHost host, List<EntityFormCtrl> data)
            : this(host, 0, -1, data)
        {

        }

        public DesignLoaderForm(IDesignerHost host, int templateControlFormID, int formversion, List<EntityFormCtrl> data)
        {
            Host = host;
            _data = data;
        ...
        public void PerformFlushWorker()
        {
            ...
            this._data = serService.Serialize(comps) as List<EntityFormCtrl>;
        }
        ...
        protected override void PerformLoad(IDesignerSerializationManager serializationManager)
        {
            try
            {
                ...
                {
                    EntityFormCtrl entityRoot = this._data.Find(i => i.ControlName.Contains(typeof(DesignPanel).Name));
                ...
                else
                {
                    ...
                    ctrlContainer.BackColor = (this.FormFlag ? Color.White : Color.FromArgb(9, 111, 133));
                }
                ...
                {
                    //导入模板控件
                    List<EntityFormCtrl> tempControl = null;// FormLoader.GetControls(_templateControlFormID, ref _formVersion);
                    CustomFormControlCreatorForm creator = new CustomFormControlCreatorForm();

                    List<IRuntimeDesignControl> t = new List<IRuntimeDesignControl>();
                    creator.CreateControls(0, ctrlContainer, tempControl, ref t);
                }
                #endregion
        ...
        public void Deserialize(List<EntityFormCtrl> data)
        {
            this._data = data;
        ...
        public List<EntityFormCtrl> Save()
        {
            GetSerializeData();
            this.Isdirty = false;
            this.Unsave = false;
        ...
        public List<EntityFormCtrl> GetSerializeData()
        {
