...
{
    public delegate void dlgHandleHostSizeChanged();
    ...
    internal class AutocompleteMenuHost : ToolStripDropDown
    {
        ...
        public event dlgHandleHostSizeChanged evtHostSizeChanged;
        ...
        public AutocompleteMenuHost(AutocompleteMenu menu)
        {
            ...
            this.SizeChanged += new EventHandler(AutocompleteMenuHost_SizeChanged);
        }

        void AutocompleteMenuHost_SizeChanged(object sender, EventArgs e)
        {
            if (evtHostSizeChanged != null)
            {
                evtHostSizeChanged();
            }
        }
