    ...
    public partial class ctlTreeSelectCheckPart : ctlTreeSelect
    {
        ...
        private void LoadData()
        {
            ...
            if (!DesignMode && this.DataSource == null)
            {
                ...
                this.Columns = cols;
                //this.SetToGridMode();
                this.DataSource = EntityTools.ConvertToDataTable<EntityCheckPart>(GlobalDic.DataSourceCheckPart);
            }
        }
        ...
        {
            DataTable dtNewSource = EntityTools.ConvertToDataTable<EntityCheckPart>(GlobalDic.DataSourceCheckPart);
