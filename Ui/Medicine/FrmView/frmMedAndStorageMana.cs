...
namespace com.digitalwave.iCare.gui.HIS
{
	...
	/// </summary>
	public class frmMedAndStorageMana :com.digitalwave.GUI_Base.frmMDI_Child_Base
	{
		...
		internal System.Windows.Forms.ComboBox m_cmbMedType;
		...
		private void InitializeComponent()
		{
			...
			this.m_cmbMedType = new System.Windows.Forms.ComboBox();
			...
			this.ctlDgMed.MultiSelect = true;
			...
			this.ctlDgMed.Size = new System.Drawing.Size(376, 576);
			...
			this.ctlDgStorageMed.MultiSelect = true;
			...
			this.ctlDgStorageMed.Size = new System.Drawing.Size(408, 576);
			...
			this.groupBox1.Controls.Add(this.m_cmbMedType);
			...
			// m_cmbMedType
			// 
			this.m_cmbMedType.Cursor = System.Windows.Forms.Cursors.Hand;
			this.m_cmbMedType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.m_cmbMedType.Location = new System.Drawing.Point(80, 24);
			this.m_cmbMedType.Name = "m_cmbMedType";
			this.m_cmbMedType.Size = new System.Drawing.Size(120, 22);
			this.m_cmbMedType.TabIndex = 76;
			// 
			// btnEsc
			// 
			...
			this.btnEsc.Hint = "";
			this.btnEsc.Location = new System.Drawing.Point(384, 528);
			...
			this.btnEsc.Text = "退出系统(&E)";
			this.btnEsc.Click += new System.EventHandler(this.btnEsc_Click);
			// 
			// checkBox1
			// 
			this.checkBox1.Location = new System.Drawing.Point(392, 272);
			this.checkBox1.Name = "checkBox1";
			this.checkBox1.Size = new System.Drawing.Size(200, 24);
			this.checkBox1.TabIndex = 76;
			this.checkBox1.Text = "不显示药库已经存在的药品";
			...
			this.buttonXP1.Hint = "";
			this.buttonXP1.Location = new System.Drawing.Point(384, 576);
			this.buttonXP1.Name = "buttonXP1";
			this.buttonXP1.Scheme = PinkieControls.ButtonXP.Schemes.Blue;
			this.buttonXP1.Size = new System.Drawing.Size(208, 32);
			this.buttonXP1.TabIndex = 77;
			this.buttonXP1.Text = "刷新数据(&R)";
			this.buttonXP1.Click += new System.EventHandler(this.buttonXP1_Click);
			// 
			// frmMedAndStorageMana
			// 
			...
			this.Name = "frmMedAndStorageMana";
			this.Text = "药库药品维护";
		...
		{
			this.objController=new com.digitalwave.iCare.gui.HIS.clsControlMedAddStorageMana();
			objController.Set_GUI_Apperance(this);
		}

		private void frmMedAndStorageMene_Load(object sender, System.EventArgs e)
		{
		    ((clsControlMedAddStorageMana)this.objController).m_lngFrmLoad();
		}

		private void btnFind_Click(object sender, System.EventArgs e)
		{
			checkBox1.Checked=false;
			((clsControlMedAddStorageMana)this.objController).m_lngFindData();
		}

		private void m_cboStorage_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			((clsControlMedAddStorageMana)this.objController).m_lngChangItem();
		}

		private void m_btnAddAll_Click(object sender, System.EventArgs e)
		{
			if(MessageBox.Show("确定将列表在所有药品增加到"+m_cboStorage.SelectedItem.ToString()+"？","",MessageBoxButtons.OKCancel)==DialogResult.OK)
			{
				((clsControlMedAddStorageMana)this.objController).m_lngAddNewAll();
			}
		}

		private void m_btnDelAll_Click(object sender, System.EventArgs e)
		{
			if(MessageBox.Show("确定将所有药品从"+m_cboStorage.SelectedItem.ToString()+"删除？","",MessageBoxButtons.OKCancel)==DialogResult.OK)
			{
				((clsControlMedAddStorageMana)this.objController).m_lngDelData();
			}
		}

		private void m_btnDel_Click(object sender, System.EventArgs e)
		{
			if(ctlDgStorageMed.RowCount>0)
			{
				if(MessageBox.Show("确定将选择的从"+m_cboStorage.SelectedItem.ToString()+"删除？","",MessageBoxButtons.OKCancel)==DialogResult.OK)
				{
					((clsControlMedAddStorageMana)this.objController).m_lngDeleOneFromStorage();
				}
			}
		}
		...
		{
			if(MessageBox.Show("确定将选择的增加到"+m_cboStorage.SelectedItem.ToString()+"？","",MessageBoxButtons.OKCancel)==DialogResult.OK)
			{
				((clsControlMedAddStorageMana)this.objController).m_lngAddNewNeoData();
			}
		...
		{
			((clsControlMedAddStorageMana)this.objController).m_lngReturnClick();
		}
		...
		private void checkBox1_CheckedChanged(object sender, System.EventArgs e)
		{
			if(checkBox1.Checked==true)
				((clsControlMedAddStorageMana)this.objController).m_mthNotShowAll();
			else
				((clsControlMedAddStorageMana)this.objController).m_mthShowAll();
		}
