...
{
    /// <summary>
    /// 茶山危重患者护理记录(内科、妇产科、普儿科、急诊科、手术室)主窗体
    /// </summary>
    public partial class frmGeneralNurseRecord_CS : iCare.frmRecordsBase
    {
        ...
        public frmGeneralNurseRecord_CS()
        {
            InitializeComponent();
        ...
        protected override void m_mthInitDataTable(DataTable p_dtbRecordTable)
        {
            ...
            p_dtbRecordTable.Columns.Add("Custom", typeof(clsDSTRichTextBoxValue));//21
            DataColumn dc3 = p_dtbRecordTable.Columns.Add("ExecuseSign");//22
            dc3.DefaultValue = "";
            p_dtbRecordTable.Columns.Add("Content", typeof(clsDSTRichTextBoxValue));//23
            p_dtbRecordTable.Columns.Add("DetailRecordTime");//24
            p_dtbRecordTable.Columns.Add("RecordAndDetailSign");//25
            //存放记录创建者ID
            p_dtbRecordTable.Columns.Add("CreateUserID");//26
        ...
        {
            return new clsRecordsDomain(enmRecordsType.GeneralNurseRecord_CSRec);
        }
            ...
            object[] p_objDataArr)
        {
            ...
            {
                case enmDiseaseTrackType.GeneralNurseRecord_CS:
            ...
            objContent.m_strCreateUserID = (string)p_objDataArr[26];

            return objContent;
        }

        private void frmGeneralNurseRecord_CS_Load(object sender, System.EventArgs e)
        {
            #region 添加右键菜单
        ...
        {
            frmGeneralNurseRecord_CSCon frmAddNewForm = (frmGeneralNurseRecord_CSCon)p_objSender;
            //显示窗体
        ...
        private void mniContentAdd_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                frmGeneralNurseRecord_CSCon frm = new frmGeneralNurseRecord_CSCon(true, m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), "2005");
        ...
        private void mniContentModify_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                //验证
                if (m_dtgRecordDetail.CurrentCell.ColumnNumber != 19)
                {
                ...
                //传递参数
                int intSelectedRecordStartRow = m_dtgRecordDetail.CurrentCell.RowNumber;
                string strRecordTime = (m_dtbRecords.Rows[intSelectedRecordStartRow][24]).ToString();
                if (strRecordTime.Trim().Length == 0)
                    return;
                //打开窗体
                frmGeneralNurseRecord_CSCon frm = new frmGeneralNurseRecord_CSCon(false, m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), strRecordTime);
                frm.Closed += new EventHandler(m_mthSubFormClosed);
                //更新
                //frm.TopMost = true;
                this.m_FrmCurrentSub = frm;
        ...
        private void mniContentDelete_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                string strDetailSign = (m_dtbRecords.Rows[intSelectedRecordStartRow][26]).ToString();
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_CSService_m_lngDeleteDetail(m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), strRecordTime, strDelTime, strDelID);
                //更新
                if (lngRes > 0)
                {
                    m_mthPerformSessionChanged(m_ObjCurrentEmrPatientSession, 0);
        ...
        protected override frmDiseaseTrackBase m_frmGetRecordForm(int p_intRecordType)
        {
            switch ((enmDiseaseTrackType)p_intRecordType)
            {
                case enmDiseaseTrackType.GeneralNurseRecord_CSRec:
                    return new frmGeneralNurseRecord_CSRec();
                case enmDiseaseTrackType.GeneralNurseRecord_CS:
                    return new frmGeneralNurseRecord_CSRec();
                case enmDiseaseTrackType.GeneralNurseRecord_CSCon:
                    return new frmGeneralNurseRecord_CSCon(false, m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), "");
            }
...
#endif
            m_mthAddNewRecord((int)enmDiseaseTrackType.GeneralNurseRecord_CS);
        }
        ...
        private void m_mthSaveColumnNameToDB(string p_strColumnIndex, ref string p_strColumnName)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_CSService_m_lngSetCustomColumnName(m_objCurrentPatient.m_StrInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), p_strColumnIndex, p_strColumnName);
        }
        ...
        protected override infPrintRecord m_objGetPrintTool()
        {
            ...
            return new clsGeneralNurseRecord_CSPrintTool(m_strCustomColumnName);
        }
        #endregion
