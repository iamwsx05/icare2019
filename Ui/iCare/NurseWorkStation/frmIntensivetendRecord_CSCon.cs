...
{
    /// <summary>
    /// 新生儿科危重患者护理记录--病情观察子窗体
    /// </summary>
    public partial class frmIntensivetendRecord_CSCon : iCare.frmDiseaseTrackBase
    {
        public frmIntensivetendRecord_CSCon()
        {
            InitializeComponent();
        }
        ...
        public frmIntensivetendRecord_CSCon(bool blnNew, string p_strInPatientID, string p_strInPatientDate, string p_strCreateDate)
            : this()
        {
            blnNewRecord = blnNew;
			...
			string p_strOpenDate)
		{
			...
			clsIntensivetendRecordContent_CSDetail objContent;

            //clsIntensivetendRecord_CSService objITRServ =
            //    (clsIntensivetendRecord_CSService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsIntensivetendRecord_CSService));
        ...
        private void frmIntensivetendRecord_CSCon_Load(object sender, EventArgs e)
        {
            if (blnNewRecord)
            {
                //初始化
