...
{
    /// <summary>
    /// 茶山危重患者护理记录(内科、妇产科、普儿科、急诊科、手术室)--病情观察子窗体
    /// </summary>
    public partial class frmGeneralNurseRecord_CSCon : iCare.frmDiseaseTrackBase
    {
        ...
        public frmGeneralNurseRecord_CSCon()
        {
            InitializeComponent();
        }
        ...
        private new long m_lngSave()
        {
            ...
            try
            {
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_CSService_m_lngAddNewDetail(objContent);
            }
            catch (Exception ex)
            {
        ...
        private long m_lngModify()
        {
            ...
            try
            {
                ...
                */
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_CSService_m_lngModifyDetail(objContent);
            }
            catch (Exception ex)
            {
        ...
        private void m_GetDataFromDB()
        {
            ...
            try
            {
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_CSService_m_lngGetRecordContent(strRecordInPatientID, strRecordInPatientDate, strRecordCreateDate, out objDetail);
                //objserv.Dispose();
                if (objDetail == null)
                    return;
                //赋值到表单
        ...
        private void frmGeneralNurseRecord_CSCon_Load(object sender, System.EventArgs e)
        {
            ...
            string p_strOpenDate)
        {
            ...
            //获取记录
            long lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_CSService_m_lngGetDelRecordContentWithInpatient(p_objSelectedPatient.m_StrInPatientID, p_objSelectedPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), p_strOpenDate, out objContent);
            //objITRServ.Dispose();
