...
namespace iCare
{
    ...
    /// 　一般患者护理记录单外科（茶山,外科）
    /// </summary>
    public partial class frmGeneralNurseRecordWK_CS : iCare.frmRecordsBase
    {
        ...
        public frmGeneralNurseRecordWK_CS()
        {
            InitializeComponent();
        ...
        protected override void m_mthInitDataTable(DataTable p_dtbRecordTable)
        {
            ...
            p_dtbRecordTable.Columns.Add("Pupil_SizeLeft", typeof(clsDSTRichTextBoxValue));//12
            p_dtbRecordTable.Columns.Add("Pupil_SizeRight", typeof(clsDSTRichTextBoxValue));//13
            p_dtbRecordTable.Columns.Add("Pupil_ReflectLeft", typeof(clsDSTRichTextBoxValue));//14
            p_dtbRecordTable.Columns.Add("Pupil_ReflectRight", typeof(clsDSTRichTextBoxValue));//15
            p_dtbRecordTable.Columns.Add("Incept_Kind", typeof(clsDSTRichTextBoxValue));//16
            p_dtbRecordTable.Columns.Add("Incept_Mete", typeof(clsDSTRichTextBoxValue));//17
            p_dtbRecordTable.Columns.Add("Eduction_Kind", typeof(clsDSTRichTextBoxValue));//18
            p_dtbRecordTable.Columns.Add("Eduction_Mete", typeof(clsDSTRichTextBoxValue));//19
            p_dtbRecordTable.Columns.Add("Eduction_Color", typeof(clsDSTRichTextBoxValue));//20
            p_dtbRecordTable.Columns.Add("PiWen", typeof(clsDSTRichTextBoxValue));//21
            p_dtbRecordTable.Columns.Add("Color", typeof(clsDSTRichTextBoxValue));//22
            p_dtbRecordTable.Columns.Add("ZhangLi", typeof(clsDSTRichTextBoxValue));//23
            p_dtbRecordTable.Columns.Add("Cap", typeof(clsDSTRichTextBoxValue));//24
            p_dtbRecordTable.Columns.Add("Custom", typeof(clsDSTRichTextBoxValue));//25
            p_dtbRecordTable.Columns.Add("Custom2", typeof(clsDSTRichTextBoxValue));//26
            p_dtbRecordTable.Columns.Add("Content", typeof(clsDSTRichTextBoxValue));//27
            p_dtbRecordTable.Columns.Add("DetailRecordTime");//28
            p_dtbRecordTable.Columns.Add("RecordAndDetailSign");//29
            //存放记录创建者ID
            p_dtbRecordTable.Columns.Add("CreateUserID");//30
        ...
        {
            return new clsRecordsDomain(enmRecordsType.GeneralNurseRecordWK_CSRec);
        }
            ...
            object[] p_objDataArr)
        {
            ...
            {
                case enmDiseaseTrackType.GeneralNurseRecordWK_CS:
            ...
            objContent.m_strCreateUserID = (string)p_objDataArr[30];

            return objContent;
        }

        private void frmGeneralNurseRecordWK_CS_Load(object sender, System.EventArgs e)
        {
            #region 添加右键菜单
        ...
        {
            frmGeneralNurseRecordWK_CSCon frmAddNewForm = (frmGeneralNurseRecordWK_CSCon)p_objSender;
            //显示窗体
        ...
        private void mniContentAdd_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                frmGeneralNurseRecordWK_CSCon frm = new frmGeneralNurseRecordWK_CSCon(true, m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), "2005");
        ...
        private void mniContentModify_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                //验证
                if (m_dtgRecordDetail.CurrentCell.ColumnNumber != 23)
                {
                ...
                string strRecordTime = (m_dtbRecords.Rows[intSelectedRecordStartRow][28]).ToString();
                if (strRecordTime.Trim().Length == 0)
                    return;
                //打开窗体
                frmGeneralNurseRecordWK_CSCon frm = new frmGeneralNurseRecordWK_CSCon(false, m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), strRecordTime);
                frm.Closed += new EventHandler(m_mthSubFormClosed);
                //更新
                //frm.TopMost = true;
                this.m_FrmCurrentSub = frm;
        ...
        private void mniContentDelete_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                string strDetailSign = (m_dtbRecords.Rows[intSelectedRecordStartRow][30]).ToString();
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecordWK_CSService_m_lngDeleteDetail(m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), strRecordTime, strDelTime, strDelID);
                //更新
                if (lngRes > 0)
                {
                    m_mthPerformSessionChanged(m_ObjCurrentEmrPatientSession, 0);
        ...
        protected override frmDiseaseTrackBase m_frmGetRecordForm(int p_intRecordType)
        {
            switch ((enmDiseaseTrackType)p_intRecordType)
            {
                case enmDiseaseTrackType.GeneralNurseRecordWK_CSRec:
                    return new frmGeneralNurseRecordWK_CSRec();
                case enmDiseaseTrackType.GeneralNurseRecordWK_CS:
                    return new frmGeneralNurseRecordWK_CSRec();
                case enmDiseaseTrackType.GeneralNurseRecordWK_CSCon:
                    return new frmGeneralNurseRecordWK_CSCon(false, m_objCurrentPatient.m_StrEMRInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), "");
            }
...
#endif
            m_mthAddNewRecord((int)enmDiseaseTrackType.GeneralNurseRecordWK_CS);
        }
            ...
            try
            {
                ...
                for (int i = 0; i < intRecordCount; i++)
                {
                    ...
                    if (objCurrent.m_dtmCreateDate != DateTime.MinValue)
                    {
                        ...
                        objData[1] = (int)enmRecordsType.GeneralNurseRecordWK_CS;//存放记录类型的int值
                        objData[2] = objCurrent.m_dtmOpenDate;//存放记录的OpenDate字符串
                        objData[3] = objCurrent.m_dtmModifyDate;//存放记录的ModifyDate字符串   
                        objData[30] = objCurrent.m_strCreateUserID;//存放记录的createUserid字符串   
                        //同一个则只在第一行显示日期
                        ...
                        {//若当前记录日期与病情观察记录日期相同，先输出当前记录，再输出病情观察记录
                            ...
                            for (int m = 0; m < m_intMax; m++)
                            {
                                ...
                                if (m < ((string[])(((object[])arlDetail[intCurrentDetail])[0])).Length)
                                {
                                    ...
                                    objData[28] = (DateTime)((object[])arlDetail[intCurrentDetail])[3];
                                }
        ...
        private void m_mthSetOtherDetail(object[] objDetail, int intCurrentDetail, int intRowOfCurrentDetail, clsGeneralNurseRecordContent_CS objCurrent, out object[] objOtherDetail)
        {
            ...
            objclsDSTRichTextBoxValue.m_strText = strText;
            objclsDSTRichTextBoxValue.m_strDSTXml = strXml;
            objOtherDetail[27] = objclsDSTRichTextBoxValue;
            objOtherDetail[28] = (DateTime)objDetail[3];
        }
        ...
        private void m_dtgRecordDetail_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left && e.Clicks == 2)
            {
                ...
                if (myHitTest.Column == 21 || myHitTest.Column == 22)
                {
                    m_strTempColumnName = "";
        ...
        private void m_mthSaveColumnNameToDB(string p_strColumnIndex, ref string p_strColumnName)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecordWK_CSService_m_lngSetCustomColumnName(m_objCurrentPatient.m_StrInPatientID, m_objCurrentPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), p_strColumnIndex, p_strColumnName);
        }
        ...
        protected override void m_mthStartPrint()
        {
            ...
            try
            {
                ...
                //m_pdcPrintDocument.DefaultPageSettings.PaperSize = new PaperSize("A4", 1150, 1620);
                //if (m_blnDirectPrint)
                //{
        ...
        protected override infPrintRecord m_objGetPrintTool()
        {
            ...
            return new frmGeneralNurseRecordWK_CSPrintTool(m_strCustomColumnName, m_strCustomColumnName2);
        }
        #endregion
