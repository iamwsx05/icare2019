...
{
    /// <summary>
    /// 危重患者护理记录单/添加记录（茶山,外科）
    /// </summary>
    public partial class frmIntensiveTendMain_CSWKRec : frmDiseaseTrackBase
    {
        //定义签名类
        ...
        private void frmIntensiveTendMain_CSWKRec_Load(object sender, System.EventArgs e)
        {
        ...
        private void lsvRecordSign_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void m_cmbRecordSign_Click(object sender, EventArgs e)
        {
