namespace iCare
{
    partial class frmGeneralNurseRecord_CS
    {
        /// <summary>
        /// 必需的设计器变量。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Size = new System.Drawing.Size(779, 12);
            this.label1.TabIndex = 10000007;
            this.label1.Text = "(供内科、妇产科、普儿科、急诊科、手术室使用)  注：SpO2指经皮血氧饱和度；CVP指中心静脉压；瞳孔对光反射用符号表示：灵敏+ 迟钝 消失-";
            // 
            // frmGeneralNurseRecord_CS
            // 
            this.ClientSize = new System.Drawing.Size(849, 645);
            this.Controls.Add(this.panel1);
            this.Controls.Add(this.label1);
            this.Name = "frmGeneralNurseRecord_CS";
            this.Text = "护理记录（内科、妇产科、普儿科、急诊科、手术室）";
            this.Load += new System.EventHandler(this.frmGeneralNurseRecord_CS_Load);
