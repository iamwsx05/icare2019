...
{
    /// <summary>
    ///危重患者护理记录单/病程记录（茶山,外科）
    /// </summary>
    public partial class frmIntensiveTendMain_CSWKCon : iCare.frmDiseaseTrackBase
    {
        ...
        public frmIntensiveTendMain_CSWKCon()
        {
            InitializeComponent(); 
        }
        public frmIntensiveTendMain_CSWKCon(bool blnNew, string p_strInPatientID, string p_strInPatientDate, string p_strCreateDate)
            : this()
        {
            blnNewRecord = blnNew;
        ...
        protected override iCare.clsDiseaseTrackDomain m_objGetDiseaseTrackDomain()
        {
            ...
            return new clsDiseaseTrackDomain(enmDiseaseTrackType.IntensiveTendMain_CSWK);
        }
        /// <summary>
        ...
        private new long m_lngSave()
        {
            ...
            try
            {
              ...
              //      (clsIntensiveTendMain_CSWKService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsIntensiveTendMain_CSWKService));
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsIntensiveTendMain_CSWKService_m_lngAddNewDetail(objContent);
            }
            catch (Exception ex)
            {
        ...
        private long m_lngModify()
        {
            ...
            try
            {
                ...
                */
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsIntensiveTendMain_CSWKService_m_lngModifyDetail(objContent);
            }
            catch (Exception ex)
            {
        ...
        private void m_GetDataFromDB()
        {
            ...
            try
            {
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsIntensiveTendMain_CSWKService_m_lngGetRecordContent(strRecordInPatientID, strRecordInPatientDate, strRecordCreateDate, out objDetail);
                //objserv.Dispose();
                if (objDetail == null)
                    return;
                //赋值到表单
        ...
        private void frmIntensiveTendMain_CSWKCon_Load(object sender, System.EventArgs e)
        {
            ...
            string p_strOpenDate)
        {
            ...
            //clsIntensiveTendMain_CSWKService objITRServ =
            //    (clsIntensiveTendMain_CSWKService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsIntensiveTendMain_CSWKService));

            //获取记录
            long lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsIntensiveTendMain_CSWKService_m_lngGetDelRecordContentWithInpatient(p_objSelectedPatient.m_StrInPatientID, p_objSelectedPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), p_strOpenDate, out objContent);
            //objITRServ.Dispose();
