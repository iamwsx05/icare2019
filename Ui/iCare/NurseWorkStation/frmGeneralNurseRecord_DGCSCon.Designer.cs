namespace iCare
{
    partial class frmGeneralNurseRecord_DGCSCon
    {
        /// <summary>
        /// 必需的设计器变量。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmGeneralNurseRecord_DGCSCon";
            this.Text = "一般患者护理记录茶山版（内科、妇产科、普儿科）-病情观察、护理措施、效果";
            this.Load += new System.EventHandler(this.frmGeneralNurseRecord_DGCSCon_Load);
