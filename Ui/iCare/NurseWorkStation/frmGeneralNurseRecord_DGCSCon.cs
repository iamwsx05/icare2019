...
{
    /// <summary>
    /// 茶山一般患者护理记录（内科、妇产科、普儿科）--病情观察子窗体
    /// </summary>
    public partial class frmGeneralNurseRecord_DGCSCon : iCare.frmDiseaseTrackBase
    {
        ...
        public frmGeneralNurseRecord_DGCSCon()
        {
            InitializeComponent();
        }
        public frmGeneralNurseRecord_DGCSCon(bool blnNew, string p_strInPatientID, string p_strInPatientDate, string p_strCreateDate)
            : this()
        {
            blnNewRecord = blnNew;
        ...
        private new long m_lngSave()
        {
            ...
            try
            {
                ...
                //从界面获取表单值		
                clsGeneralNurseRecordContent_DGCSDetail objContent = new clsGeneralNurseRecordContent_DGCSDetail();
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_DGCSService_m_lngAddNewDetail(objContent);
            }
            catch (Exception ex)
            {
        ...
        private long m_lngModify()
        {
            ...
            try
            {
                ...
                objContent.objSignerArr[0].m_strFORMID_VCHR = "frmGeneralNurseRecord_DGCSCon";//注意大小写
                ...
                */
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_DGCSService_m_lngModifyDetail(objContent);
            }
            catch (Exception ex)
            {
        ...
        private void m_GetDataFromDB()
        {
            ...
            try
            {
                ...
                lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_DGCSService_m_lngGetRecordContent(strRecordInPatientID, strRecordInPatientDate, strRecordCreateDate, out objDetail);
                //objserv.Dispose();
                if (objDetail == null)
                    return;
                //赋值到表单
        ...
        private void frmGeneralNurseRecord_DGCSCon_Load(object sender, System.EventArgs e)
        {
            ...
            string p_strOpenDate)
        {
            ...
            clsGeneralNurseRecordContent_DGCSDetail objContent;

            //clsGeneralNurseRecord_DGCSService objITRServ =
            //    (clsGeneralNurseRecord_DGCSService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsGeneralNurseRecord_DGCSService));

            //获取记录
            long lngRes = (new weCare.Proxy.ProxyEmr05()).Service.clsGeneralNurseRecord_DGCSService_m_lngGetDelRecordContentWithInpatient(p_objSelectedPatient.m_StrInPatientID, p_objSelectedPatient.m_DtmSelectedInDate.ToString("yyyy-MM-dd HH:mm:ss"), p_strOpenDate, out objContent);
            //objITRServ.Dispose();
        ...
        {
            clsGeneralNurseRecordContent_DGCSDetail objContent = (clsGeneralNurseRecordContent_DGCSDetail)p_objContent;
            //把表单值赋值到界面，由子窗体重载实现			
