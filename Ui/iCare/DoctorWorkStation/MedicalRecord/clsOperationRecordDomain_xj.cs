...
namespace iCare
{
    ...
    /// </summary>
    public class clsOperationRecordDomain_xj
    {
        /// <summary>
        /// 获取病人的该记录时间列表。
        /// </summary>
        ...
        {
            com.digitalwave.DiseaseTrackService.clsOperationRecordService_xj objServ =
                    (com.digitalwave.DiseaseTrackService.clsOperationRecordService_xj)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.DiseaseTrackService.clsOperationRecordService_xj));
