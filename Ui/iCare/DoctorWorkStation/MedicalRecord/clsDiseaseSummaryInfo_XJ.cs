...
namespace iCare
{
    ...
    /// 阶段小结信息--新疆
    /// </summary>
    public class clsDiseaseSummaryInfo_XJ : clsDiseaseTrackInfo
    {
        clsPatient m_objCurrentPatient = null;
        public clsDiseaseSummaryInfo_XJ(clsPatient p_objPatient)
        {
        ...
        public override string m_strGetTrackText()
        {
            ...
            clsDiseaseSummaryRecordContent_XJ objContent = ((clsDiseaseSummaryRecordContent_XJ)m_objRecordContent);
        ...
        private string m_strGetHeaderText()
        {
            ...
            clsDiseaseSummaryRecordContent_XJ objContent = ((clsDiseaseSummaryRecordContent_XJ)m_objRecordContent);
            string strText;
            strText = objContent.m_dtmCreateDate.ToString(MDIParent.s_ObjRecordDateTimeInfo.m_strGetRecordTimeFormat("frmDiseaseSummary_XJ")) + "   " + "阶段小结\n";
        ...
        {
            return enmDiseaseTrackType.DiseaseSummary_XJ;
        }
