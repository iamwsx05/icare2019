...
namespace iCare
{
    ...
    /// 谈话记录-----新疆
    /// </summary>
    public partial class frmTalkRecord_XJ : iCare.frmDiseaseTrackBase
    {
        #region
        ...
        protected override void m_mthClearRecordInfo()
        {
            ...
            m_txtyibao.Text = "";
            m_dtpriqi.Value = DateTime.Now;
            m_dtpOutHospitalDate.Value = DateTime.Now;
        ...
        {
            //获取病程记录的领域层实例
            return new clsDiseaseTrackDomain(enmDiseaseTrackType.TalkRecord_XJ);
        }
        ...
        private void frmTalkRecord_XJ_Load(object sender, EventArgs e)
        {
        ...
        clsTalkRecord_XJPrintTool objPrintTool;
        ...
        protected override void m_mthSetDefaultValue(clsPatient p_objPatient)
        {
            ...
            try
            {
                ...
                clsTalkRecordDomain_XJ objDomain = new clsTalkRecordDomain_XJ();
                ...
                if (dtbOrder != null)
                {
                    ...
                    if (intRowsCount > 0)
                    {
                        ...
                        this.m_txtOutHospitalDiagnose.Text = stbOutOrder.ToString();
                    }
                }
            }
            catch (Exception Ex)
        ...
        protected override clsInactiveRecordInfo_VO[] m_objSubGetAllInactiveInfo(clsInactiveRecordInfo_VO p_objSelectedValue)
        {
            ...
            new clsTalkRecordDomain_XJ().m_lngGetAllInactiveInfo(p_objSelectedValue.m_StrInpatientId, p_objSelectedValue.m_DtmInpatientDate, out objArr);
            return objArr;
        }
