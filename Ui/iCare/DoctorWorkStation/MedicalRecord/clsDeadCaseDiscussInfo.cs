...
namespace iCare
{
	...
	/// 死亡病例讨论记录信息。
	/// </summary>
	public class clsDeadCaseDiscussInfo	: clsDiseaseTrackInfo
	{
		...
		public override string m_strGetTrackText()
		{
			...
			clsDeadCaseDiscussRecordContent objContent=((clsDeadCaseDiscussRecordContent)m_objRecordContent);
			string strText=m_strGetHeaderText();

			string strReadOuterName = "";

			strReadOuterName ="病例宣读人:"+ m_strGetName(m_objRecordContent.objSignerArr,"lsvRead");
			...
			strText +="\n参照本例应借鉴的问题:"+objContent.m_strUseForReference;	
			return strText;
		}
		...
		public override string m_strGetTrackXml()
		{
            ...
            string strXML8 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n参照本例应借鉴的问题:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            ...
            string strXML = ctlRichTextBox.clsXmlTool.s_strCombineXml(new string[]{strXML1,strXML2,objContent.m_strAddressXML,strXML3,strXML4,strXML5,objContent.m_strDiscussContentXML,
																		 strXML6,objContent.m_strDeadDiagnoseXML,strXML7,objContent.m_strDeadReasonXML,strXML8,objContent.m_strUseForReferenceXML});
		...
		private string m_strGetHeaderText()
		{
			...
			clsDeadCaseDiscussRecordContent objContent=((clsDeadCaseDiscussRecordContent)m_objRecordContent);
			string strText;
			strText=objContent.m_dtmCreateDate.ToString(MDIParent.s_ObjRecordDateTimeInfo.m_strGetRecordTimeFormat("frmDeadCaseDiscuss"))+"   "+"死亡病例讨论记录";
			return strText;
		}
		...
		{
			return enmDiseaseTrackType.DeadCaseDiscuss;
		}
		...
		public void m_mthGetFormatTrackInfo(int p_intCharPerLine,bool p_blnIsPrintCall,DateTime p_dtmSeperateTime,out string p_strText,out string p_strXml)
		{
			...
			p_strText +="\n地点:"+objContent.m_strAddress;
			p_strText +="\n参加人员:"+m_strGetName(m_objRecordContent.objSignerArr,"lsvAttend");
            p_strText += "\n主持人:" + m_strGetName(m_objRecordContent.objSignerArr, "lsvCompere") + "    " + strReadOuterName;
            //p_strText += "\n病例宣读人:" + m_strGetName(m_objRecordContent.objSignerArr, "lsvRead");
			p_strText +="\n讨论内容:\n";	
            ...
            string strXML2 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n地点:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML3 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n参加人员:" + m_strGetName(m_objRecordContent.objSignerArr, "lsvAttend"), objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML4 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n主持人:" + m_strGetName(m_objRecordContent.objSignerArr, "lsvCompere") + "    " + strReadOuterName, objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML5 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n讨论内容:\n", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML6 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n死亡诊断:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML7 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n死亡原因:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML8 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n参照本例应借鉴的问题:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
			...
			arlXml.AddRange(new string[]{strXML6,objContent.m_strDeadDiagnoseXML,strXML7,objContent.m_strDeadReasonXML,strXML8,objContent.m_strUseForReferenceXML});

            p_strXml = ctlRichTextBox.clsXmlTool.s_strCombineXml((string[])arlXml.ToArray(typeof(string)));
	...
	}// END CLASS DEFINITION clsDeadCaseDiscussInfo
	
	/// <summary>
	/// 死亡病例讨论记录信息(新)。
	/// </summary>
	public class clsDeathCaseDiscussInfo	: clsDiseaseTrackInfo
	{
		private const string c_strSplitText = "医生：";
		...
		public override enmDiseaseTrackType m_enmGetTrackType()
		{
			return enmDiseaseTrackType.DeathCaseDiscuss;
		}
