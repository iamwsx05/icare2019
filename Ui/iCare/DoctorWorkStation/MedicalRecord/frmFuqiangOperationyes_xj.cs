...
namespace iCare
{
    ...
    /// 腹腔镜手术同意书----新疆 
    /// </summary>
    public partial class frmFuqiangOperationyes_xj : iCare.frmDiseaseTrackBase
    {
        ...
        public frmFuqiangOperationyes_xj()
        {
            InitializeComponent();
        ...
        {
            clsFuqiangOperationyesInfo_xj objTrackInfo = new clsFuqiangOperationyesInfo_xj();

            objTrackInfo.m_ObjRecordContent = m_objCurrentRecordContent;
            //设置m_strTitle和m_dtmRecordTime
            objTrackInfo.m_DtmRecordTime = m_dtpCreateDate.Value;
            objTrackInfo.m_StrTitle = "腹腔镜手术同意书";
        ...
        protected override void m_mthSetDeletedGUIFromContent(clsTrackRecordContent p_objContent)
        {
            ...
            m_txtInHospitalDiagnose.Text = com.digitalwave.controls.ctlRichTextBox.s_strGetRightText(objContent.m_strShuQian, objContent.m_strShuQianXML);
            m_txtSpeakRecord.Text = com.digitalwave.controls.ctlRichTextBox.s_strGetRightText(objContent.m_strNiShi, objContent.m_strNiShiXML);
            m_txtYiJian.Text = com.digitalwave.controls.ctlRichTextBox.s_strGetRightText(objContent.m_strMaZui, objContent.m_strMaZuiXML);
        ...
        {
            //获取病程记录的领域层实例
            return new clsDiseaseTrackDomain(enmDiseaseTrackType.FuqiangOperationyes_xj);
        }
        ...
        private void frmFuqiangOperationyes_xj_Load(object sender, EventArgs e)
        {
            m_mthfrmLoad();
            //if(m_objCurrentPatient !=null)
            //{
        ...
        clsFuqiangOperationyesPrintTool_xj objPrintTool;
        private void m_mthDemoPrint_FromDataSource()
        {
            //			if(m_blnHasInitPrintTool==false)
            //			{
            objPrintTool = new clsFuqiangOperationyesPrintTool_xj();
        ...
        protected override bool m_blnSubReuse(clsInactiveRecordInfo_VO p_objSelectedValue)
        {
            ...
            {
                clsTrackRecordContent m_objContent = new clsFuqiangOperationyesContent_xj();
                ...
                clsFuqiangOperationyesContent_xj p_objContent = (clsFuqiangOperationyesContent_xj)m_objContent;
                ...
                this.m_txtInHospitalDiagnose.Text = p_objContent.m_strShuQian;
                this.m_txtSpeakRecord.Text = p_objContent.m_strNiShi;
                this.m_txtYiJian.Text = p_objContent.m_strMaZui;            
        ...
        protected override void m_mthSubPreviewInactiveRecord(IWin32Window p_infOwner, clsInactiveRecordInfo_VO p_objSelectedValue)
        {
            ...
            if (m_objBaseCurrentPatient != null)
            {
                ...
                clsPrintInfo_FuqiangOperationyes_xj objPrintInfo = new clsPrintInfo_FuqiangOperationyes_xj();
                ...
                clsTrackRecordContent p_objContent = new clsFuqiangOperationyesContent_xj();
