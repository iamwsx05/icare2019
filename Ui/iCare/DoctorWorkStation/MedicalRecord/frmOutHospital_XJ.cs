...
namespace iCare
{
    ...
    /// 出院记录---新疆
    /// </summary>
    public partial class frmOutHospital_XJ : iCare.frmDiseaseTrackBase
    {
        #region
       ...
       // protected com.digitalwave.Utility.Controls.ctlTimePicker m_dtpOutHospitalDate;
        ...
        {
            clsOutHospitalInfo_XJ objTrackInfo = new clsOutHospitalInfo_XJ();
        ...
        {
            //获取病程记录的领域层实例
            return new clsDiseaseTrackDomain(enmDiseaseTrackType.OutHospital_XJ);
        }
        ...
        clsOutHospital_XJPrintTool objPrintTool;
        ...
        protected override void m_mthSetDefaultValue(clsPatient p_objPatient)
        {
            ...
            try
            {
                ...
                clsOutHospitalDomain_XJ objDomain = new clsOutHospitalDomain_XJ();
        ...
        protected override clsInactiveRecordInfo_VO[] m_objSubGetAllInactiveInfo(clsInactiveRecordInfo_VO p_objSelectedValue)
        {
            ...
            new clsOutHospitalDomain_XJ().m_lngGetAllInactiveInfo(p_objSelectedValue.m_StrInpatientId, p_objSelectedValue.m_DtmInpatientDate, out objArr);
            return objArr;
        }
