...
namespace iCare
{
    ...
    public class clsInHospitalMainRecordDomain
    {
        ...
        public long m_strGetFirstPrintDate(string p_strInPatientID, string p_strInPatientDate,/*string p_strOpenDate,*/out string p_strFirstPrintDate)
        {
            ...
            try
            {
                lngRes = (new weCare.Proxy.ProxyEmr03()).Service.clsInHospitalMainRecordServ_m_lngGetFirstPrintDate(p_strInPatientID, p_strInPatientDate,/*p_strOpenDate,*/out p_strFirstPrintDate);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        {//載陔菴珨棒湖荂奀潔		
            ...
            try
            {
                lngRes = (new weCare.Proxy.ProxyEmr03()).Service.clsInHospitalMainRecordServ_m_lngUpdateFirstPrintDate(p_strInPatientID, p_strInPatientDate/*,p_strOpenDate*/);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngDoSave(clsInHospitalMainRecord_Main p_objMain, clsInHospitalMainRecord_Content p_objContent, clsInHospitalMainRecord_OtherDiagnosis[] p_objOtherDiagnosisArr, clsInHospitalMainRecord_Operation[] p_objOperationArr, clsInHospitalMainRecord_Baby[] p_objBabyArr, clsInHospitalMainRecord_Chemotherapy[] p_objChemotherapyArr, bool p_bolIfAddNew)
        {
            ...
            try
            {
                ...
                if (p_bolIfAddNew)//陔崝
                    lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngAddNew(m_strMainXML, m_strContentXML, m_strOtherDiagnosisXMLArr, m_strOperationXMLArr, m_strBabyXMLArr, m_strChemotherapyXMLArr);
                else//党蜊
                    lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngModify(p_objMain.m_strInPatientID, p_objMain.m_strInPatientDate, p_objMain.m_strOpenDate, p_objContent.m_strLastModifyUserID,
        ...
        public long m_lngGetOpenDateInfo(string p_strInPatientID, string p_strInPatientDate, out string p_strOpenDate)
        {
            ...
            try
            {
                string m_strXML = "";
                int m_intRows = 0;
                lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetOpenDateInfo(p_strInPatientID, p_strInPatientDate, out m_strXML, out m_intRows);
        ...
        public long m_lngGetMainInfo(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Main p_objMain)
        {
            ...
            try
            {
                ...
                lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetMainInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objMain);
                #region 導源楊ㄛ眒煙ィ
        ...
        public long m_lngGetDeletedMainInfo(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Main p_objMain)
        {
            ...
            try
            {
                ...
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeletedMainInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objMain);
                #region 導源楊ㄛ眒煙ィ
        ...
        public long m_lngGetContentInfo(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Content p_objContent)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetContentInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objContent);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
        ...
        public long m_lngGetDeletedContentInfo(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Content p_objContent)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeletedContentInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objContent);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
                //    p_objContent = new clsInHospitalMainRecord_Content();
        ...
        public long m_lngGetOtherDiagnosisArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_OtherDiagnosis[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetOtherDiagnosisInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out m_strXML, out m_intRows);
                if (m_lngRes >= 0 && m_intRows > 0)
                {
        ...
        public long m_lngGetDeletedOtherDiagnosisArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_OtherDiagnosis[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeletedOtherDiagnosisInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out m_strXML, out m_intRows);
                if (m_lngRes >= 0 && m_intRows > 0)
                {
                    p_objDataArr = new clsInHospitalMainRecord_OtherDiagnosis[m_intRows];
                    XmlTextReader objReader = new XmlTextReader(m_strXML, XmlNodeType.Element, m_objXmlParser);
        ...
        public long m_lngGetOperationArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Operation[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetOperationInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
        ...
        public long m_lngGetDeletedOperationArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Operation[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeletedOperationInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
                //    p_objDataArr = new clsInHospitalMainRecord_Operation[m_intRows];
        ...
        public long m_lngGetBabyArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Baby[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetBabyInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
        ...
        public long m_lngGetDeletedBabyArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Baby[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeletedBabyInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
                //    p_objDataArr = new clsInHospitalMainRecord_Baby[m_intRows];
        ...
        public long m_lngGetChemotherapyArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Chemotherapy[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetChemotherapyInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
        ...
        public long m_lngGetDeletedChemotherapyArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Chemotherapy[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeletedChemotherapyInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
                #region 導源楊ㄛ眒煙ィ
                //if (m_lngRes >= 0 && m_intRows > 0)
                //{
                //    p_objDataArr = new clsInHospitalMainRecord_Chemotherapy[m_intRows];
        ...
        public long m_lngGetDiagnosisArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Diagnosis[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDiagnosisInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
            }
            catch (Exception Ex)
            {
        ...
        public long m_lngGetDeleteDiagnosisArr(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out clsInHospitalMainRecord_Diagnosis[] p_objDataArr)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeleteDiagnosisInfo(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_objDataArr);
            }
            catch (Exception Ex)
            {
                string strEx = Ex.Message;
        ...
        public long m_lngGetAnaesthesiaModeLikeID(string p_strInput, out clsAnaesthesiaModeInOperation[] p_objAnaesthesiaModeInOperation)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.clsInHospitalMainRecordServ_m_lngGetAnaesthesiaModeLikeID(p_strInput, out p_objAnaesthesiaModeInOperation);
                #region 導源楊ㄛ眒煙ィ
        ...
        public long m_lngGetCreateDateCount(string p_strInPatientID, string p_strInPatientDate, out int p_intRows)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetCreateDateCount(p_strInPatientID, p_strInPatientDate, out p_intRows);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngGetLastModifyDateAndUser(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, out string p_strLastModifyDate, out string p_strLastModifyUserID)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetLastModifyDateAndUser(p_strInPatientID, p_strInPatientDate, p_strOpenDate, out p_strLastModifyDate, out p_strLastModifyUserID);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngGetDeactivedDateAndUser(string p_strInPatientID, string p_strInPatientDate, out string p_strDeactivedDate, out string p_strDeactivedUserID)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDeactivedDateAndUser(p_strInPatientID, p_strInPatientDate, out p_strDeactivedDate, out p_strDeactivedUserID);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngDeleteRecord(string p_strInPatientID, string p_strInPatientDate, string p_strOpenDate, string p_strOperatorID)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngDeleteRecord(p_strInPatientID, p_strInPatientDate, p_strOpenDate, p_strOperatorID);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngAddDistrict(string p_strDistrict, string p_strParentID, string p_strType)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngAddDistrict(p_strDistrict, p_strParentID, p_strType);
                if (m_lngRes == -31)
        ...
        public long m_lngModifyDistrict(string p_strDistrict, string p_strID)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngModifyDistrict(p_strDistrict, p_strID);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngGetAidDict(string p_strParentID, ref DataTable dtResult)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetAidDict(p_strParentID, out dtResult);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngGetDistrict(string p_strParentID, ref DataTable dtResult)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDistrict(p_strParentID, out dtResult);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngGetIDByName(string p_strDistrict, string p_strType, string p_strParentID, out string p_strDisID)
        {
            ...
            try
            {
                m_lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetDisIDByName(p_strDistrict, p_strType, p_strParentID, out p_strDisID);
            }
            finally
            {
                //m_objServ.Dispose();
        ...
        public long m_lngGetInHospitalMainTransDeptInstance(string p_strRegisterID, out clsInHospitalMainTransDeptInstance p_objDeptInstance)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.clsInHospitalMainRecordServ_m_lngGetInHospitalMainTransDeptInstance(p_strRegisterID, out p_objDeptInstance);
            //objServ.Dispose();
            return lngRes;
        }
        #endregion
        ...
        public long m_lngSavePatientInfo(string p_strPatientID, string p_strRegisterID, clsPeopleInfo p_objPeopleInfo)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngUpdateToBsePatient(p_strPatientID, p_objPeopleInfo);
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngUpdateToRegisterDetail(p_strRegisterID, p_objPeopleInfo);
        ...
        public long m_lngGetICDDiagnosisCode(out DataTable p_dtbResult)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr07()).Service.m_lngGetICDDiagnosisCode(  out p_dtbResult);
        ...
        public long m_lngGetAnaesthesiaMode(out DataTable p_dtbResult)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr07()).Service.m_lngGetAnaesthesiaMode(  out p_dtbResult);
        ...
        public long m_lngGetOprationCode(out DataTable p_dtbResult)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr07()).Service.m_lngGetOprationCode(  out p_dtbResult);
        ...
        public long m_lngCommitToGD(clsInHospitalMainRecord_Collection p_objCollection, clsPeopleInfo p_objPeoInfo, clsInHospitalMainTransDeptInstance p_objTransferDept, string p_strHISInDate)
        {
            ...
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitRecord(p_objCollection.m_objMain.m_strInPatientID, Convert.ToDateTime(p_objCollection.m_objMain.m_strInPatientDate), Convert.ToDateTime(p_objCollection.m_objMain.m_strOpenDate));
            if (lngRes < 0)
            {
                return -1;
            }
            ...
            int intInTimes = 1;
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetInTimes(p_objCollection.m_objMain.m_strInPatientID,
                Convert.ToDateTime(p_objCollection.m_objMain.m_strInPatientDate), out intInTimes);

            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA1(p_objCollection.m_objMain.m_strInPatientID, intInTimes, p_objPeoInfo);
            if (lngRes < 0)
            {
                return -1;
            }

            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA2(p_objCollection, intInTimes, p_objTransferDept, p_objPeoInfo, p_strHISInDate);

            if (lngRes < 0)
                return -1;
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA3(p_objCollection, intInTimes, p_objPeoInfo.m_StrLastName);
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA4(p_objCollection, intInTimes, p_objPeoInfo.m_StrLastName);
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA5(p_objCollection, intInTimes, p_objPeoInfo.m_StrLastName);
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA6(p_objCollection, intInTimes, p_objPeoInfo.m_StrLastName);
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA7(p_objTransferDept, p_objCollection.m_objMain.m_strInPatientID, intInTimes, p_objPeoInfo.m_StrLastName);
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA9(p_objCollection, intInTimes, p_objPeoInfo.m_StrLastName);
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngCommitToBA10(p_objCollection, intInTimes, p_objPeoInfo.m_StrLastName);
            return lngRes;
        }
        #endregion
        ...
        public DateTime m_lngGetUpdateDatetime()
        {
            ...
            //com.digitalwave.InHospitalMainRecord.clsInHospitalMainRecordServ m_objServ =
            //    (com.digitalwave.InHospitalMainRecord.clsInHospitalMainRecordServ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.InHospitalMainRecord.clsInHospitalMainRecordServ));
            return (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetUpdateDatetime();
        }
        #endregion
        ...
        public long m_lngGetChargeChanKe(string p_strRegisterID, DataTable p_strbbReisterID, out clsInHospitalMainCharge[] p_objRecordArr)
        {
            ...
            //clsInHospitalMainRecordServ objServ =
            //    (clsInHospitalMainRecordServ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsInHospitalMainRecordServ));
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetChargeChanKe(  p_strRegisterID, p_strbbReisterID, out p_objRecordArr);
        ...
        public long m_lngGetCHRCATE2009(string p_strRegisterID, out clsInHospitalMainCharge[] p_objRecordArr)
        {
            ...
            //clsInHospitalMainRecordServ objServ =
            //    (clsInHospitalMainRecordServ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsInHospitalMainRecordServ));
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetCHRCATE2009(  p_strRegisterID, out p_objRecordArr);
            //m_lngGetCHRCATE2009  m_lngGetCHRCATE
        ...
        public long m_lngGetSelfPay(string p_strInpatientID, out clsInHospitalMainRecord_Content p_objRecordcontent)
        {
            ...
            //clsInHospitalMainRecordServ objServ =
            //    (clsInHospitalMainRecordServ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsInHospitalMainRecordServ));
            lngRes = (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetSelfPay(  p_strInpatientID, out p_objRecordcontent);//, p_dtmInhospitalDate);
        ...
        public DataTable m_lngGetRgisterIDByInpatientID(string p_strRegister)
        {
            //clsInHospitalMainRecordServ objServ =
            //    (clsInHospitalMainRecordServ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsInHospitalMainRecordServ));
            return (new weCare.Proxy.ProxyEmr03()).Service.m_lngGetRgisterIDByInpatientID(p_strRegister);
        }
