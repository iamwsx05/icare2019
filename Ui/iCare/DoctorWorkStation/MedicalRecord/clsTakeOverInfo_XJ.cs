...
namespace iCare
{
    ...
    /// 交班记录信息--新疆
    /// </summary>
    public class clsTakeOverInfo_XJ : clsDiseaseTrackInfo
    {
        clsPatient m_objCurrentPatient = null;
        public clsTakeOverInfo_XJ(clsPatient p_objPatient)
        {
        ...
        public override string m_strGetTrackText()
        {
            ...
            clsTakeOverRecordContent_XJ objContent = ((clsTakeOverRecordContent_XJ)m_objRecordContent);
        ...
        private string m_strGetHeaderText()
        {
            ...
            clsTakeOverRecordContent_XJ objContent = ((clsTakeOverRecordContent_XJ)m_objRecordContent);
            string strText;
            strText = objContent.m_dtmCreateDate.ToString(MDIParent.s_ObjRecordDateTimeInfo.m_strGetRecordTimeFormat("frmTakeOver_XJ")) + "   " + "交班记录\n";
        ...
        {
            return enmDiseaseTrackType.TakeOver_XJ;
        }
