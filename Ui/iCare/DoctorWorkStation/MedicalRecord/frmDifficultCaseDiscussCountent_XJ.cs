...
namespace iCare
{
    ...
    /// 疑难病例讨论记录----新疆 
    /// </summary>
    public partial class frmDifficultCaseDiscussCountent_XJ : iCare.frmDiseaseTrackBase
    {
        ...
        public frmDifficultCaseDiscussCountent_XJ()
        {
            InitializeComponent(); 
        ...
        {
            clsDifficultCaseDiscussInfo_XJ objTrackInfo = new clsDifficultCaseDiscussInfo_XJ();
        ...
        {
            //获取病程记录的领域层实例
            return new clsDiseaseTrackDomain(enmDiseaseTrackType.DifficultCaseDiscussCountent_XJ);
        }
        ...
        clsDifficultCaseDiscuss_XJPrintTool objPrintTool;
