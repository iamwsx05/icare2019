...
namespace iCare
{
    ...
    public class clsFuqiangOperationyesInfo_xj : clsDiseaseTrackInfo
    {
        ...
        public override string m_strGetTrackText()
        {
            ...
            clsFuqiangOperationyesContent_xj objContent = ((clsFuqiangOperationyesContent_xj)m_objRecordContent);
            ...
            strText += "\n　　术前诊断:" + objContent.m_strShuQian;
            strText += "\n　　麻醉医师:" + objContent.m_strCompereName;
            strText += "\n　　手术者:" + m_strGetName(objContent.m_strAttendeeNameArr);        
            strText += "\n    麻醉方式:" + objContent.m_strMaZui;            
            strText += "\n    主管医师:" + objContent.m_strRecordName;
        ...
        public override string m_strGetTrackXml()
        {
            ...
            string strXML3 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n    术前诊断:" + objContent.m_strShuQian, objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML4 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n　　麻醉医师:" + objContent.m_strCompereName, objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            ...
            string strXML6 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n　　麻醉方式:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML7 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n   主管医师:" + objContent.m_strRecordName, objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            ...
            string strXML = ctlRichTextBox.s_strCombineXml(new string[]{strXML1,strXML2,strXML3,objContent.m_strShuQianXML,strXML4,strXML5,strXML6,objContent.m_strMaZuiXML,strXML7});
            return strXML;
        }
        ...
        private string m_strGetHeaderText()
        {
            ...
            clsFuqiangOperationyesContent_xj objContent = ((clsFuqiangOperationyesContent_xj)m_objRecordContent);
            string strText;
            strText = objContent.m_dtmCreateDate.ToString(MDIParent.s_ObjRecordDateTimeInfo.m_strGetRecordTimeFormat("frmFuqiangOperationyes_xj")) + "   " + "腹腔镜手术同意书";
            return strText;
        }
        ...
        {
            return enmDiseaseTrackType.FuqiangOperationyes_xj;
        }
        ...
        public void m_mthGetFormatTrackInfo(int p_intCharPerLine, bool p_blnIsPrintCall, DateTime p_dtmSeperateTime, out string p_strText, out string p_strXml)
        {
            ...
            arlXml.AddRange(new string[] { strXML1, strXML2, strXML3,objContent.m_strShuQianXML, strXML4, strXML5, strXML6 ,objContent.m_strMaZuiXML,strXML7});
