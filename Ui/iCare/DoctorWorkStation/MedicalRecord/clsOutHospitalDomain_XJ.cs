...
namespace iCare
{
    ...
    /// </summary>
    public class clsOutHospitalDomain_XJ
    {
        /// <summary>
        /// 获取病人的该记录时间列表。
        /// </summary>
        ...
        {
            clsOutHospitalService_XJ m_objServ =
                (clsOutHospitalService_XJ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsOutHospitalService_XJ));
        ...
        {
            com.digitalwave.DiseaseTrackService.clsOutHospitalService_XJ objServ =
                    (com.digitalwave.DiseaseTrackService.clsOutHospitalService_XJ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.DiseaseTrackService.clsOutHospitalService_XJ));
