...
namespace iCare
{
	...
	/// 接班记录信息。
	/// </summary>
	public class clsTakeOverInfo	: clsDiseaseTrackInfo
	{
		clsPatient m_objCurrentPatient = null;
        public clsTakeOverInfo(clsPatient p_objPatient)
        {
		...
		public override string m_strGetTrackText()
		{
			...
			clsTakeOverRecordContent objContent=((clsTakeOverRecordContent)m_objRecordContent);
			string strText=m_strGetHeaderText();

			strText +="\n　　初步诊断:"+objContent.m_strOriginalDiagnose;
			strText +="\n　　目前诊断:"+objContent.m_strCurrentDiagnose;
			strText +="\n　　病情简介:"+objContent.m_strCaseHistory;
			strText +="\n　　诊疗计划:"+objContent.m_strReferral;
		...
		public override string m_strGetTrackXml()
		{
            ...
            string strXML4 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n　　病情简介:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML5 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n　　诊疗计划:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
		...
		private string m_strGetHeaderText()
		{
			...
			clsTakeOverRecordContent objContent=((clsTakeOverRecordContent)m_objRecordContent);
			string strText;
			strText=objContent.m_dtmCreateDate.ToString(MDIParent.s_ObjRecordDateTimeInfo.m_strGetRecordTimeFormat("frmTakeOver"))+"   "+"接班记录\n";
		...
		{
			return enmDiseaseTrackType.TakeOver;
		}
	...
	}// END CLASS DEFINITION clsTakeOverInfo
