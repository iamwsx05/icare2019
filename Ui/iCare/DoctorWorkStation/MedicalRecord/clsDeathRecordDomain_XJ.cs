...
namespace iCare
{
    ...
    /// </summary>
    public class clsDeathRecordDomain_XJ
    {
        /// <summary>
        /// 获取病人的该记录时间列表。
        /// </summary>
        ...
        {
            clsDeathRecordService_XJ m_objServ =
                (clsDeathRecordService_XJ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsDeathRecordService_XJ));
        ...
        {
            com.digitalwave.DiseaseTrackService.clsDeathRecordService_XJ objServ =
                    (com.digitalwave.DiseaseTrackService.clsDeathRecordService_XJ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.DiseaseTrackService.clsDeathRecordService_XJ));
