...
namespace iCare
{
    ...
    /// </summary>
    public class clsTalkRecordDomain_XJ
    {
        /// <summary>
        /// 获取病人的该记录时间列表。
        /// </summary>
        ...
        {
            clsTalkRecordService_XJ m_objServ =
                (clsTalkRecordService_XJ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(clsTalkRecordService_XJ));
        ...
        {
            com.digitalwave.DiseaseTrackService.clsTalkRecordService_XJ objServ =
                    (com.digitalwave.DiseaseTrackService.clsTalkRecordService_XJ)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.DiseaseTrackService.clsTalkRecordService_XJ));
