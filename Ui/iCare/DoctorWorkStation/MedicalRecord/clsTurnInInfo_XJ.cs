...
namespace iCare
{
    ...
    /// 转入记录信息--新疆 
    /// </summary>
    public class clsTurnInInfo_XJ : clsDiseaseTrackInfo
    {
        clsPatient m_objCurrentPatient = null;
        public clsTurnInInfo_XJ(clsPatient p_objPatient)
        {
        ...
        public override string m_strGetTrackText()
        {
            ...
            clsTurnInRecordContent_XJ objContent = ((clsTurnInRecordContent_XJ)m_objRecordContent);
        ...
        private string m_strGetHeaderText()
        {
            ...
            clsTurnInRecordContent_XJ objContent = ((clsTurnInRecordContent_XJ)m_objRecordContent);
            string strText;
            strText = objContent.m_dtmCreateDate.ToString(MDIParent.s_ObjRecordDateTimeInfo.m_strGetRecordTimeFormat("frmTurnIn_XJ")) + "   " + "转入记录\n";
        ...
        {
            return enmDiseaseTrackType.TurnIn_XJ;
        }
