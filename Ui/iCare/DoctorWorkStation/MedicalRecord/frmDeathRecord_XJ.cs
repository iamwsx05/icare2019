...
namespace iCare
{
    ...
    /// 死亡记录----新疆
    /// </summary>
    public partial class frmDeathRecord_XJ : iCare.frmDiseaseTrackBase
    {
        #region
        ...
        {
            clsDeathRecordInfo_XJ objTrackInfo = new clsDeathRecordInfo_XJ();
        ...
        protected override void m_mthClearRecordInfo()
        {
            ...
            m_txtOutXiYiDiagnose.m_mthClearText();
            m_txtInXiYiDiagnose.m_mthClearText();
        ...
        protected override clsTrackRecordContent m_objGetContentFromGUI()
        {
            ...
            //从界面获取表单值
            clsDeathRecordContent_XJ objContent = new clsDeathRecordContent_XJ();
        ...
        {
            //获取病程记录的领域层实例
            return new clsDiseaseTrackDomain(enmDiseaseTrackType.DeathRecord_XJ);
        }
        ...
        protected override void m_mthReAddNewRecord(clsTrackRecordContent p_objRecordContent)
        {
            ...
            clsDeathRecordContent_XJ objContent = (clsDeathRecordContent_XJ)p_objRecordContent;
            //把表单值赋值到界面，由子窗体重载实现
        ...
        private void frmDeathRecord_XJ_Load(object sender, EventArgs e)
        {
            m_mthfrmLoad();
        ...
        //private void frmOutHospital_XJ_Load(object sender, EventArgs e)
        //{
        ...
        clsDeathRecord_XJPrintTool objPrintTool;
        private void m_mthDemoPrint_FromDataSource()
        {
            if (m_blnHasInitPrintTool == false)
            {
                objPrintTool = new clsDeathRecord_XJPrintTool();
        ...
        protected override void m_mthSetDefaultValue(clsPatient p_objPatient)
        {
            ...
            try
            {
                ...
                clsDeathRecordDomain_XJ objDomain = new clsDeathRecordDomain_XJ();
        ...
        protected override bool m_blnSubReuse(clsInactiveRecordInfo_VO p_objSelectedValue)
        {
            ...
            {
                clsTrackRecordContent m_objContent = new clsDeathRecordContent_XJ();
                ...
                clsDeathRecordContent_XJ p_objContent = (clsDeathRecordContent_XJ)m_objContent;
        ...
        protected override void m_mthSubPreviewInactiveRecord(IWin32Window p_infOwner, clsInactiveRecordInfo_VO p_objSelectedValue)
        {
            ...
            if (m_objBaseCurrentPatient != null)
            {
                ...
                clsPrintInfo_DeathRecord_XJ objPrintInfo = new clsPrintInfo_DeathRecord_XJ();
                ...
                clsTrackRecordContent p_objContent = new clsDeathRecordContent_XJ();
        ...
        protected override clsInactiveRecordInfo_VO[] m_objSubGetAllInactiveInfo(clsInactiveRecordInfo_VO p_objSelectedValue)
        {
            ...
            new clsDeathRecordDomain_XJ().m_lngGetAllInactiveInfo(p_objSelectedValue.m_StrInpatientId, p_objSelectedValue.m_DtmInpatientDate, out objArr);
            return objArr;
        }
