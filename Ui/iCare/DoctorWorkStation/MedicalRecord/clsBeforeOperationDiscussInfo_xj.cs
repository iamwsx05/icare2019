...
namespace iCare
{
    ...
    public class clsBeforeOperationDiscussInfo_xj : clsDiseaseTrackInfo
    {
        ...
        public override string m_strGetTrackText()
        {
            ...
            clsBeforeOperationDiscussContent_xj objContent = ((clsBeforeOperationDiscussContent_xj)m_objRecordContent);
            ...
            strText += "\n　　术前准备情况:" + objContent.m_strNiZheng;
            strText += "\n　　主持人:" + objContent.m_strCompereName;
            strText += "\n　　参加人员:" + m_strGetName(objContent.m_strAttendeeNameArr);
            strText += "\n　　病史汇报者:" + objContent.m_strHuiBaoName;
            strText += "\n　　可能出现的以外及防范措施:" + objContent.m_strHuiBao;
            strText += "\n    手术指征及禁忌症:" + objContent.m_strTaoLunYiJian;
            strText += "\n    手术方案:" + objContent.m_strTaoLunXiaoJie;
        ...
        public override string m_strGetTrackXml()
        {
            ...
            string strXML3 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n    术前准备情况:" + objContent.m_strNiZheng, objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            ...
            string strXML7 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n　　可能出现的以外及防范措施:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML8 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n　　手术指征及禁忌症:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
            string strXML9 = ctlRichTextBox.clsXmlTool.s_strMakeTextXml("\n　 手术方案:", objContent.m_strCreateUserID, strCreateUserName, System.Drawing.Color.White);
        ...
        private string m_strGetHeaderText()
        {
            ...
            clsBeforeOperationDiscussContent_xj objContent = ((clsBeforeOperationDiscussContent_xj)m_objRecordContent);
            string strText;
            strText = objContent.m_dtmCreateDate.ToString(MDIParent.s_ObjRecordDateTimeInfo.m_strGetRecordTimeFormat("frmBeforeOperationDiscuss_xj")) + "   " + "术前讨论记录";
            return strText;
        }
        ...
        {
            return enmDiseaseTrackType.BeforeOperationDiscuss_xj;
        }
