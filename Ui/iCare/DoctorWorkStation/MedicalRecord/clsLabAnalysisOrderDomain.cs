...
namespace iCare
{
    ...
    public class clsLabAnalysisOrderDomain
    {
        ...
        /// <returns></returns>
        public long m_lngAddNewRecord2DB(weCare.Core.Entity.clsLabCheckOrderContent p_objRecordContent)
        {
            //com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService m_objServ =
            //    (com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService));
        ...
        /// <param name="p_objRecordContent"></param>
        /// <returns></returns>
        public long m_lngGetRecordContentWithServ(string p_strInPatientID, string p_strInPatientDate, string p_strCreateDate, out weCare.Core.Entity.clsLabCheckOrderContent p_objRecordContent)
        {
            //com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService m_objServ =
            //    (com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService));
        ...
        /// <param name="p_objRecordContent"></param>
        /// <returns></returns>
        public long m_lngDeleteRecord2DB(weCare.Core.Entity.clsLabCheckOrderContent p_objRecordContent)
        {
            //com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService m_objServ =
            //    (com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService));
        ...
        /// <returns></returns>
        public long m_lngGetAllLabCheckAlias(out weCare.Core.Entity.clsPublicIDAndName[] p_strAliasArr)
        {
            //com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService m_objServ =
            //    (com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService)com.digitalwave.iCare.common.clsObjectGenerator.objCreatorObjectByType(typeof(com.digitalwave.LabAnalysisOrderService.clsLabAnalysisOrderService));
