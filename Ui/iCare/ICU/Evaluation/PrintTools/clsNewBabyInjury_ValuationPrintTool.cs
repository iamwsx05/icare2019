...
namespace iCare.ICU.Evaluation
{
	...
	/// 新生儿危重病例评分打印工具
	/// </summary>
	public class clsNewBabyInjury_ValuationPrintTool: clsValuationPrintBase
	{
		public clsNewBabyInjury_ValuationPrintTool()
		{}
		...
		{
			p_objGrp.DrawString("新生儿危重病例评分法（草案）",m_fotItemHead,m_slbBrush,290,60);
		}
		...
		private class clsPrintValuation: clsPrintValuationInfo
		{
			...
			private clsEvalInfoOfNewBabyInjuryCaseEvaluation m_objPrintSubInfo;
			...
			{
				m_objPrintSubInfo = m_objPrintInfo as clsEvalInfoOfNewBabyInjuryCaseEvaluation;
			...
			private void m_mthPrintBabyInjury(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				p_objGrp.DrawString("呼吸： " + m_objPrintSubInfo.strBreath + "    次/分",p_fntNormalText,Brushes.Black,m_intXPos+20,p_intPosY);
				...
				p_objGrp.DrawString("红细胞积压比： " + m_objPrintSubInfo.strRedCellComp,p_fntNormalText,Brushes.Black,m_intXPos+350,p_intPosY);
				p_intPosY += 30;
				...
				p_objGrp.DrawString("肠胃表现： " + m_objPrintSubInfo.strStomachAndIntestines,p_fntNormalText,Brushes.Black,m_intXPos+20,p_intPosY);
			...
			private void m_mthPrintResult(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				#region 
				p_intPosY += 20;
				p_objGrp.DrawString("新生儿危重病例评分法（草案）结果：",p_fntNormalText,Brushes.Black,m_intXPos,p_intPosY);
				p_intPosY += 30;
				m_intXPos += 40;
				int i=0;
				for(;i<=11;i++)
				...
				p_objGrp.DrawString("红细胞积压比",p_fntNormalText,Brushes.Black,m_intXPos,p_intPosY+4);
