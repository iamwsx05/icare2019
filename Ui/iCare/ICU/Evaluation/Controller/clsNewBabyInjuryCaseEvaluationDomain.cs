...
{
	/// <summary>
	/// Summary description for clsNewBabyInjuryCaseEvaluationDomain.
	/// </summary>
	public class clsNewBabyInjuryCaseEvaluationDomain
	{
		#region Member		
		/// <summary>
		/// 生成Xml的缓冲
		...
		#region Constructor
		public clsNewBabyInjuryCaseEvaluationDomain()
		{
			//
		...
		public DateTime [] m_dtmGetTimeInfoOfAPatientArr(string p_strInPatientID,string p_strInPatientDate,string p_strFromDate, string p_strToDate)
		{
            ...
            long lngRes = (new weCare.Proxy.ProxyEmr07()).Service.clsEvaluation_QuerySvc_m_lngGetTimeInfoOfAPatient("newbabyinjurycaseevaluation", p_strInPatientID, p_strInPatientDate, p_strFromDate, p_strToDate, ref strXml, ref intRows);
		...
		#region Save
		public long m_lngSave(clsEvalInfoOfNewBabyInjuryCaseEvaluation p_objBabyInjuryCaseEvaluationDB)
		{
            ...
            return (new weCare.Proxy.ProxyEmr07()).Service.clsEvaluation_UpdataSvc_m_lngAddNew("newbabyinjurycaseevaluation", strMainXml);
		}

		private string m_mthGetMainXml(clsEvalInfoOfNewBabyInjuryCaseEvaluation p_objBabyInjuryCaseEvaluationDB)
		{
			if(p_objBabyInjuryCaseEvaluationDB == null)
				return null;
...
//				m_objXmlWriter.WriteAttributeString("HBSEL", p_objBabyInjuryCaseEvaluationDB.strHbSel.Replace('\'','き'));
		...
		#region 读取信息
		public long m_lngGetNewBabyInjuryCaseValue(string p_strInPatientID, string p_strInPatientDate, string p_strCreateDate, out clsEvalInfoOfNewBabyInjuryCaseEvaluation p_objBabyInjuryCaseEvaluationDB)
		{
			...
			int intRows = 0;
            //clsEvaluation_QuerySvc objSvc = (clsEvaluation_QuerySvc)clsObjectGenerator.objCreatorObjectByType(typeof(clsEvaluation_QuerySvc));
            long lngRes = (new weCare.Proxy.ProxyEmr07()).Service.clsEvaluation_QuerySvc_m_lngGetEvaluationData("newbabyinjurycaseevaluation", p_strInPatientID, p_strInPatientDate, p_strCreateDate, ref strXml, ref intRows);
			...
			p_objBabyInjuryCaseEvaluationDB = new clsEvalInfoOfNewBabyInjuryCaseEvaluation();
...
//							p_objBabyInjuryCaseEvaluationDB.strHbSel=	 objReader.GetAttribute("HBSEL").ToString().Replace ('き','\'');	
							p_objBabyInjuryCaseEvaluationDB.strRedCellComp = objReader.GetAttribute("REDCELLCOMP").ToString().Replace ('き','\'');	
		...
		public long m_lngDeactive(string p_strDeactiveUserID,string p_strInPatientID,string p_strInPatientDate,string p_strCreateDate)
		{
            ...
            //clsEvaluation_UpdataSvc objSvc = (clsEvaluation_UpdataSvc)clsObjectGenerator.objCreatorObjectByType(typeof(clsEvaluation_UpdataSvc));
            long lngRes = (new weCare.Proxy.ProxyEmr07()).Service.clsEvaluation_UpdataSvc_m_lngDeActiveRecord("newbabyinjurycaseevaluation", strDeactiveXML);			
			if(lngRes <= 0)
				return -1;
	...
	public class clsEvalInfoOfNewBabyInjuryCaseEvaluation
	{
