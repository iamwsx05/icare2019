...
{
    /// <summary>
    /// 危重患者护理记录(茶山,外科)打印工具类(新版)摘要说明。
    /// </summary>
    public class clsIntensiveTendMain_CSWKPrintTool : infPrintRecord
    {
        ...
        private string strCustomName2 = "";                      //自定义列名2


        private object[][] objDataArr;
        private bool m_bSummaryRow = false;
        public clsIntensiveTendMain_CSWKPrintTool(string p_strCustomName, string p_strCustomName2)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        {	//m_objprintinfo为空表明未设置打印内容		
            ...
            if (m_objPrintInfo.m_strInPatentID == "")
                return;
            //获取打印内容
            m_objRecordsDomain = new clsRecordsDomain(enmRecordsType.IntensiveTendMain_CSWKRec);
        ...
        public void m_mthInitPrintTool(object p_objArg)
        {
            ...
            //m_objPrintLenth.m_intPrintLenth_RecordContent = (int)((float)(enmRecordRectangleInfo.ColumnsMark25 - enmRecordRectangleInfo.ColumnsMark24 - 6) / 17.5) + 1;//病程记录，填充汉字

            m_objPrintLenth.m_intPrintLenth_Look = (int)((float)(enmRecordRectangleInfo.ColumnsMark21 - enmRecordRectangleInfo.ColumnsMark20) / 8.75) + 1;
            ...
            m_objPrintLenth.m_intPrintLenth_Custom2 = (int)((float)(enmRecordRectangleInfo.ColumnsMark22 - enmRecordRectangleInfo.ColumnsMark21) / 8.75) + 1;
        ...
        private class clsPrintLenth_GeneralNurseRecordCS
        {
            ...
            public int m_intPrintLenth_Custom2;				//自定义列2 
        }
        ...
        {//A4纸，横向打印：1170*827
            ...
            /// 时间
            /// </summary>
            ColumnsMark1 = 60 - inty,//时间35
            /// <summary>
            /// //体温
            /// </summary>
            ColumnsMark2 = 95 - inty,//体温30
            /// <summary>
            /// 心率
            /// </summary>
            ColumnsMark3 = 125 - inty,//心率30
            /// <summary>
            /// 呼吸
            /// </summary>
            ColumnsMark4 = 155 - inty,//呼吸30
            /// <summary>
            /// 血压
            /// </summary>
            ColumnsMark5 = 185 - inty,//血压50
            /// <summary>
            /// SpO2
            /// </summary>
            ColumnsMark6 = 235 - inty,//SpO2 30
            /// <summary>
            /// CVP
            /// </summary>
            ColumnsMark7 = 265 - inty,//CVP 30
            /// <summary>
            /// 神志
            /// </summary>
            ColumnsMark8 = 295 - inty,//神志 30
            /// <summary>
            /// 瞳孔大小左
            /// </summary>
            ColumnsMark9 = 325 - inty,//瞳孔大小左 30

            /// <summary>
            /// 瞳孔大小右
            /// </summary>
            ColumnsMark10 = 355 - inty,//瞳孔大小右 30

            /// <summary>
            /// 瞳孔反射左
            /// </summary>
            ColumnsMark11 = 385 - inty,//瞳孔反射左 30

            /// <summary>
            /// 瞳孔反射右
            /// </summary>
            ColumnsMark12 = 415 - inty,//瞳孔反射右 30 

            /// <summary>
            /// 摄入种类
            /// </summary>
            ColumnsMark13 = 445 - inty,//摄入种类 30
            /// <summary>
            /// 摄入量
            /// </summary>
            ColumnsMark14 = 475 - inty,//摄入量 30
             
            /// <summary>
            /// 排出种类
            /// </summary>
            ColumnsMark15 = 505 - inty,//排出种类 30
            /// <summary>
            /// 排出量
            /// </summary>
            ColumnsMark16 = 535 - inty,//排出量 30

           /// <summary>
            /// 排出颜色
           /// </summary>
            ColumnsMark17 = 565 - inty,  //排出颜色 30
              
            /// <summary>
            /// 皮温
            /// </summary>
            ColumnsMark18 = 595 - inty,//皮温 30
            /// <summary>
            /// 颜色
            /// </summary>
            ColumnsMark19 = 625 - inty,//颜色 30 
            /// <summary>
            /// 张力
            /// </summary>
            ColumnsMark20 = 655 - inty,//张力 30 
            /// <summary>
            /// CAP反应
            /// </summary>
            ColumnsMark21 = 685 - inty,//CAP反应 30
            /// <summary>
            /// 自定义列
            /// </summary>
            ColumnsMark22 = 715 - inty,//自定义列 30
            /// <summary>
            /// 自定义列2
            /// </summary>
            ColumnsMark23 = 745 - inty,//自定义列 30
            /// <summary>
            /// 病情观察
            /// </summary>
            ColumnsMark25 = 775 - inty,//病情观察 125
            /// <summary>
            /// 记录签名
            /// </summary>
            ColumnsMark26 = 990 - inty//记录签名
        }
            ...
            public PointF m_getCoordinatePoint(int p_intItemName)
            {
                ...
                switch (p_intItemName)
                {
                    ...
                    case (int)enmItemDefination.Page_HospitalName:
                        m_fReturnPoint = new PointF(485f, 40f - inty+5);
                        break;
                    case (int)enmItemDefination.Page_Name_Title:
                        m_fReturnPoint = new PointF(535f, 80f - inty);
                        break;
                    case (int)enmItemDefination.Name_Title:
                        m_fReturnPoint = new PointF(110f, 120f - inty);
                        break;
                    case (int)enmItemDefination.Name:
                        m_fReturnPoint = new PointF(160f, 120f - inty);
                        break;

                    case (int)enmItemDefination.Sex_Title:
                        m_fReturnPoint = new PointF(290f, 120f - inty);
                        break;
                    ...
                    case (int)enmItemDefination.Age_Title:
                        m_fReturnPoint = new PointF(400f, 120f - inty);
                        break;
                    ...
                    case (int)enmItemDefination.Dept_Name_Title:
                        m_fReturnPoint = new PointF(570f, 120f - inty);
                        break;
                    ...
                    case (int)enmItemDefination.BedNo_Title:
                        m_fReturnPoint = new PointF(750f, 120f - inty);
                        break;
                    case (int)enmItemDefination.BedNo:
                        m_fReturnPoint = new PointF(800f, 120f - inty);
                        break;

                    case (int)enmItemDefination.InPatientID_Title:
                        m_fReturnPoint = new PointF(880f, 120f - inty);
                        break;
                    case (int)enmItemDefination.InPatientID:
                        m_fReturnPoint = new PointF(945f, 120f - inty);
                        break;
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            //e.Graphics.DrawString("护理记录单", new Font("黑体", 18), m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title));
            ...
            SizeF m_szfChildTitle = e.Graphics.MeasureString("护理记录单", new Font("黑体", 18));
            ...
            e.Graphics.DrawString(clsSystemContext.s_ObjCurrentContext.m_ObjHospitalInfo.m_StrHospitalTitle, new Font("宋体", 15, FontStyle.Bold), m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_HospitalName));
            e.Graphics.DrawString("护理记录单", new Font("黑体", 18), m_slbBrush, m_intChildTitleNameOffSetX, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title).Y);
        ...
        {
            //日期
            e.Graphics.DrawString("日 期", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX + 3,
                (int)enmRecordRectangleInfo.TopY + 35);

            //时间
            e.Graphics.DrawString("时", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark1 + 8, (int)enmRecordRectangleInfo.TopY + 10);
            e.Graphics.DrawString("间", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark1 + 8, (int)enmRecordRectangleInfo.TopY + 70);
            ...
            e.Graphics.DrawString("温", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark2 + 6, (int)enmRecordRectangleInfo.TopY + 35);
            e.Graphics.DrawString("。", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark2 + 4, (int)enmRecordRectangleInfo.TopY +60);
            e.Graphics.DrawString("C", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark2 + 8, (int)enmRecordRectangleInfo.TopY + 71);
            ...
            e.Graphics.DrawString("率", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark3 + 8, (int)enmRecordRectangleInfo.TopY + 22);
            e.Graphics.DrawString("次", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark3 + 8, (int)enmRecordRectangleInfo.TopY + 39);
            e.Graphics.DrawString("/", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark3 + 10, (int)enmRecordRectangleInfo.TopY + 55);
            e.Graphics.DrawString("分", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark3 + 8, (int)enmRecordRectangleInfo.TopY + 70);
            ...
            e.Graphics.DrawString("吸", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark4 + 6, (int)enmRecordRectangleInfo.TopY + 22);
            e.Graphics.DrawString("次", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark4 + 6, (int)enmRecordRectangleInfo.TopY + 39);
            e.Graphics.DrawString("/", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark4 + 6, (int)enmRecordRectangleInfo.TopY + 55);
            e.Graphics.DrawString("分", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark4 + 6, (int)enmRecordRectangleInfo.TopY + 70);
            ...
            e.Graphics.DrawString("压", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark5 + 17, (int)enmRecordRectangleInfo.TopY + 42);
            e.Graphics.DrawString("mmHg", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark5 + 12, (int)enmRecordRectangleInfo.TopY + 70);
            ...
            e.Graphics.DrawString("O", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark6 + 6, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("2", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark6 + 12, (int)enmRecordRectangleInfo.TopY + 42);
            e.Graphics.DrawString("%", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark6 + 6, (int)enmRecordRectangleInfo.TopY + 70);

            //CVP
            e.Graphics.DrawString("C", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark7 + 10, (int)enmRecordRectangleInfo.TopY + 5);
            e.Graphics.DrawString("V", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark7 + 10, (int)enmRecordRectangleInfo.TopY + 18);
            e.Graphics.DrawString("P", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark7 + 10, (int)enmRecordRectangleInfo.TopY + 42);
            e.Graphics.DrawString("CmH O", new Font("SimSun",7), m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark7 + 1, (int)enmRecordRectangleInfo.TopY + 70);
            e.Graphics.DrawString("2", new Font("SimSun", 7), m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark7 + 17, (int)enmRecordRectangleInfo.TopY + 74);
            //神志
            e.Graphics.DrawString("神", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark8 + 7, (int)enmRecordRectangleInfo.TopY + 10);
            e.Graphics.DrawString("志", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark8 + 7, (int)enmRecordRectangleInfo.TopY + 70);

            //瞳孔
            e.Graphics.DrawString(" 瞳   孔", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark9 + 30, (int)enmRecordRectangleInfo.TopY + 5);
            e.Graphics.DrawString("大小\n(mm)", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark9 + 10, (int)enmRecordRectangleInfo.TopY + 28);
            e.Graphics.DrawString("左", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark9 + 6, (int)enmRecordRectangleInfo.TopY + 68);
            e.Graphics.DrawString("右", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark10 + 6, (int)enmRecordRectangleInfo.TopY + 68);
            e.Graphics.DrawString("反射", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark11 + 15, (int)enmRecordRectangleInfo.TopY + 35);
            e.Graphics.DrawString("左", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark11 + 6, (int)enmRecordRectangleInfo.TopY + 68);
            e.Graphics.DrawString("右", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark12 + 6, (int)enmRecordRectangleInfo.TopY + 68);

            //摄入
            e.Graphics.DrawString("摄 入", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark13 + 12, (int)enmRecordRectangleInfo.TopY + 5);
            e.Graphics.DrawString("种", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark13 + 7, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("类", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark13 + 7, (int)enmRecordRectangleInfo.TopY + 70);
            e.Graphics.DrawString("量", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark14 + 7, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("ml/g", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark14 + 1, (int)enmRecordRectangleInfo.TopY + 70);

            //排出
            e.Graphics.DrawString("排出", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark15 + 27, (int)enmRecordRectangleInfo.TopY + 5);
            e.Graphics.DrawString("种", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark15 + 8, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("类", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark15 + 8, (int)enmRecordRectangleInfo.TopY + 70);
            e.Graphics.DrawString("量", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark16 + 6, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("ml/g", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark16 + 1, (int)enmRecordRectangleInfo.TopY + 70);
            e.Graphics.DrawString("颜", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
               (int)enmRecordRectangleInfo.ColumnsMark17 + 6, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("色", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark17 + 6, (int)enmRecordRectangleInfo.TopY + 70);

            //血循环观察
            e.Graphics.DrawString("血循环观察", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark18 + 35, (int)enmRecordRectangleInfo.TopY + 5);
            e.Graphics.DrawString("皮", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark18 + 7, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("温", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark18 + 7, (int)enmRecordRectangleInfo.TopY + 70);
            e.Graphics.DrawString("颜", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark19 + 7, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("色", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark19 + 7, (int)enmRecordRectangleInfo.TopY + 70);
            e.Graphics.DrawString("张", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark20 + 7, (int)enmRecordRectangleInfo.TopY + 38);
            e.Graphics.DrawString("力", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark20 + 7, (int)enmRecordRectangleInfo.TopY + 70);
            e.Graphics.DrawString("CAP", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark21 + 4, (int)enmRecordRectangleInfo.TopY + 34);
            e.Graphics.DrawString("反", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark21 + 7, (int)enmRecordRectangleInfo.TopY + 55);
            e.Graphics.DrawString("应", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
               (int)enmRecordRectangleInfo.ColumnsMark21 + 7, (int)enmRecordRectangleInfo.TopY + 70);


            //自定义列1
            strCustomName = strCustomName.Replace("\r\n", "");
            e.Graphics.DrawString(strCustomName, new Font("Simsun", 10.5f), m_slbBrush, new RectangleF((int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark22, (int)enmRecordRectangleInfo.TopY + 25, (int)enmRecordRectangleInfo.ColumnsMark23 - (int)enmRecordRectangleInfo.ColumnsMark22, 100), new StringFormat(StringFormatFlags.LineLimit));
            //if (strCustomName.Length == 1)
            //{
            //    e.Graphics.DrawString(strCustomName, m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
            //        (int)enmRecordRectangleInfo.ColumnsMark22 + 7, (int)enmRecordRectangleInfo.TopY + 50);
            //}
            ...
            //        (int)enmRecordRectangleInfo.ColumnsMark22 + 8, (int)enmRecordRectangleInfo.TopY + 30);
            //    e.Graphics.DrawString(strCustomName.Substring(1), m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
            //        (int)enmRecordRectangleInfo.ColumnsMark22 + 8, (int)enmRecordRectangleInfo.TopY + 80);
            //}
            //else
            //{
            ...
            //        (int)enmRecordRectangleInfo.ColumnsMark22 + 7, (int)enmRecordRectangleInfo.TopY + i * 25 + 25);
            //    }
            //}

            //自定义列2
            strCustomName2 = strCustomName2.Replace("\r\n", "");
            e.Graphics.DrawString(strCustomName2, new Font("Simsun", 9f), m_slbBrush, new RectangleF((int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark23, (int)enmRecordRectangleInfo.TopY + 5, (int)enmRecordRectangleInfo.ColumnsMark25 - (int)enmRecordRectangleInfo.ColumnsMark23, 80), new StringFormat(StringFormatFlags.LineLimit));
            ...
            //        (int)enmRecordRectangleInfo.ColumnsMark23 + 7, (int)enmRecordRectangleInfo.TopY + 35);
            //}
            ...
            //        (int)enmRecordRectangleInfo.ColumnsMark23 + 8, (int)enmRecordRectangleInfo.TopY + 5);
            //    e.Graphics.DrawString(strCustomName2.Substring(1), m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
            //        (int)enmRecordRectangleInfo.ColumnsMark23 + 8, (int)enmRecordRectangleInfo.TopY + 80);
            //}
            //else
            //{
            ...
            //        (int)enmRecordRectangleInfo.ColumnsMark23 + 7, (int)enmRecordRectangleInfo.TopY + i * 25 + 5);
            //    }
            //}
            ...
            e.Graphics.DrawString(" 病情、护理措施、效果", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark25 + 10, (int)enmRecordRectangleInfo.TopY + 30);

            //记录签名
            e.Graphics.DrawString("记", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark26 + 19, (int)enmRecordRectangleInfo.TopY + 8);
            e.Graphics.DrawString("录", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark26 + 19, (int)enmRecordRectangleInfo.TopY + 30);
            e.Graphics.DrawString("签", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark26 + 19, (int)enmRecordRectangleInfo.TopY + 52);
            e.Graphics.DrawString("名", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark26 + 19, (int)enmRecordRectangleInfo.TopY + 75);
        }
        #endregion
        ...
        private void m_mthPrintRectangleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i1 = 0; i1 <= (int)enmRecordRectangleInfo.RowLinesNum; i1++)
            {
                if (i1 != 1 && i1 != 2)
                    ...
                    e.Graphics.DrawLine(m_GridPen, (int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark9,
                        ...
                        (int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark23,
                        (int)enmRecordRectangleInfo.TopY + ((int)enmRecordRectangleInfo.RowStep) * i1 - 8);
                else //if(i1==2)
                    e.Graphics.DrawLine(m_GridPen, (int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark9,
                        (int)enmRecordRectangleInfo.TopY + ((int)enmRecordRectangleInfo.RowStep) * i1,
            ...
            e.Graphics.DrawLine(m_GridPen, (int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark14, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep - 8,
            ...
            //血循环中间分界线
            e.Graphics.DrawLine(m_GridPen, (int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark18, (int)enmRecordRectangleInfo.TopY,
        ...
        private void m_mthAddDataToGrid(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            intNowRow = 1;
            int iTemp = (int)enmRecordRectangleInfo.TopY + ((int)enmRecordRectangleInfo.RowStep * ((int)enmRecordRectangleInfo.RowLinesNum)) + 2;
            strRecord = " （供外科使用） 注：SpO";
            string strRecord2="指经皮血氧饱和度（动脉血氧饱和度）； Cvp指中心静脉压； Cap反应指毛细血管反应                        （第" + intNowPage.ToString() + "页）";
            ...
            e.Graphics.DrawString(strRecord, this.m_fotTinyFont, m_slbBrush, (float)enmRecordRectangleInfo.LeftX, (float)iTemp+5);
            e.Graphics.DrawString("2", this.m_fotTinyFont, m_slbBrush, (float)enmRecordRectangleInfo.LeftX + 148, (float)iTemp + 3+5);//2下标
            e.Graphics.DrawString(strRecord2, this.m_fotTinyFont, m_slbBrush, (float)enmRecordRectangleInfo.LeftX + 155, (float)iTemp+5);
            strRecord = "";
        ...
        private enmReturnValue m_blnPrintOneRowValueCS(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (strTemp != "")
            {
                ...
                {
                    m_mthDrawMultiString(this.m_fotTinyFont, this.m_fotTinyFont, 4, m_intPosX - 10, m_intPosY, m_intPosX1, m_intPosY1, m_intXOff - 5, m_intYOff - 10, strBloodPress[0], e);
                    m_mthDrawMultiString(this.m_fotTinyFont, this.m_fotTinyFont, 4, m_intPosX + 1, m_intPosY - 5, m_intPosX1, m_intPosY1, m_intXOff + 5, m_intYOff + 10, strBloodPress[1], e);
                }
                else
            ...
            m_intPosX1 = (int)enmRecordRectangleInfo.RightX;//当前的X坐标
            intTempColumn = 30;
            strTemp = m_strConvertObjectValue(objDataArr[m_intCurrentContentRow][intTempColumn]);
            if (strTemp.Trim().Length != 0)
            {
                ...
                if (imgEmpSig != null)
                {
                    //e.Graphics.DrawImage(imgEmpSig, m_intPosX+2, m_intPosY, 67, 28);
        ...
        private void m_mthSetOtherDetail(object[] objDetail, int intCurrentDetail, int intRowOfCurrentDetail, clsGeneralNurseRecordContent_CS objCurrent, out object[] objOtherDetail)
        {
            ...
            objOtherDetail[31] = (DateTime)objDetail[3];
        }
        ...
        private object[][] m_objGetRecordsValueArr(clsTransDataInfo p_objTransDataInfo)
        {
            ...
            try
            {
                ...
                if (objGNRCInfo.m_objDetailArr != null)
                {
                    ...
                    for (int n = 0; n < objGNRCInfo.m_objDetailArr.Length; n++)
                    {
                        ...
                        //将病情记录分为行。
                        com.digitalwave.controls.ctlRichTextBox.m_mthSplitXmlByBytes(strDetail, strDetailXML, 30, out strDetailArr, out strDetailXMLArr);
                        ...
                        {//若当前记录日期与病情观察记录日期相同，先输出当前记录，再输出病情观察记录
                            ...
                            for (int m = 0; m < m_intMax; m++)
                            {
                                ...
                                if (m < ((string[])(((object[])arlDetail[intCurrentDetail])[0])).Length)
                                {
                                    ...
                                    objData[31] = (DateTime)((object[])arlDetail[intCurrentDetail])[3];
                                }
            ...
            {
                MessageBox.Show("i= " + i.ToString() + "      " +ex.Message);
                return null;
            }
            #endregion
        }
