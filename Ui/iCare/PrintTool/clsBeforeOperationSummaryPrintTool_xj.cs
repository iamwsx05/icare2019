...
namespace iCare
{
    ...
    /// 术前小结---新疆 的打印工具类
    /// </summary>
    public class clsBeforeOperationSummaryPrintTool_xj : infPrintRecord
    {
        ...
        private clsBeforeOperationSummaryDomain_xj m_objRecordsDomain;
        private clsPrintInfo_BeforeOperationSummary_xj m_objPrintInfo;
        private clsBeforeOperationSummaryContent_xj m_objRecordContent = null;
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            m_objPrintInfo = new clsPrintInfo_BeforeOperationSummary_xj();
        ...
        public void m_mthInitPrintContent()
        {
            ...
            {
                m_objRecordsDomain = new clsBeforeOperationSummaryDomain_xj();
                ...
                if (lngRes <= 0)
                    return;
                m_objRecordContent = (clsBeforeOperationSummaryContent_xj)objContent;
            }
        ...
        public void m_mthSetPrintContent(object p_objPrintContent)
        {
            ...
            m_blnWantInit = false;
            if (p_objPrintContent.GetType().Name != "clsPrintInfo_BeforeOperationSummary_xj")
            {
                clsPublicFunction.ShowInformationMessageBox("参数错误");
                return;
            }
            m_blnIsFromDataSource = false;//表明是从文件直接提取信息
            m_objPrintInfo = (clsPrintInfo_BeforeOperationSummary_xj)p_objPrintContent;
        ...
        private void m_mthPrintPageSub(PrintPageEventArgs e)
        {
            ...
            if (m_objRecordContent != null)
            {
                ...
                if (objEmpVO != null)
                    strMainName = objEmpVO.ToString();
                //objEmployeeSign.m_lngGetEmpByNO(m_objRecordContent.m_strDoctorID, out objEmpVO);
                //if (objEmpVO != null)
                //    strDocName = objEmpVO.ToString();
            }
            e.Graphics.DrawString("医师签名:" + strMainName, new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 200, m_intYPos);
            //			m_intYPos+=25;
            ...
            public PointF m_getCoordinatePoint(int p_intItemName)
            {
                ...
                switch (p_intItemName)
                {
                    ...
                    case (int)enmItemDefination.Name_Title:
                        m_fReturnPoint = new PointF(40f, 140f);
                        break;
                    case (int)enmItemDefination.Name:
                        m_fReturnPoint = new PointF(85f, 140f);
                        break;
                    ...
                    case (int)enmItemDefination.InPatientID:
                        m_fReturnPoint = new PointF(595f, 140f);
                        break;
        ...
        private void m_mthSetPrintValue()
        {
            ...
            #region 打印行初始化
            m_objLine1Arr = new clsPrintLine1[9];
            ...
            m_objLine2Arr[1] = new clsPrintLine2(390);
            m_objLine2Arr[2] = new clsPrintLine2(480);
            m_objLine2Arr[3] = new clsPrintLine2(580);
            m_objLine2Arr[4] = new clsPrintLine2(680);
            m_objLine2Arr[5] = new clsPrintLine2(780);
            //     m_objLine2Arr[3] = new clsPrintLine2(790);
            m_objPrintContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
										 m_objLine1Arr[1],m_objLine1Arr[2],m_objLine1Arr[3],m_objLine1Arr[4],m_objLine1Arr[5],m_objLine1Arr[6],m_objLine1Arr[7],m_objLine1Arr[8],
                                         m_objLine2Arr[0],m_objLine2Arr[1],m_objLine2Arr[2],m_objLine2Arr[3],m_objLine2Arr[4],m_objLine2Arr[5]
									  });
            ...
            if (m_objRecordContent != null)
            {
                ...
                if (m_objRecordContent.m_dtmOutHospitalDate != DateTime.MinValue
                    ...
                    strOutDate = m_objRecordContent.m_dtmOutHospitalDate.ToString("yyyy年MM月dd日 HH:mm ");
                Object[] objData1 = new object[6];
                objData1[0] = "";
                objData1[1] = "";
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "入院日期: " + m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日") + "　　　　　　　　　　　" + "记录时间: " + strOutDate;
                m_objLine1Arr[1].m_ObjPrintLineInfo = objData1;

                ///////////////2行/////////////////
                objData1[0] = "T：" + m_objRecordContent.m_strT + "℃ P：" + m_objRecordContent.m_strP + "次/分 R:" + m_objRecordContent.m_strR + "次/分 BP：" + m_objRecordContent.m_strBP1 + "/" + m_objRecordContent.m_strBP2 + "mmHg";
                objData1[1] = "";//m_objRecordContent.m_strInHospitalCase_Right;
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "术前检查:";
                m_objLine1Arr[2].m_ObjPrintLineInfo = objData1;

                ///////////////2行/////////////////
                objData1[0] = "HGB：" + m_objRecordContent.m_strHGB + "g/L RBC：" + m_objRecordContent.m_strRBC + "×10⒓/L WBC:" + m_objRecordContent.m_strWBC + "×10/L GRA：" + m_objRecordContent.m_strGRA + "% LYM：" + m_objRecordContent.m_strLYM + "% 血型：" + m_objRecordContent.m_strXueXing;
                objData1[1] = "";// m_objRecordContent.m_strInHospitalDiagnose_Right;
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "血 Rt:";
                m_objLine1Arr[3].m_ObjPrintLineInfo = objData1;
                //////////////////////////////////////////////
                objData1[0] = "PT：" + m_objRecordContent.m_strPT + "，FTB：" + m_objRecordContent.m_strFTB + "，APTT:" + m_objRecordContent.m_strAPTT + "，肾功 BUN：" + m_objRecordContent.m_strBUN + "，Cr：" + m_objRecordContent.m_strCr + "，血糖：" + m_objRecordContent.m_strXueTang;
                objData1[1] = "";// m_objRecordContent.m_strInHospitalDiagnose_Right;
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "血 凝:";
                ...
                ///////////////////////////////////////
                objData1[0] = "ALT：" + m_objRecordContent.m_strALT + "，AST：" + m_objRecordContent.m_strAST + "，TBIL:" + m_objRecordContent.m_strTBIL + "，DBIL：" + m_objRecordContent.m_strDBIL + "，IBIL：" + m_objRecordContent.m_strIBIL + "，ALP：" + m_objRecordContent.m_strALP + "，GGT：" + m_objRecordContent.m_strGGT;
                objData1[1] = "";// m_objRecordContent.m_strInHospitalDiagnose_Right;
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "肝功:";
                ...
                ///////////////////////////////////////
                objData1[0] = "HBsAg：" + m_objRecordContent.m_strHBsAg + "，HBsAb：" + m_objRecordContent.m_strHBsAb + "，HBeAg:" + m_objRecordContent.m_strHBeAg + "，HBeAb：" + m_objRecordContent.m_strHBeAb + "，HBcAb：" + m_objRecordContent.m_strHBcAb + "，HBcIg：" + m_objRecordContent.m_strHBcIg;
                objData1[1] = "";// m_objRecordContent.m_strInHospitalDiagnose_Right;
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "已功:";
                ...
                ///////////////////////////////////////
                objData1[0] = "甲肝:HAVAb：" + m_objRecordContent.m_strHAVAb + "，丙肝：HCVAb：" + m_objRecordContent.m_strHCVAb + "，梅毒：RPR:" + m_objRecordContent.m_strRPR + "，爱滋病：HIVAb：" + m_objRecordContent.m_strHIVAb; 
                objData1[1] = "";// m_objRecordContent.m_strInHospitalDiagnose_Right;
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "";
                ...
                ///////////////////////////////////////
                objData1[0] = "心电图：" + m_objRecordContent.m_strXinDianTu + "，胸透：" + m_objRecordContent.m_strXiongTou + "，其他：" + m_objRecordContent.m_strQiTa ;
                objData1[1] = "";// m_objRecordContent.m_strInHospitalDiagnose_Right;
                objData1[2] = dtmFirstPrintTime;
                objData1[3] = "";
                ...
                ///////////////5行/////////////////
                objData1[0] = m_objRecordContent.m_strJianYaoBingQing;
                objData1[1] = m_objRecordContent.m_strJianYaoBingQingXML;
                objData1[3] = "简要病情:";
                ...
                ///////////////7行/////////////////
                objData1[0] = m_objRecordContent.m_strShuQianZhengDuan;
                objData1[1] = m_objRecordContent.m_strShuQianZhengDuanXML;
                objData1[3] = "术前诊断:";
                m_objLine2Arr[1].m_ObjPrintLineInfo = objData1;
                ///////////////8行/////////////////			
                objData1[0] = m_objRecordContent.m_strShouShuZhiZheng;
                objData1[1] = m_objRecordContent.m_strShouShuZhiZhengXML;
                objData1[3] = "手术指征:";
                m_objLine2Arr[2].m_ObjPrintLineInfo = objData1;
                //////////////////////////////////////////////////
                objData1[0] = m_objRecordContent.m_strShouShuMingCheng;
                objData1[1] = m_objRecordContent.m_strShouShuMingChengXML;
                objData1[3] = "拟施手术名称和方式:";
                m_objLine2Arr[3].m_ObjPrintLineInfo = objData1;

                objData1[0] = m_objRecordContent.m_strMaZuiFangFa;
                objData1[1] = m_objRecordContent.m_strMaZuiFangFaXML;
                objData1[3] = "拟施麻醉方式:";
                m_objLine2Arr[4].m_ObjPrintLineInfo = objData1;

                objData1[0] = m_objRecordContent.m_strZhuYiShiXiang;
                objData1[1] = m_objRecordContent.m_strZhuYiShiXiangXML;
                objData1[3] = "注意事项:";
            ...
            else
            {
                ...
                {
                    objData1[3] = "入院日期:" + m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日") + "　　　　　　　　　　　" + "死亡时间:" + "    年  月  日";
                }
                else
                {
                    objData1[3] = "入院日期:" + "    年  月  日" + "　　　　　　　　　　　" + "手术时间:" + "    年  月  日";
                }
                m_objLine1Arr[1].m_ObjPrintLineInfo = objData1;
            ...
            public override object m_ObjPrintLineInfo
            {
                ...
                set
                {
                    if (value != null)
                    {
                        ...
                        m_strTitle = objData[3].ToString();
                        dtmFirstPrint = (DateTime)objData[2];
                        if (clsBeforeOperationSummaryPrintTool_xj.m_blnIsPrintMark)
                        {
                            if (objData[1].ToString() == "")
                            {
                                m_objDiagnose.m_mthSetContextWithCorrectBefore(objData[0].ToString(), objData[1].ToString(), dtmFirstPrint);
