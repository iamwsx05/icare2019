...
{
	/// <summary>
	/// Summary description for clsGynecologyCaseHisPrintTool.
	/// </summary>
	public class clsGynecologyCaseHisPrintTool: clsInpatMedRecPrintBase
	{
		public clsGynecologyCaseHisPrintTool(string p_strTypeID) :base(p_strTypeID)
		{
			//
		...
		{
			m_objPrintOneItemArr = new clsPrintInPatMedRecItem[11];
		...
		protected override void m_mthSetSubPrintInfo()
		{
			...
			m_objPrintOneItemArr[1].m_mthSetPrintValue("既往史","既往史：");
			m_objPrintOneItemArr[2].m_mthSetPrintValue("月经史","月经史：");
			m_objPrintOneItemArr[3].m_mthSetPrintValue("婚姻史","婚姻史：");
			m_objPrintOneItemArr[4].m_mthSetPrintValue("生育史","生育史：");
			m_objPrintOneItemArr[5].m_mthSetPrintValue("个人史","个人史：");
			m_objPrintOneItemArr[6].m_mthSetPrintValue("家族史","家族史：");
			m_objPrintOneItemArr[7].m_mthSetPrintValue("避孕情况","避孕情况：");
			m_objPrintOneItemArr[8].m_mthSetPrintValue("以往妇科疾患","以往妇科疾患：");
			m_objPrintOneItemArr[9].m_mthSetPrintValue("专科检查","专科检查：");
			m_objPrintOneItemArr[10].m_mthSetPrintValue("辅助检查","辅助检查：");
			#endregion	
		}
		#region Print Class
		...
		private class clsPrintInPatientBodyChekcFixStatus : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_blnIsFirstPrint)
				{
					...
					p_objGrp.DrawString("体 格 检 查",clsObstetricCaseHisPrintTool.m_fotItemHead,Brushes.Black,m_intRecBaseX+330,p_intPosY);
					...
					if(objChekcContent!=null)
					{
						...
						if(objItemContent != null)
							strAllText += "\n"+objItemContent.m_strItemContent;
		...
		private class clsPrintPatientPrimaryDiagnoseInfo : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				objChekcContent = m_objGetContentFromItemArr(new string[]{"入院诊断"});
				...
				{	
					p_intPosY += 20;
					p_objGrp.DrawString("入院诊断：",p_fntNormalText,Brushes.Black,m_intRecBaseX+360,p_intPosY);
					p_intPosY += 20;
