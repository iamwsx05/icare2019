...
namespace iCare
{
    ...
    /// 盛光怀 2008/1/08
	/// </summary>
	public class clsIMR_Neuromedicine_F2PrintTool : clsInpatMedRecPrintBase
	{
        public clsIMR_Neuromedicine_F2PrintTool(string p_strTypeID) : base(p_strTypeID)
		{
			//
			// TODO: 在此处添加构造函数逻辑
			//
		...
		protected override void m_mthSetPrintLineArr()
		{
			m_objPrintLineContext = new com.digitalwave.Utility.Controls.clsPrintContext(
				new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
										  new clsPrintPatientFixInfo("神经内科住院病历",330),
		...
		private class clsPrintInPatMedRecMedical : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_blnIsPrint[1])
				{
					...
					strPrintText = "         ";
                    if (m_hasItemDetail.Contains("体格检查>>一般情况>>皮肤粘膜>>颜色"))
				...
				if(m_blnIsPrint[4])
				{
					if(m_blnCheckBottom(ref p_intPosY,70,p_intPosY))
					{
						m_blnHaveMoreLine = true;
						return;
					}
		...
		private class clsPrintInPatMedRecGeneralNerves : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_blnIsPrint[1])
				{
                    ...
                    if (m_hasItemDetail.Contains("精神状态>>幻觉"))
						strPrintText += "幻觉"+m_hasItemDetail["精神状态>>幻觉"]+",";
				...
				if(m_blnIsPrint[5])
				{
                    ...
                    if (m_hasItemDetail.Contains("左眼球内陷"))
                        strPrintText += "及眼球内陷" + m_hasItemDetail["左眼球内陷"] + ",";
...
//						p_intPosY += 20;
					...
					{
						if((p_intPosY+60) > ((int)enmRectangleInfo.BottomY -50))
						{
							m_blnHaveMoreLine = true;
							p_intPosY += 100;
							m_intIndex = i;
		...
		private class clsPrintInPatMedRecPlant : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_blnIsPrint[1])
				{
					...
					strPrintText = "            ";
                    if (m_hasItemDetail.Contains("颈强直"))
                        strPrintText += "颈强直" + m_hasItemDetail["颈强直"] + ",";
				...
				if(m_blnIsFirstPrint)
				{
					...
					if (objItemContent[1] != null)
						if (objItemContent[1].m_strItemContent != null)
						{
                            ...
                            m_mthAddSign2("出院诊断：", m_objPrintContext1.m_ObjModifyUserArr);
						}
        ...
        private class clsPrintInSing : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_objPrintContext1.m_BlnHaveNextLine() || m_objPrintContext2.m_BlnHaveNextLine())
				{
                    ...
                    //    if (objItemContent[0].m_strItemContent != null)
                    //        m_objPrintContext2.m_mthPrintLine(330,m_intRecBaseX+400,p_intPosY,p_objGrp);
                    p_objGrp.DrawString("签名：" + (objItemContent[1] == null ? "" : (objItemContent[1].m_strItemContent == null ? "" : objItemContent[1].m_strItemContent)), p_fntNormalText, Brushes.Black, m_intRecBaseX + 450, p_intPosY);
...
//						m_hasItemDetail.Add(objItem.m_strItemName,"");
		...
		/// 打印画图
		/// </summary>
		internal class clsPrintInPatMedRecPic3 : clsInpatMedRecPrintBase.clsIMR_PrintLineBase
		{
			/// <summary>
			/// 相同的内容只打印一次(而不是首次打印时间对应的m_blnIsFirstPrint)
			/// </summary>
            ...
            public clsPrintInPatMedRecPic3(bool p_blnMustPrinted)
			{
