...
namespace iCare
{
    class clsIMR_Bonehurtcervicalprint : clsInpatMedRecPrintBase
    {
        public clsIMR_Bonehurtcervicalprint(string p_strTypeID)
            : base(p_strTypeID)
		{
			//
			// TODO: 在此处添加构造函数逻辑
        ...
        protected override void m_mthSetPrintLineArr()
        {
            m_objPrintLineContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
                                                                           new clsPrintPatientFixInfo("骨伤科入院记录(颈椎病新疆版)",320),
                                                                           new clsPrint2(),
                                                                           new clsPrint3(),
                                                                           new clsPrint4(),
                                                                           new clsPrint5(),
        ...
        private class clsPrint10 : clsIMR_PrintLineBase
        {
            ...
            private string[] m_strKeysArr101 = { "视诊：颈椎生理区度：" };
            private string[] m_strKeysArr01a = { "", "颈椎凸>>无", "颈椎凸>>有" };
            private string[] m_strKeysArr101a ={ "颈椎侧凸：", "颈椎凸>>无", "颈椎凸>>有" };
            ...
            private string[] m_strKeysArr101b ={ "触诊：项肌痉挛：", "项肌痉挛>>无", "项肌痉挛>>有" };
            ...
            private string[] m_strKeysArr103h = { "特殊实验：压顶实验：左：", "压顶实验>>左>>+", "压顶实验>>左>>-" };
            ...
            private string[] m_strKeysArr103h2 = { "扣击实验：左：", "扣击实验>>左+", "扣击实验>>左-" };
            private string[] m_strKeysArr03h3 ={ "", "扣击实验>>右+", "扣击实验>>右-" };
            private string[] m_strKeysArr103h3 = { "右：", "扣击实验>>右+", "扣击实验>>右-" };

            private string[] m_strKeysArr03h4 ={ "", "臂神经>>左+", "臂神经>>左-" };
            private string[] m_strKeysArr103h4 = { "臂从神经牵拉实验：左：", "臂神经>>左+", "臂神经>>左-" };
            private string[] m_strKeysArr03h5 ={ "", "扣击实验>>右+", "扣击实验>>右-" };
            private string[] m_strKeysArr103h5 = { "右：", "臂神经>>右+", "臂神经>>右-" };

            private string[] m_strKeysArr04 ={ "", "颈椎旋转", "颈椎>>其他",  "辅助检查", "x光片示", "生化检查", "生花>>其他" };
            private string[] m_strKeysArr104 = { "颈椎旋转：", "\n其他：",  "\n辅助检查：", "\nX光片示", "\n生化检查", "\n其他" };
  ...
  if (m_blnHavePrintInfo(m_strKeysArr03) != false)
     ...
     if (m_blnHavePrintInfo(m_strKeysArr03e) != false)
                        ...
                        m_mthMakeCheckText(m_strKeysArr103h4, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h5, ref strAllText, ref strXml);
