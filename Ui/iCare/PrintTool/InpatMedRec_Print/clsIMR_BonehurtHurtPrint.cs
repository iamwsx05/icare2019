...
namespace iCare
{
    class clsIMR_BonehurtHurtPrint : clsInpatMedRecPrintBase
    {
        public clsIMR_BonehurtHurtPrint(string p_strTypeID)
            : base(p_strTypeID)
		{
			//
			// TODO: 在此处添加构造函数逻辑
        ...
        protected override void m_mthSetPrintLineArr()
        {
            m_objPrintLineContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
                                                                           new clsPrintPatientFixInfo("骨伤科入院记录(创伤新疆版)",320),
                                                                           new clsPrint2(),
                                                                           new clsPrint3(),
                                                                           new clsPrint4(),
                                                                           new clsPrint5(),
     ...
     private string[] m_strKeysArr06e = {  "肝脾出诊" };// "手术斑痕：", "手术斑痕>>无", "手术斑痕>>有", "：", ">>无", "包块>>有", "压痛:", "压痛>>无", "压痛>>有", "反跳痛：", "反跳动>>无", "反跳动>>有", "肝脾肋下触诊：", "肝脾肋下触诊>>未触诊", "肝脾肋下触诊>>异常", "肾区扣击痛：", "肾区痛>>阳性", "肾区通阴性", "肠鸣音：", "肠音>>正常", "肠音>>亢进", "肠音>>减弱", "肠音>>消失" };
        ...
        private class clsPrint10 : clsIMR_PrintLineBase
        {
            ...
            //			private string[] m_strKeysArr101 = {"测试：","测试：","测试：","测试：","测试："};
            //          m_mthMakeCheckText(m_strKeysArr102,ref strAllText,ref strXml);
            private string[] m_strKeysArr01 = { "", "视诊>>肿胀", "视诊>>畸行", "视诊>>末梢血运正常", "视诊>>青紫", "视诊>>苍白" };// "红斑：", "压之退色", "压之不退色", 症>>无", "
            private string[] m_strKeysArr101 = { "视诊：", "视诊>>肿胀", "视诊>>畸行", "视诊>>末梢血运正常", "视诊>>青紫", "视诊>>苍白" };//, "红斑：", "压之退色"
            private string[] m_strKeysArr01a = { "", "视诊>>其他" };
            private string[] m_strKeysArr101a ={"其他：" };

            private string[] m_strKeysArr01b = { "","触诊" };
            private string[] m_strKeysArr101b ={ "触诊：" };
            private string[] m_strKeysArr01c = { "", "动脉>>正常", "动脉>>若", "动脉>>消失" };
            private string[] m_strKeysArr101c ={ "动脉搏动：", "动脉>>正常", "动脉>>若", "动脉>>消失" };
            private string[] m_strKeysArr01d = { "", "纵轴扣击痛>>无", "纵轴扣击痛>>有" };
            private string[] m_strKeysArr101d ={ "纵轴扣击痛：", "纵轴扣击痛>>无", "纵轴扣击痛>>有" };
            private string[] m_strKeysArr01e = { "", "体表温度>>高", "体表温度>>低", "体表温度>>正常" };
            private string[] m_strKeysArr101e ={ "体表温度：", "体表温度>>高", "体表温度>>低", "体表温度>>正常" };
            private string[] m_strKeysArr01f = { "", "动诊>>有", "动诊断>>无" };
            private string[] m_strKeysArr101f ={ "动诊：  异常活动：", "动诊>>有", "动诊断>>无" };
            private string[] m_strKeysArr01g = { "", "活动受限>>有", "活动受限>>无" };
            private string[] m_strKeysArr101g ={ "活动受限：", "活动受限>>有", "活动受限>>无" };
            private string[] m_strKeysArr02 = { "", "量诊" }; //"肿瘤>>圆形", "肿瘤>>带形", "肿瘤>>不规则", "肿瘤>>软", "肿瘤>>硬", "肿瘤>>高出皮面", "肿瘤>>平皮", "肿瘤>>良性", "肿瘤>>恶性", "囊肿：", "囊肿>>球形", "囊肿>>椭圆", "囊肿>>大小", "继发皮损" };
            private string[] m_strKeysArr102 = { "量诊：" };
            private string[] m_strKeysArr02a = { "", "皮肤感觉正常", "皮肤感觉减退", "皮肤感觉消失" };// "肿瘤>>软", "肿瘤>>硬" };
            private string[] m_strKeysArr102a = { "神经系统检查：感觉：", "皮肤感觉正常", "皮肤感觉减退", "皮肤感觉消失" };

            private string[] m_strKeysArr03 = { "", "运动" };// "红斑：", "压之退色", "压之不退色", "红斑>>颜色", "白斑：", "白班>>有", "白斑>>无", "水疱：", "水疱>>大", "水疱>>小", "尼氏症：", "尼氏症>>有", "尼氏症>>无", "风团>>颜色" };
            private string[] m_strKeysArr103 = { "运动："};

            private string[] m_strKeysArr03a ={ "", "踝反射>>做", "踝反射>>右", "肛门反射" };
            private string[] m_strKeysArr103a = { "生理病理反射：膝反射 左：", " 右：", "膝反射 左：", "右","肛门反射：" };
            ...
            private string[] m_strKeysArr03h ={ "", "石膏固定>>有", "石膏固定>>无" };
            private string[] m_strKeysArr103h = { "；石膏外固定：", "石膏固定>>有", "石膏固定>>无" };



            private string[] m_strKeysArr04 ={ "", "伤肢功能情况", "皮肤损伤情况", "皮肤>>其他", "辅助检查", "x光片示", "生化检查", "生花>>其他" };
            private string[] m_strKeysArr104 = { "伤肢功能情况：","\n皮肤损伤情况：","\n其他","\n辅助检查：","\nX光片示","\n生化检查","\n其他"};
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_blnIsFirstPrint)
                {
                    ...
                    if (m_objContent != null)
                    {
                        ...
                        m_mthMakeCheckText(m_strKeysArr101f, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr101g, ref strAllText, ref strXml);
                        if (m_blnHavePrintInfo(m_strKeysArr02) != false)
                            m_mthMakeText(m_strKeysArr102, m_strKeysArr02, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr102a, ref strAllText, ref strXml);
