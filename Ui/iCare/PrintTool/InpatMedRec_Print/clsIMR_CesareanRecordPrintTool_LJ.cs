...
//																		   new clsPrintInPatApgar(),
        ...
        //                p_objGrp.DrawString("剖宫产手术记录",new Font("SimSun", 16,FontStyle.Bold),Brushes.Black,358,70);
                ...
                if (m_blnIsFirstPrint)
                {
                    ...
                    if (m_objContent != null)
                    {
                        ...
                        m_mthMakeText(new string[] { "$$", " 形长", "cm; $$", "厚", "cm; $$", " 撕裂", " 位置", " 长度", "cm$$", "\n切开子宫所见：", "胎方位", " 切口下见：", " 羊水量", "ml; $$", " 性状", "\n手术娩出胎儿的过程：", " 娩出胎儿", "部$$" },
                                      new string[] { "子宫切口>>1", "子宫切口>>形长", "", "子宫切口>>厚", "", "子宫切口>>撕裂", "子宫切口>>位置", "子宫切口>>长度", "", "", "切开子宫所见>>胎方位", "切开子宫所见>>切口下见", "切开子宫所见>>羊水量", "", "切开子宫所见>>性状", "", "手术娩出胎儿的过程>>娩出胎儿", "" }, ref strAllText, ref strXml);
                        ...
                        m_mthMakeCheckText(new string[] { "手法：", "手术娩出胎儿的过程>>手法>>推压宫底", "手术娩出胎儿的过程>>手法>>阴道推先露" }, ref strAllText, ref strXml);
                        ...
                        m_mthMakeText(new string[] { "体积：", "重量", "g; $$", "其它", "\n              脐带长：", "cm；$$" },
                            new string[] { "胎盘脐带情况>>胎膜>>体积", "胎盘脐带情况>>胎膜>>重量", "", "胎盘脐带情况>>胎膜>>其它：", "胎盘脐带情况>>脐带长", "" }, ref strAllText, ref strXml);

                        m_mthMakeCheckText(new string[] { "", "胎盘脐带情况>>脐带>>绕颈", "胎盘脐带情况>>脐带>>绕手", "胎盘脐带情况>>脐带>>绕腿" }, ref strAllText, ref strXml);
                        m_mthMakeText(new string[] { "$$", "周；$$" }, new string[] { "胎盘脐带情况>>脐带>>周", "" }, ref strAllText, ref strXml);
                        ...
                        m_mthMakeText(new string[] { "Apgar评分1'：", "5'：", "体重", "#g$$" },
                            new string[] { "新生婴儿情况>>评分1'", "新生婴儿情况>>5'", "新生婴儿情况>>体重", "新生婴儿情况>>体重" }, ref strAllText, ref strXml);
                        ...
                        m_mthMakeText(new string[] { "\n                     脂肪层用：", "号；$$", "线 $$", " 缝合$$", "针；$$", "\n                     皮肤用：", "号；$$", "线 $$", " $$" },
                            new string[] { "腹壁缝合>>脂肪层>>号", "腹壁缝合>>脂肪层>>线", "腹壁缝合>>脂肪层>>线", "腹壁缝合>>脂肪层>>针", "", "皮肤>>号", "皮肤>>线", "皮肤>>缝合", "" }, ref strAllText, ref strXml);
