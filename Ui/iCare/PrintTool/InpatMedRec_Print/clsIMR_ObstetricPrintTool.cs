...
{
	/// <summary>
	/// Summary description for clsIMR_ObstetricPrintTool.
	/// </summary>
	public class clsIMR_ObstetricPrintTool: clsInpatMedRecPrintBase
	{
		public clsIMR_ObstetricPrintTool(string p_strTypeID) :base(p_strTypeID)
		{
			//
		...
		protected override void m_mthSetPrintLineArr()
		{
			m_objPrintLineContext = new com.digitalwave.Utility.Controls.clsPrintContext(
				new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
										  ...
										  new clsPrintInPatMedRecDiagnosic(),
		...
		private class clsPrintInPatMedRecMedical : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_blnIsFirstPrint)
				{
					...
					if(m_objContent!=null)
					{
						m_mthMakeText(new string[]{"体温：","脉搏：","呼吸：","血压："},m_strKeysArr1,ref strAllText,ref strXml);
		...
		private class clsPrintInPatMedRecObstetricCheck : clsIMR_PrintLineBase
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_blnIsFirstPrint)
				{
                    if (p_intPosY + 30 > clsPrintPosition.c_intBottomY)
                    {//避免打印内容超出底框
                        p_intPosY += 1000;//换页
                        return;
                    }
		...
		private class clsPrintInPatMedRecCurePlan : clsIMR_PrintLineBase
		{
			...
			{
				if(m_hasItems != null)
				if(m_hasItems.Contains("治疗计划"))
					objItemContent = m_hasItems["治疗计划"] as clsInpatMedRec_Item;
				if(objItemContent == null || objItemContent.m_strItemContent == "" || objItemContent.m_strItemContent == null)
				{
				...
				if(m_blnIsFirstPrint)
				{
					p_objGrp.DrawString("治疗计划：",p_fntNormalText,Brushes.Black,m_intRecBaseX+10,p_intPosY);
					p_intPosY += 20;
					m_objPrintContext.m_mthSetContextWithCorrectBefore((objItemContent==null ? "" : objItemContent.m_strItemContent)  ,(objItemContent==null ? "<root />" : objItemContent.m_strItemContentXml),m_dtmFirstPrintTime,objItemContent!=null);
					m_mthAddSign2("治疗计划：",m_objPrintContext.m_ObjModifyUserArr);
					m_blnIsFirstPrint = false;					
				}
			...
			private void m_mthPrintSign(ref int p_intPosY,System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(objSignContent == null)
					return;
				p_intPosY += 20;
				p_objGrp.DrawString("主治医师："+(objSignContent[0]==null ? "" : objSignContent[0].m_strItemContent) ,p_fntNormalText,Brushes.Black,m_intRecBaseX+50,p_intPosY);
				p_objGrp.DrawString("住院医师："+(objSignContent[1]==null ? "" : objSignContent[1].m_strItemContent) ,p_fntNormalText,Brushes.Black,m_intRecBaseX+275,p_intPosY);
