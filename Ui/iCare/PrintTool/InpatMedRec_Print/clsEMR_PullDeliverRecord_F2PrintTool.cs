...
namespace iCare
{
    public class clsEMR_PullDeliverRecord_F2PrintTool : clsInpatMedRecPrintBase
    {
        /// <summary>
        /// 阴道胎头吸引器助产手术记录
        /// </summary>
        /// <param name="p_strTypeID"></param>
        public clsEMR_PullDeliverRecord_F2PrintTool(string p_strTypeID)
            : base(p_strTypeID)
        {
            //构造函数
        ...
        private class clsPrint8 : clsIMR_PrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_objPrintContext.m_BlnHaveNextLine())
                {
                    m_objPrintContext.m_mthPrintLine((int)enmRectangleInfoInPatientCaseInfo.PrintWidth2, m_intRecBaseX + 300, p_intPosY, p_objGrp);
                  //  p_intPosY += 20;
                }
                if (m_objPrintContext.m_BlnHaveNextLine())
                {
