...
namespace iCare
{
    class clsIMR_Bonelumbocruralpain : clsInpatMedRecPrintBase
    {

        public clsIMR_Bonelumbocruralpain(string p_strTypeID)
            : base(p_strTypeID)
		{
			//
			// TODO: 在此处添加构造函数逻辑
        ...
        protected override void m_mthSetPrintLineArr()
        {
            m_objPrintLineContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
                                                                           new clsPrintPatientFixInfo("骨伤科入院记录(腰腿痛新疆版)",320),
                                                                           new clsPrint2(),
                                                                           new clsPrint3(),
                                                                           new clsPrint4(),
                                                                           new clsPrint5(),
        ...
        private class clsPrint10 : clsIMR_PrintLineBase
        {
            ...
            private string[] m_strKeysArr01 = { "", "颈椎生理度" };
            private string[] m_strKeysArr101 = { "视诊：腰椎生理区度：" };
            private string[] m_strKeysArr01a = { "", "颈椎凸>>无", "颈椎凸>>有" };
            private string[] m_strKeysArr101a ={ "腰椎侧凸：", "颈椎凸>>无", "颈椎凸>>有" };
            private string[] m_strKeysArr01aa = { "颈椎凸>>左", "颈椎凸>>右" };
            private string[] m_strKeysArr101aa = { "颈椎凸>>左", "颈椎凸>>右" };
            private string[] m_strKeysArr011 = { "", "活动度" };
            private string[] m_strKeysArr1011 = { "活动度：" };
            private string[] m_strKeysArr011a = { "", "局部肿块>无", "局部肿块>有" };
            private string[] m_strKeysArr1011a = { "局部肿块：", "局部肿块>无", "局部肿块>有" };
            private string[] m_strKeysArr011b = { "", "局部肿>>其他" };
            private string[] m_strKeysArr1011b = { "其他：" };

            private string[] m_strKeysArr01b = { "", "项肌痉挛>>无", "项肌痉挛>>有" };
            private string[] m_strKeysArr101b ={ "触诊：骶棘肌痉挛：", "项肌痉挛>>无", "项肌痉挛>>有" };
            private string[] m_strKeysArr01b1 = { "", "压痛>>无", "压痛>>有" };
            private string[] m_strKeysArr101b1 ={ "压痛：", "压痛>>无", "压痛>>有" };
            ...
            private string[] m_strKeysArr01b7 = { "", "纵轴扣击痛>>无", "纵轴扣击痛>>有" };
            private string[] m_strKeysArr101b7 ={ "纵轴扣击痛：", "纵轴扣击痛>>无", "纵轴扣击痛>>有" };
            private string[] m_strKeysArr01b8 = { "纵轴扣击痛" };
            private string[] m_strKeysArr101b8 ={ "" };

            private string[] m_strKeysArr01e = { "", "体表温度>>高", "体表温度>>低", "体表温度>>正常" };
            private string[] m_strKeysArr101e ={ "体表温度：", "体表温度>>高", "体表温度>>低", "体表温度>>正常" };

            private string[] m_strKeysArr01f = { "", "颈椎活动度>>屈", "颈椎活动度>>伸", "侧完>>左", "侧完>>右", "旋转>>左", "旋转>>右" };
            private string[] m_strKeysArr101f ={ "动诊：  颈椎活动度：屈：", "伸：", "侧弯：左：", "右：", "旋转：左：", "右：" };

            private string[] m_strKeysArr02 = { "", "量诊" };
            private string[] m_strKeysArr102 = { "\n量诊：" };
            private string[] m_strKeysArr02a = { "", "神经系统检查" };// "肿瘤>>软", "肿瘤>>硬" };
            private string[] m_strKeysArr102a = { "\n神经系统检查：感觉：" };
            ...
            private string[] m_strKeysArr03h ={ "", "压顶实验>>左>>+", "压顶实验>>左>>-" };
            private string[] m_strKeysArr103h = { "特殊实验：直接抬高实验：左：", "压顶实验>>左>>+", "压顶实验>>左>>-" };
            private string[] m_strKeysArr03h1 ={ "", "压顶实验>>右>>+", "压顶实验>>右>>-" };
            private string[] m_strKeysArr103h1 = { "右：", "压顶实验>>右>>+", "压顶实验>>右>>-" };
            private string[] m_strKeysArr03h2 ={ "", "扣击实验>>左+", "扣击实验>>左-" };
            private string[] m_strKeysArr103h2 = { "加强：左：", "扣击实验>>左+", "扣击实验>>左-" };
            private string[] m_strKeysArr03h3 ={ "", "扣击实验>>右+", "扣击实验>>右-" };
            private string[] m_strKeysArr103h3 = { "右：", "扣击实验>>右+", "扣击实验>>右-" };
            private string[] m_strKeysArr03h2a ={ "", "曲颈>>左+", "曲颈>>>左-" };
            private string[] m_strKeysArr103h2a = { "曲颈挺腹实验：左：", "曲颈>>左+", "曲颈>>>左-" };
            private string[] m_strKeysArr03h3a ={ "", "曲颈>>右+", "曲颈>>右-" };
            private string[] m_strKeysArr103h3a = { "右：", "曲颈>>右+", "曲颈>>右-" };

            private string[] m_strKeysArr03h2b ={ "", "字实验>>左+", "字实验>>左-" };
            private string[] m_strKeysArr103h2b = { "4字实验：左：", "字实验>>左+", "字实验>>左-" };
            private string[] m_strKeysArr03h3b ={ "", "字实验>>右+", "字实验>>右-" };
            private string[] m_strKeysArr103h3b = { "右：", "字实验>>右+", "字实验>>右-" };
            private string[] m_strKeysArr03h2c ={ "", "臂神经>>左+", "臂神经>>左-" };
            private string[] m_strKeysArr103h2c = { "梨状肌紧张实验：左：", "臂神经>>左+", "臂神经>>左-" };
            private string[] m_strKeysArr03h3c ={ "", "臂神经>>右+", "臂神经>>右-" };
            private string[] m_strKeysArr103h3c = { "右：", "臂神经>>右+", "臂神经>>右-" };
            private string[] m_strKeysArr03h2d ={ "", "扭转实验>>左+", "扭转实验>>左-" };
            private string[] m_strKeysArr103h2d = { "骶关节扭转实验：左：", "扭转实验>>左+", "扭转实验>>左-" };
            private string[] m_strKeysArr03h3d ={ "", "扭转实验>>右+", "扭转实验>>右-" };
            private string[] m_strKeysArr103h3d = { "右：", "扭转实验>>右+", "扭转实验>>右-" };

            private string[] m_strKeysArr03h2e ={ "", "腰部>>左+", "腰部>>左-" };
            private string[] m_strKeysArr103h2e = { "腰部扭转实验：左：", "腰部>>左+", "腰部>>左-" };
            private string[] m_strKeysArr03h3e ={ "", "腰部>>右+", "腰部>>右-" };
            private string[] m_strKeysArr103h3e = { "右：", "腰部>>右+", "腰部>>右-" };


            private string[] m_strKeysArr03h2f ={ "", "肌圣经>>左+", "肌圣经>>左-" };
            private string[] m_strKeysArr103h2f = { "肌神经紧张实验：左：", "肌圣经>>左+", "肌圣经>>左-" };
            private string[] m_strKeysArr03h3f ={ "", "肌圣经>>右+", "肌圣经>>右-" };
            private string[] m_strKeysArr103h3f = { "右：", "肌圣经>>右+", "肌圣经>>右-" };




            private string[] m_strKeysArr04 ={ "", "颈椎>>其他", "辅助检查", "x光片示", "生化检查", "生花>>其他" };
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_blnIsFirstPrint)
                {
                    ...
                    if (m_objContent != null)
                    {
                        ...
                        m_mthMakeCheckText(m_strKeysArr101aa, ref strAllText, ref strXml);
                        if (m_blnHavePrintInfo(m_strKeysArr011) != false)
                            m_mthMakeText(m_strKeysArr1011, m_strKeysArr011, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr1011a, ref strAllText, ref strXml);
                        if (m_blnHavePrintInfo(m_strKeysArr011b) != false)
                            m_mthMakeText(m_strKeysArr1011b, m_strKeysArr011b, ref strAllText, ref strXml);
                        ...
                        m_mthMakeCheckText(m_strKeysArr101b7, ref strAllText, ref strXml);

                        if (m_blnHavePrintInfo(m_strKeysArr01b8) != false)
                            m_mthMakeText(m_strKeysArr101b8, m_strKeysArr01b8, ref strAllText, ref strXml);
                        ...
                        m_mthMakeCheckText(m_strKeysArr103h, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h1, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h2, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h3, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h2a, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h3a, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h2b, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h3b, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h2c, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h3c, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h2d, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h3d, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h2e, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h3e, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h2f, ref strAllText, ref strXml);
                        m_mthMakeCheckText(m_strKeysArr103h3f, ref strAllText, ref strXml);
