...
namespace iCare
{
    ...
    /// 死亡记录---新疆 的打印工具类
    /// </summary>
    public class clsDeathRecord_XJPrintTool : infPrintRecord
    {
        ...
        private clsDeathRecordDomain_XJ m_objRecordsDomain;
        private clsPrintInfo_DeathRecord_XJ m_objPrintInfo;
        private clsDeathRecordContent_XJ m_objRecordContent = null;
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            m_objPrintInfo = new clsPrintInfo_DeathRecord_XJ();
        ...
        public void m_mthInitPrintContent()
        {
            ...
            {
                m_objRecordsDomain = new clsDeathRecordDomain_XJ();
                ...
                if (lngRes <= 0)
                    return;
                m_objRecordContent = (clsDeathRecordContent_XJ)objContent;
            }
        ...
        public void m_mthSetPrintContent(object p_objPrintContent)
        {
            ...
            m_blnWantInit = false;
            if (p_objPrintContent.GetType().Name != "clsPrintInfo_DeathRecord_XJ")
            {
                clsPublicFunction.ShowInformationMessageBox("参数错误");
                return;
            }
            m_blnIsFromDataSource = false;//表明是从文件直接提取信息
            m_objPrintInfo = (clsPrintInfo_DeathRecord_XJ)p_objPrintContent;
        ...
        private void m_mthSetPrintValue()
        {
            ...
            m_objLine2Arr[1] = new clsPrintLine2(250);
            m_objLine2Arr[2] = new clsPrintLine2(300);
            //     m_objLine2Arr[3] = new clsPrintLine2(790);
            m_objPrintContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
										 m_objLine1Arr[1],m_objLine2Arr[0],m_objLine1Arr[2],m_objLine1Arr[3],
                                         m_objLine2Arr[1],m_objLine2Arr[2],m_objLine1Arr[4],m_objLine1Arr[5]
									  });
            ...
            if (m_objRecordContent != null)
            {
                ...
                objData1[3] = "入院日期: " + m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日") + "　　　　　　　　　　　" + "死亡时间: " + strOutDate;
            ...
            else
            {
                ...
                {
                    objData1[3] = "入院日期:" + "    年  月  日" + "　　　　　　　　　　　" + "死亡时间:" + "    年  月  日";
                }
                m_objLine1Arr[1].m_ObjPrintLineInfo = objData1;
            ...
            public override object m_ObjPrintLineInfo
            {
                ...
                set
                {
                    if (value != null)
                    {
                        ...
                        m_strTitle = objData[3].ToString();
                        dtmFirstPrint = (DateTime)objData[2];
                        if (clsDeathRecord_XJPrintTool.m_blnIsPrintMark)
                        {
                            if (objData[1].ToString() == "")
                            {
                                m_objDiagnose.m_mthSetContextWithCorrectBefore(objData[0].ToString(), objData[1].ToString(), dtmFirstPrint);
