...
namespace iCare
{
    ...
    /// 输血治疗同意书--新疆 的打印工具类
    /// </summary>
    public class clsShuXueZhiLiaoyesPrintTool_xj : infPrintRecord
    {
        ...
        private clsPrintInfo_ShuXueZhiLiaoyes_xj m_objPrintInfo;
        private clsShuXueZhiLiaoyesContent_xj m_objRecordContent = null;
        ...
        private void m_mthPrintPageSub(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("主管医师签字:" + strRecordName + " " + m_objRecordContent.m_dtmDoctorDate.ToString("yyyy-MM-dd"), new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 5, m_intYPos + 20);
            //e.Graphics.DrawString(m_objRecordContent.m_dtmDoctorDate.ToString("yyyy-MM-dd"), new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 200, m_intYPos + 20);

            e.Graphics.DrawString("受血着（家人/监护人）签字:                     " + m_objRecordContent.m_dtmHuanzheDate.ToString("yyyy-MM-dd"), new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 10, m_intYPos);

            e.Graphics.DrawString("备注:" + m_objRecordContent.m_strBeiZhu, new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 10, m_intYPos + 40);
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("输血治疗同意书", m_fotTitleFont, m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title));

            e.Graphics.DrawString("XHTCM/RD-288", m_fotSmallFont, m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Number));
