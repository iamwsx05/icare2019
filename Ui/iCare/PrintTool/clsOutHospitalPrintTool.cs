...
{
	/// <summary>
	/// 出院记录的打印工具类,Jacky-2003-7-1
	/// </summary>
	public class clsOutHospitalPrintTool: infPrintRecord
	{	
		...
		private clsOutHospitalDomain m_objRecordsDomain;
		private clsPrintInfo_OutHospital m_objPrintInfo;
        private clsOutHospitalRecordContent m_objRecordContent = null;
...
//			private int m_intTimes = 0;
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				{
					p_objGrp.DrawString(m_strTitle,fntTitle ,Brushes.Black,(int)enmRectangleInfo.LeftX+363,p_intPosY+5);//
				}
			...
			public override object m_ObjPrintLineInfo
			{
				...
				set
				{
					if(value != null)
					{
                        ...
                        if (clsOutHospitalPrintTool.m_blnIsPrintMark)
                        {
