...
namespace iCare
{
    ...
    /// 手术记录---新疆 的打印工具类
    /// </summary>
    public class clsOperationRecordPrintTool_xj : infPrintRecord
    {
        ...
        private clsOperationRecordDomain_xj m_objRecordsDomain;
        private clsPrintInfo_OperationRecord_xj m_objPrintInfo;
        private clsOperationRecordContent_xj m_objRecordContent = null;
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            m_objPrintInfo = new clsPrintInfo_OperationRecord_xj();
        ...
        public void m_mthInitPrintContent()
        {
            ...
            {
                m_objRecordsDomain = new clsOperationRecordDomain_xj();
                ...
                if (lngRes <= 0)
                    return;
                m_objRecordContent = (clsOperationRecordContent_xj)objContent;
            }
        ...
        public void m_mthSetPrintContent(object p_objPrintContent)
        {
            ...
            m_blnWantInit = false;
            if (p_objPrintContent.GetType().Name != "clsPrintInfo_OperationRecord_xj")
            {
                clsPublicFunction.ShowInformationMessageBox("参数错误");
                return;
            }
            m_blnIsFromDataSource = false;//表明是从文件直接提取信息
            m_objPrintInfo = (clsPrintInfo_OperationRecord_xj)p_objPrintContent;
        ...
        private void m_mthPrintPageSub(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("主治医师:" + strMainName, new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 200, m_intYPos);
            //			m_intYPos+=25;
        ...
        private void m_mthSetPrintValue()
        {
            ...
            m_objPrintContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
										 m_objLine1Arr[1],m_objLine1Arr[2],m_objLine1Arr[3],m_objLine1Arr[4],m_objLine1Arr[5],
            ...
            if (m_objRecordContent != null)
            {
                ...
                objData1[3] = "入院日期: " + m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日") + "　　　　　　　　　　　" + "手术时间: " + strOutDate;
                ...
                objEmployeeSign1.m_lngGetEmpByNO(m_objRecordContent.m_strDoctorID, out objEmpVO1);
                //if (objEmpVO != null)
                ...
                objEmployeeSign2.m_lngGetEmpByNO(m_objRecordContent.m_strHelperID, out objEmpVO2);
                //if (objEmpVO != null)
                //    if (!(string.IsNullOrEmpty(objEmpVO.m_strGetTechnicalRankAndName)))
                //        e.Graphics.DrawString(objEmpVO.m_strGetTechnicalRankAndName, new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 500 + (int)(5f * 15.5f), m_intYPos);
        ...
        {
            e.Graphics.DrawString("新 疆 中 医 附 属 医 院", m_fotSmallFont, m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_HospitalName));

            e.Graphics.DrawString("手   术   记   录", m_fotTitleFont, m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title));
            ...
            public override object m_ObjPrintLineInfo
            {
                ...
                set
                {
                    if (value != null)
                    {
                        ...
                        m_strTitle = objData[3].ToString();
                        dtmFirstPrint = (DateTime)objData[2];
                        if (clsOperationRecordPrintTool_xj.m_blnIsPrintMark)
                        {
                            if (objData[1].ToString() == "")
                            {
                                m_objDiagnose.m_mthSetContextWithCorrectBefore(objData[0].ToString(), objData[1].ToString(), dtmFirstPrint);
