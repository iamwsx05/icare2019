...
namespace iCare
{
    ...
    ///谈话记录的打印工具类
    /// </summary>
    public class clsTalkRecord_XJPrintTool : infPrintRecord
    {
        ...
        private clsTalkRecordDomain_XJ m_objRecordsDomain;
        private clsPrintInfo_TalkRecord_XJ m_objPrintInfo;
        private clsTalkRecordContent_XJ m_objRecordContent = null;
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            m_objPrintInfo = new clsPrintInfo_TalkRecord_XJ();
        ...
        public void m_mthInitPrintContent()
        {
            ...
            {
                m_objRecordsDomain = new clsTalkRecordDomain_XJ();
                ...
                if (lngRes <= 0)
                    return;
                m_objRecordContent = (clsTalkRecordContent_XJ)objContent;
            }
        ...
        public void m_mthSetPrintContent(object p_objPrintContent)
        {
            ...
            m_blnWantInit = false;
            if (p_objPrintContent.GetType().Name != "clsPrintInfo_TalkRecord_XJ")
            {
                clsPublicFunction.ShowInformationMessageBox("参数错误");
                return;
            }
            m_blnIsFromDataSource = false;//表明是从文件直接提取信息
            m_objPrintInfo = (clsPrintInfo_TalkRecord_XJ)p_objPrintContent;
        ...
        private void m_mthPrintPageSub(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("签名:患者本人：             " + "患者家属:           " + "单位代签:             " , new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 100, m_intYPos);

            e.Graphics.DrawString("注:患者家属与患者本人的关系为 " + m_objRecordContent.m_strOutHospitalDiagnose + " " + m_objRecordContent.m_dtmOutHospitalDateHuan, new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX +100, m_intYPos + 30);
            //			m_intYPos+=25;
            ...
            public PointF m_getCoordinatePoint(int p_intItemName)
            {
                ...
                switch (p_intItemName)
                {
                    case (int)enmItemDefination.Area:
                        m_fReturnPoint = new PointF(425f, 140f);
                        break;
                    case (int)enmItemDefination.Area_Title:
                        m_fReturnPoint = new PointF(380f, 140f);
                        break;
                    case (int)enmItemDefination.Bed:
                        m_fReturnPoint = new PointF(605f, 137f);
                        break;
                    case (int)enmItemDefination.Bed_Title:
                        m_fReturnPoint = new PointF(565f, 140f);
                        break;
                    case (int)enmItemDefination.Page_HospitalName:
                        m_fReturnPoint = new PointF(330f, 70f);
                        break;
                    case (int)enmItemDefination.Page_Name_Title:
                        m_fReturnPoint = new PointF(300f, 100f);
                        break;
                    case (int)enmItemDefination.Name_Title:
                        m_fReturnPoint = new PointF(60f, 140f);
                        break;
                    case (int)enmItemDefination.Name:
                        m_fReturnPoint = new PointF(105f, 140f);
                        break;

                    case (int)enmItemDefination.Sex_Title:
                        m_fReturnPoint = new PointF(195f, 140f);
                        break;
                    case (int)enmItemDefination.Sex:
                        m_fReturnPoint = new PointF(240f, 140f);
                        break;

                    case (int)enmItemDefination.Age_Title:
                        m_fReturnPoint = new PointF(275f, 140f);
                        break;
                    case (int)enmItemDefination.Age:
                        m_fReturnPoint = new PointF(320f, 140f);
                        break;

                    case (int)enmItemDefination.InPatientID_Title:
                        m_fReturnPoint = new PointF(635f, 140f);
                        break;
                    case (int)enmItemDefination.InPatientID:
                        m_fReturnPoint = new PointF(690f, 140f);
                        break;
        ...
        private void m_mthSetPrintValue()
        {
            ...
            m_objPrintContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
										 m_objLine1Arr[1],m_objLine1Arr[2],m_objLine1Arr[3],
                                         m_objLine1Arr[4],m_objLine2Arr[0]
									  });
            ...
            if (m_objRecordContent != null)
            {
                ...
                objData1[3] = "入院日期: " + m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日")  ;
                ...
                objData1[0] = "医师签名:" + strDocName +" " +m_objRecordContent.m_dtmOutHospitalDate;
                objData1[1] = "";
                objData1[3] = "";
                ...
                ///////////////5行/////////////////
                objData1[0] = m_objRecordContent.m_strInHospitalDiagnoseXi;
                objData1[1] = m_objRecordContent.m_strInHospitalDiagnoseXiXML;
                objData1[3] = "患者、患者家属或单位意见:";
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("谈   话   记   录", m_fotTitleFont, m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title));
            ...
            public override object m_ObjPrintLineInfo
            {
                ...
                set
                {
                    if (value != null)
                    {
                        ...
                        m_strTitle = objData[3].ToString();
                        dtmFirstPrint = (DateTime)objData[2];
                        if (clsTalkRecord_XJPrintTool.m_blnIsPrintMark)
                        {
                            if (objData[1].ToString() == "")
                            {
                                m_objDiagnose.m_mthSetContextWithCorrectBefore(objData[0].ToString(), objData[1].ToString(), dtmFirstPrint);
