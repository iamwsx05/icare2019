...
namespace iCare
{
    ...
    /// 疑难病例讨论记录的打印工具类
    /// </summary>
    public class clsDifficultCaseDiscuss_XJPrintTool : infPrintRecord
    {
        ...
        private clsPrintInfo_DifficultCaseDiscuss_XJ m_objPrintInfo;
        private clsDifficultCaseDiscussCountent_XJ m_objRecordContent = null;
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            m_objPrintInfo = new clsPrintInfo_DifficultCaseDiscuss_XJ();
        ...
        public void m_mthInitPrintContent()
        {
            ...
            {
                m_objRecordsDomain = new clsDiseaseTrackDomain(enmDiseaseTrackType.DifficultCaseDiscussCountent_XJ);
                ...
                if (lngRes <= 0)
                    return;
                m_objRecordContent = (clsDifficultCaseDiscussCountent_XJ)objContent;
            }
        ...
        public void m_mthSetPrintContent(object p_objPrintContent)
        {
            ...
            m_blnWantInit = false;
            if (p_objPrintContent.GetType().Name != "clsPrintInfo_DifficultCaseDiscuss_XJ")
            {
                clsPublicFunction.ShowInformationMessageBox("参数错误");
                return;
            }
            m_blnIsFromDataSource = false;//表明是从文件直接提取信息
            m_objPrintInfo = (clsPrintInfo_DifficultCaseDiscuss_XJ)p_objPrintContent;
        ...
        private void m_mthPrintPageSub(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("记录者:" + strRecordName + " 管床医师:" + strGuanChangName + " 科主任:" + strZhuRenName + " " + m_objRecordContent.m_dtmDiscussDate.ToString("yyyy-MM-dd"), new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX+5, m_intYPos);
            //			m_intYPos+=25;
        ...
        private void m_mthSetPrintValue()
        {
            ...
            m_objPrintContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
										 m_objLine1Arr[1],m_objLine1Arr[2],m_objLine1Arr[3], m_objLine1Arr[4],
            ...
            if (m_objRecordContent != null)
            {
                ...
                objData1[3] = "目前拟诊: "; //+ m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日") + "　　　　　　　　　　　" + "出院日期: " + strOutDate;
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("疑难病例讨论记录", m_fotTitleFont, m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title));
