...
{
    /// <summary>
    /// 危重患者患者护理记录茶山版（内科、妇产科、普儿科、急诊科、手术室）打印类
    /// </summary>
    public class clsGeneralNurseRecord_CSPrintTool : infPrintRecord
    {
        ...
        public clsGeneralNurseRecord_CSPrintTool(string p_strCustomName)
        {
            //
            // TODO: 在此处添加构造函数逻辑
            //
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            m_objPrintInfo.m_strHISInPatientID = m_objPatient != null ? m_objPatient.m_StrRegisterId : "";
        ...
        {	//m_objprintinfo为空表明未设置打印内容		
            ...
            if (m_objPrintInfo.m_strInPatentID == "")
                return;
            //获取打印内容
            m_objRecordsDomain = new clsRecordsDomain(enmRecordsType.GeneralNurseRecord_CSRec);

            long lngRes = 0; // 20151208 反编译EMR_clsRecordsService也未找到该方法，怀疑该方法未投入使用 m_objRecordsDomain.m_lngGetTransferInfo(m_objPrintInfo.m_strHISInPatientID, "deptid", out m_dtTransfer);

            lngRes = m_objRecordsDomain.m_lngGetPrintInfo(m_objPrintInfo.m_strInPatentID, m_objPrintInfo.m_dtmInPatientDate.ToString("yyyy-MM-dd HH:mm:ss"), out m_objPrintInfo.m_objTransDataArr, out m_objPrintInfo.m_dtmFirstPrintDateArr, out m_objPrintInfo.m_blnIsFirstPrintArr);
        ...
        private enum enmRecordRectangleInfo
        {
            ...
            ColumnsMark6 = 270,//SpO2
            ColumnsMark7 = 300,//CVP
            ColumnsMark8 = 330,//神志
            ColumnsMark9 = 360,//瞳孔大小左


            ColumnsMark10 = 400,//瞳孔大小右


            ColumnsMark11 = 440,//瞳孔反射左


            ColumnsMark12 = 460,//瞳孔反射右


            ColumnsMark13 = 480,//摄入种类
            ColumnsMark14 = 510,//摄入量


            ColumnsMark15 = 550,//排出种类
            ColumnsMark16 = 580,//排出量


            ColumnsMark17 = 620,//自定义列
            ColumnsMark18 = 675,//执行签名
            ColumnsMark19 = 745,//病情观察
            ColumnsMark20 = 950//记录签名
        }
            ...
            public PointF m_getCoordinatePoint(int p_intItemName)
            {
                ...
                switch (p_intItemName)
                {
                    ...
                    case (int)enmItemDefination.Page_HospitalName:
                        m_fReturnPoint = new PointF(550f, 35f);
                        break;
                    case (int)enmItemDefination.Page_Name_Title:
                        m_fReturnPoint = new PointF(548f, 67.5f);
                        break;
                    case (int)enmItemDefination.Name_Title:
                        m_fReturnPoint = new PointF(180f, 100f);
                        break;
                    ...
                    case (int)enmItemDefination.Sex_Title:
                        m_fReturnPoint = new PointF(340f, 100f);
                        break;
                    case (int)enmItemDefination.Sex:
                        m_fReturnPoint = new PointF(390f, 100f);
                        break;

                    case (int)enmItemDefination.Age_Title:
                        m_fReturnPoint = new PointF(450f, 100f);
                        break;
                    ...
                    case (int)enmItemDefination.BedNo_Title:
                        m_fReturnPoint = new PointF(810f, 100f);
                        break;
                    case (int)enmItemDefination.BedNo:
                        m_fReturnPoint = new PointF(860f, 100f);
                        break;

                    case (int)enmItemDefination.InPatientID_Title:
                        m_fReturnPoint = new PointF(915f, 100f);
                        break;
                    case (int)enmItemDefination.InPatientID:
                        m_fReturnPoint = new PointF(980f, 100f);
                        break;
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            objEveryRecordPageInfo.strInPatientID = m_objPrintInfo.m_strInPatentID;
            ...
            e.Graphics.DrawString("（供内科、妇产科、普儿科、急诊科、手术室使用） 注：SpO2指经皮血氧饱和度；Cvp指中心静脉压；瞳孔对光反射用符号表示：灵敏+  迟钝±  消失-" + "    （第" + intNowPage.ToString() + "页）", new Font("SimSun", 8), m_slbBrush,
                (int)enmRecordRectangleInfo.LeftX + 10,
                (int)enmRecordRectangleInfo.TopY + ((int)enmRecordRectangleInfo.RowStep) * ((int)enmRecordRectangleInfo.RowLinesNum + 1) - 20);
        ...
        private void m_mthPrintHeaderInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            //CVP
            e.Graphics.DrawString("C", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark7 + 8, (int)enmRecordRectangleInfo.TopY + 2);
            e.Graphics.DrawString("V", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark7 + 8, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 5);
            ...
            e.Graphics.DrawString("瞳   孔", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark9 + 35, (int)enmRecordRectangleInfo.TopY + 6);
            e.Graphics.DrawString("大小(mm)", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark9 + 5, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 7);
            e.Graphics.DrawString("左", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark9 + 10, (int)enmRecordRectangleInfo.TopY + 2 * (int)enmRecordRectangleInfo.RowStep + 10);
            e.Graphics.DrawString("右", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark10 + 10, (int)enmRecordRectangleInfo.TopY + 2 * (int)enmRecordRectangleInfo.RowStep + 10);
            e.Graphics.DrawString("反射", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark11 + 2, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 7);
            e.Graphics.DrawString("左", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
            ...
            e.Graphics.DrawString("摄 入", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark13 + 18, (int)enmRecordRectangleInfo.TopY + 6);
            ...
            e.Graphics.DrawString("量", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark14 + 12, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 5);
            e.Graphics.DrawString("ml/g", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark14 + 6, (int)enmRecordRectangleInfo.TopY + 2 * (int)enmRecordRectangleInfo.RowStep + 5);

            //排出
            e.Graphics.DrawString("排出", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark15 + 18, (int)enmRecordRectangleInfo.TopY + 6);
            e.Graphics.DrawString("种", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark15 + 7, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 5);
            e.Graphics.DrawString("类", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark15 + 7, (int)enmRecordRectangleInfo.TopY + 2 * (int)enmRecordRectangleInfo.RowStep + 5);
            e.Graphics.DrawString("量", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark16 + 12, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 5);
            e.Graphics.DrawString("ml/g", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
            ...
            {
                if (strCustomName.Length < 5)
                {
                    e.Graphics.DrawString(strCustomName, m_fotHeaderFont, m_slbBrush, new RectangleF((int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark17 + 20, (int)enmRecordRectangleInfo.TopY, 22, 150), new StringFormat(StringFormatFlags.LineLimit));

                }
                else if (5 <= strCustomName.Length && strCustomName.Length <= 10)
                {
                    e.Graphics.DrawString(strCustomName, m_fotHeaderFont, m_slbBrush, new RectangleF((int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark17 + 15, (int)enmRecordRectangleInfo.TopY, 45, 150), new StringFormat(StringFormatFlags.LineLimit));

                }
                else if (strCustomName.Length > 10)
                {
                    e.Graphics.DrawString(strCustomName, m_fotHeaderFont, m_slbBrush, new RectangleF((int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark17, (int)enmRecordRectangleInfo.TopY, (int)enmRecordRectangleInfo.ColumnsMark18 - (int)enmRecordRectangleInfo.ColumnsMark17, 150), new StringFormat(StringFormatFlags.LineLimit));
                }
            }
            //if (strCustomName.Length == 1)
            //{
            //    e.Graphics.DrawString(strCustomName, m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
            //        (int)enmRecordRectangleInfo.ColumnsMark17 + 22, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 5);
            //}
            ...
            //        (int)enmRecordRectangleInfo.ColumnsMark17 + 8, (int)enmRecordRectangleInfo.TopY + 5);
            //    e.Graphics.DrawString(strCustomName.Substring(1), m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
            //        (int)enmRecordRectangleInfo.ColumnsMark17 + 8, (int)enmRecordRectangleInfo.TopY + 2 * (int)enmRecordRectangleInfo.RowStep);
            //}
            //else
            //{
            ...
            //        (int)enmRecordRectangleInfo.ColumnsMark17 + 20, (int)enmRecordRectangleInfo.TopY + i * 20+5);
            //    }
            //}

            //执行签名
            e.Graphics.DrawString("执", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark18 + 24, (int)enmRecordRectangleInfo.TopY + 5);
            e.Graphics.DrawString("行", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark18 + 24, (int)enmRecordRectangleInfo.TopY + 27);
            e.Graphics.DrawString("签", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark18 + 24, (int)enmRecordRectangleInfo.TopY + 49);
            e.Graphics.DrawString("名", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark18 + 24, (int)enmRecordRectangleInfo.TopY + 71);

            //病情、护理措施、效果


            e.Graphics.DrawString("病情、护理措施、效果", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark19 + 20, (int)enmRecordRectangleInfo.TopY + (int)enmRecordRectangleInfo.RowStep + 5);

            //记录签名
            e.Graphics.DrawString("记", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark20 + 24, (int)enmRecordRectangleInfo.TopY + 5);
            e.Graphics.DrawString("录", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark20 + 24, (int)enmRecordRectangleInfo.TopY + 27);
            e.Graphics.DrawString("签", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark20 + 24, (int)enmRecordRectangleInfo.TopY + 49);
            e.Graphics.DrawString("名", m_fotHeaderFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX +
                (int)enmRecordRectangleInfo.ColumnsMark20 + 24, (int)enmRecordRectangleInfo.TopY + 71);
        }
        #endregion
        ...
        private void m_mthPrintRectangleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawLine(m_GridPen, (int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark19, (int)enmRecordRectangleInfo.TopY,
        ...
        private int m_intTransferNum = 0;
        private enmReturnValue m_blnPrintOneRowValueCS(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (m_dtTransfer != null)
            {
                if (objDataArr[m_intCurrentContentRow][4] != null && m_intTransferNum < m_dtTransfer.Length && m_dtTransfer[0] < Convert.ToDateTime(objDataArr[m_intCurrentContentRow][4] + " " + objDataArr[m_intCurrentContentRow][5]))
                {
                    m_intCurrentPagePrintRow = 0;
                    intNowPage++;
                    m_intTransferNum++;
            ...
            if (strTemp.Trim().Length != 0)
            {
                if (e.Graphics.MeasureString(strTemp, m_fotTinyFont).Width <= (int)enmRecordRectangleInfo.ColumnsMark18 - (int)enmRecordRectangleInfo.ColumnsMark17)
                //if (strTemp.Trim().Length <= 5)
                {
                    m_mthDrawMultiString(this.m_fotTinyFont, this.m_fotTinyFont, strTemp.Trim().Length + 1, m_intPosX, m_intPosY, m_intPosX1, m_intPosY1, m_intXOff, m_intYOff, strTemp, e);
                }
                else
                {
                    m_mthDrawMultiString(this.m_fotTinyFont, this.m_fotTinyFont, strTemp.Trim().Length - 1, m_intPosX, m_intPosY, m_intPosX1, m_intPosY1, m_intXOff, m_intYOff, strTemp, e);
            ...
            if (strTemp.Trim().Length != 0)
            {
                ...
                if (imgEmpSig != null)
                {
                     ...
                     e.Graphics.DrawImage(imgEmpSig, m_intPosX + 1, m_intPosY + 1, 60, 26);
                }
                else
                {
                    if (strTemp.Length > 5)
        ...
        private void m_mthSetOtherDetail(object[] objDetail, int intCurrentDetail, int intRowOfCurrentDetail, clsGeneralNurseRecordContent_CS objCurrent, out object[] objOtherDetail)
        {
            ...
            objOtherDetail[23] = objclsDSTRichTextBoxValue;
            objOtherDetail[24] = (DateTime)objDetail[3];
        }
            ...
            try
            {
                ...
                for (int i = 0; i < intRecordCount; i++)
                {
                    ...
                    if (objCurrent.m_dtmCreateDate != DateTime.MinValue)
                    {
                        ...
                        objData[1] = (int)enmRecordsType.GeneralNurseRecord_CSRec;//存放记录类型的int值
                        ...
                        objData[26] = objCurrent.m_strCreateUserID;//存放记录的createUserid字符串   
                        //同一个则只在第一行显示日期
                    ...
                    {//循环检查所有病情记录
                        ...
                        {//若当前记录日期与病情观察记录日期相同，先输出当前记录，再输出病情观察记录
                            ...
                            for (int m = 0; m < m_intMax; m++)
                            {
                                ...
                                if (m < ((string[])(((object[])arlDetail[intCurrentDetail])[0])).Length)
                                {
                                    ...
                                    objData[24] = (DateTime)((object[])arlDetail[intCurrentDetail])[3];
                                }
                                if (m >= ((string[])(((object[])arlDetail[intCurrentDetail])[0])).Length - 1 && m < ((string[])(((object[])arlDetail[intCurrentDetail])[0])).Length)
                                {
                                    objData[25] = ((clsEmrSigns_VO[])(((object[])arlDetail[intCurrentDetail])[4]))[intCurrentSignIndex++].objEmployee.m_strLASTNAME_VCHR;
                                }
                                else
                                {
                                    objData[25] = "";
                            ...
                            for (int j = intRowOfCurrentDetail; j < ((string[])(((object[])arlDetail[intCurrentDetail])[0])).Length; j++)
                            {
                                ...
                                if (j == ((string[])(((object[])arlDetail[intCurrentDetail])[0])).Length - 1)
                                {
                                    if (((clsEmrSigns_VO[])(((object[])arlDetail[intCurrentDetail])[4])) != null)
                                    {
                                        ...
                                        {
                                            objOtherDetail[25] = ((clsEmrSigns_VO[])(((object[])arlDetail[intCurrentDetail])[4]))[h].objEmployee.m_strLASTNAME_VCHR;
                        ...
                        {//若当前记录日期小于病情观察记录日期，则输出当前记录，循环下一条当前记录
                            ...
                            int m_intMax = Math.Max(Math.Max(objCurrent.m_objEductionArr == null ? 0 : objCurrent.m_objEductionArr.Length, objCurrent.m_objInpectArr == null ? 0 : objCurrent.m_objInpectArr.Length), objCurrent.m_strEXECUTESIGNNAMEARR.Length);
                            for (int m = 0; m < m_intMax; m++)
                            {
                                if (objCurrent.m_objInpectArr != null && m < objCurrent.m_objInpectArr.Length)
                                {
