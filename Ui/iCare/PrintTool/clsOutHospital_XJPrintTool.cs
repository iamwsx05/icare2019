...
namespace iCare
{
    ...
    /// 出院记录的打印工具类
    /// </summary>
    public class clsOutHospital_XJPrintTool : infPrintRecord
    {
        ...
        private clsOutHospitalDomain_XJ m_objRecordsDomain;
        private clsPrintInfo_OutHospital_XJ m_objPrintInfo;
        private clsOutHospitalRecordContent_XJ m_objRecordContent = null;
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            m_objPrintInfo = new clsPrintInfo_OutHospital_XJ();
        ...
        public void m_mthInitPrintContent()
        {
            ...
            {
                m_objRecordsDomain = new clsOutHospitalDomain_XJ();
                ...
                if (lngRes <= 0)
                    return;
                m_objRecordContent = (clsOutHospitalRecordContent_XJ)objContent;
            }
        ...
        public void m_mthSetPrintContent(object p_objPrintContent)
        {
            ...
            m_objPrintInfo = (clsPrintInfo_OutHospital_XJ)p_objPrintContent;
        ...
        private void m_mthPrintPageSub(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("经治医师:" + strMainName , new Font("SimSun", 12), Brushes.Black, (int)enmRectangleInfo.LeftX + 200, m_intYPos);
            //			m_intYPos+=25;
       ...
       //     m_objLine2Arr[3] = new clsPrintLine2(790);
            m_objPrintContext = new com.digitalwave.Utility.Controls.clsPrintContext(
                new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
                                         ...
                                         m_objLine2Arr[1],m_objLine1Arr[4],m_objLine1Arr[5],m_objLine2Arr[2]
									  });
            ...
            if (m_objRecordContent != null)
            {
                ...
                objData1[3] = "入院日期: " + m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日") + "　　　　　　　　　　　" + "出院日期: " + strOutDate;
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("出   院   记   录", m_fotTitleFont, m_slbBrush, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title));
