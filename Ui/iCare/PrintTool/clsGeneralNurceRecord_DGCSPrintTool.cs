...
namespace iCare
{
    ...
    public class clsGeneralNurseRecord_DGCSPrintTool : infPrintRecord
    {
        ...
        private clsPrintInfo_GeneralNurseRecordDGCS m_objPrintInfo;     //打印内容
        ...
        private enum enmRecordRectangleInfo
        {
            ...
            ColumnsMark7 = 350,//神志
            ColumnsMark8 = 390,//摄入种类
            ColumnsMark9 = 430,//摄入量
            ColumnsMark10 = 470,//排出种类
            ColumnsMark11 = 510,//排出量
            ColumnsMark12 = 550,//自定义列
            ColumnsMark13 = 620,//执行签名
            ColumnsMark14 = 690,//病情观察
            ColumnsMark15 = 950//记录签名
        }
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            //在最后一行下面打印说明部分
            e.Graphics.DrawString("（供内科、妇产科、普儿科使用）        注：SpO2指经皮血氧饱和度（脉动血氧饱和度）", m_fotSmallFont, m_slbBrush,
        ...
        private void m_mthAddDataToGrid(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            m_mthDrawMultiString(this.m_fotSmallFont, (int)enmRecordRectangleInfo.LeftX + 300, iTemp, (int)enmRecordRectangleInfo.RightX + 300, iTemp + 50, 1, 1, "（第" + intNowPage.ToString() + "页）", e);
