...
namespace iCare
{
    ...
    /// </summary>
    public class clsInHospitalMainRecordCSPrintTool : infPrintRecord
    {
        ...
        public clsInHospitalMainRecordCSPrintTool(bool p_blnPrintTitle)
        {
            s_blnPrintTitle = p_blnPrintTitle;
        }

        public clsInHospitalMainRecordCSPrintTool()
        {
        }
        ...
        public void m_mthSetPrintInfo(clsPatient p_objPatient, DateTime p_dtmInPatientDate, DateTime p_dtmOpenDate)
        {
            ...
            if (lngRes > 0 && objTransDeptInstance != null)
            {
                ...
                if (objTransDeptInstance.m_strTransSourceDeptIDArr != null
                    && objTransDeptInstance.m_strTransTargetDeptIDArr != null
                    && objTransDeptInstance.m_strTransSourceDeptIDArr.Length == objTransDeptInstance.m_strTransTargetDeptIDArr.Length)
                {
                    for (int i = 0; i < objTransDeptInstance.m_strTransTargetDeptIDArr.Length; i++)
                    {
                        strChangeDept += objTransDeptInstance.m_strTransTargetDeptNameArr[i] + "(" + objTransDeptInstance.m_strTransDeptDateArr[i].Substring(0, 9).Replace("-", "") + ") ";
                    }
                }
            }
            #endregion
        ...
        public void m_mthInitPrintContent()
        {
            ...
            if (m_objPrintInfo.m_objCollection != null)
            {
            ...
            public PointF m_getCoordinatePoint(int p_intItemName)
            {
                ...
                switch (p_intItemName)
                {
                    case (int)enmItemDefination.Page_HospitalName:
                        m_fReturnPoint = new PointF(90f - fltOffsetX, 25f);
                        break;
                    case (int)enmItemDefination.Page_Name_Title:
                        m_fReturnPoint = new PointF(79f - fltOffsetX, 32f);
                        break;
                    case (int)enmItemDefination.Name_Title:
                        m_fReturnPoint = new PointF(18f - fltOffsetX, 45f);
                        break;
                    default:
        ...
        private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (m_objCollection != null && m_objCollection.m_objContent != null)
            {
                ...
                objEveryRecordPageInfo.m_strPatientHistoryNO = m_objPrintInfo.m_strHISInPatientID;//m_objCollection.m_objContent.m_strPatientHistoryNO;// txtPatientHistoryNO.Text;
            }
            else
            {
            ...
            e.Graphics.DrawRectangle(new Pen(m_slbBrush, 0.1f), 44 - fltOffsetX, 45, 3, 3);
            e.Graphics.DrawString(m_strModeOfPayment, m_fotSmallFont, m_slbBrush, 44f - fltOffsetX, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Name_Title).Y);
            e.Graphics.DrawString("医保号：", m_fotSmallFont, m_slbBrush, 55f - fltOffsetX, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Name_Title).Y);
            e.Graphics.DrawString(objEveryRecordPageInfo.m_strInsuranceNum, m_fotSmallFont, m_slbBrush,69f - fltOffsetX, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Name_Title).Y);
        ...
        private void m_mthSetPrintValue()
        {
            ...
            if (m_bolIfCheck)
            {
                ...
                m_objDataArr[3] = m_objCollection.m_objMain.m_strDiagnosisXML;
            ...
            if (m_bolIfCheck)
            {
                ...
                m_objDataArr[3] = m_objCollection.m_objMain.m_strMainDiagnosisXML;
            ...
            if (m_bolIfCheck)
            {
                ...
                m_objDataArr[1] = m_objCollection.m_objMain.m_strPathologyDiagnosisXML;
            ...
            if (m_bolIfCheck)
            {
                ...
                m_objDataArr[4] = m_objCollection.m_objMain.m_strSensitiveXML;
        ...
        private class clsPrintLine1 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                else
                {
                    ...
                    {
                        switch(m_objPeople.m_StrMarried)
                        {
                            case "未婚":
        ...
        private class clsPrintLine3 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_objPeople != null)
                {
                    p_objGrp.DrawString(m_objPeople.m_StrHomePhone, m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 125, p_intPosY);
                    p_objGrp.DrawString(m_objPeople.m_StrOfficePC, m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 165, p_intPosY);
                    ...
                    StringFormat frmat = new StringFormat();
                    if (m_objPeople.m_StrOffice_name.Length > 10 || m_objPeople.m_StrOfficeAddress.Length >11)
                    {
                        fotNow1 = new Font("SimSun", 8f);
                        rtgf1 = new RectangleF((int)enmRectangleInfo.LeftX + 19, p_intPosY, 75, 35);
                        rtgf2 = new RectangleF((int)enmRectangleInfo.LeftX + 65, p_intPosY, 75, 35);
                        if (m_objPeople.m_StrOffice_name.Length > 10)
                        {
                            rtgf1 = new RectangleF((int)enmRectangleInfo.LeftX + 19, p_intPosY - 2, 75, 35);
                    ...
                    {
                        p_objGrp.DrawString(m_objPeople.m_StrOffice_name, m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 17, p_intPosY);
        ...
        private class clsPrintLine8 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                Rectangle rtg = new Rectangle((int)enmRectangleInfo.LeftX + 25, p_intPosY, 80, 25);
                ...
                if (m_objDataArr[0].ToString().Length > 15)
                {
                    ...
                    rtg = new Rectangle((int)enmRectangleInfo.LeftX + 25, p_intPosY - 2, 55, 35);
                    frmat.FormatFlags = StringFormatFlags.FitBlackBox;
                }
                //p_objGrp.DrawString(m_objDataArr[0].ToString(), fotNow, Brushes.Black, rtgf, frmat/*(int)enmRectangleInfo.LeftX+25,p_intPosY*/);
                int intRealHeight=0;
                m_objText1.m_mthSetContextWithAllCorrect(m_objDataArr[0].ToString(),m_objDataArr[3].ToString());
                m_objText1.m_blnPrintAllBySimSun(intfotNow, rtg, p_objGrp, out intRealHeight, false);
                m_blnHaveMoreLine = false;
                p_intPosY += (int)enmRectangleInfo.RowStep1;
                //				}
                p_objGrp.PageUnit = enmOld;
        ...
        private class clsPrintLine9 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                StringFormat frmat = new StringFormat();
                if (m_objDataArr[0].ToString().Length > 26)
                {
                    fotNow = new Font("SimSun", 8f);
                    rtgf = new RectangleF((int)enmRectangleInfo.LeftX + 18, p_intPosY, 100, 35);
                    if (m_objDataArr[0].ToString().Length > 34)
                        rtgf = new RectangleF((int)enmRectangleInfo.LeftX + 18, p_intPosY - 2, 100, 35);
                    frmat.FormatFlags = StringFormatFlags.FitBlackBox;
                }
        ...
        private class clsPrintLine10 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (s_blnPrintTitle)
                {
                    ...
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX - 2, 51, (int)enmRectangleInfo.LeftX - 2, 288);//1
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.RightX, 51, (int)enmRectangleInfo.RightX, 288);//1
        ...
        private class clsPrintLine11 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (p_intPosY != 1000)
                {
                    ...
                    {
                        p_objGrp.DrawString(strMainDiagnose.Substring(0, 22), m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 18, p_intPosY);
                    ...
                    p_objGrp.DrawString(strMainDiagnose, m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 18, p_intPosY);
                    m_intRows++;
                    m_blnHaveMoreLine = false;
                    p_intPosY += (int)enmRectangleInfo.RowStep;
                }
                ...
                //{
                //    //p_objGrp.DrawString(strMainDiagnose, m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 18, p_intPosY);
                //    Rectangle rtg = new Rectangle((int)enmRectangleInfo.LeftX + 18, p_intPosY, 80, 25);
                //    int intRealHeight = 0;
                //    m_objText1.m_mthSetContextWithAllCorrect(m_objDataArr[0].ToString(), m_objDataArr[3].ToString());
                //    m_objText1.m_blnPrintAllBySimSun(10.5f, rtg, p_objGrp, out intRealHeight, false);
                //    m_intRows++;
                //    m_blnHaveMoreLine = false;
                //    p_intPosY += (int)enmRectangleInfo.RowStep;
                //    if (p_intPosY >= 289)
                ...
                {
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 103, m_intPosY, (int)enmRectangleInfo.LeftX + 103, 288);//2
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 113, m_intPosY + 8, (int)enmRectangleInfo.LeftX + 113, 288);//3
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 123, m_intPosY + 8, (int)enmRectangleInfo.LeftX + 123, 288);//4
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 133, m_intPosY + 8, (int)enmRectangleInfo.LeftX + 133, 288);//5
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 143, m_intPosY + 8, (int)enmRectangleInfo.LeftX + 143, 288);//6
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 153, m_intPosY, (int)enmRectangleInfo.LeftX + 153, 288);//7
                }
            }
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_objDataArr != null && m_objDataArr.Length > 0)
                {
                    ...
                    {   
                        ...
                        if (strOtherDiagnose == "")
                        {
                            p_objGrp.DrawString("无", m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 18, p_intPosY);
                            if(m_intPages>1)
                                p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX1, p_intPosY - 1, (int)enmRectangleInfo.RightX1, p_intPosY - 1);
                            m_intRows++;
                        }
        ...
        private class clsPrintLine13 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_intPages > 1)
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX1, p_intPosY - 1, (int)enmRectangleInfo.RightX1, p_intPosY - 1);
                else if (m_intRows < 13)
                    p_intPosY += (14-m_intRows) * (int)enmRectangleInfo.RowStep;
                ...
                p_objGrp.DrawString(m_objDataArr[0].ToString() == "" ? "无" : m_objDataArr[0].ToString(), m_fotPrintFont, Brushes.Black, (int)enmRectangleInfo.LeftX + 25, p_intPosY);
                m_intRows++;
                int m_intY = p_intPosY + 5;
                if (m_intRows > 14)//超过固定行数
                {
                    m_intY = m_intPosY + (int)enmRectangleInfo.RowStep * (m_intRows + 2) + 1;
                }
                if (m_intPages > 1)
                {
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 103, 28, (int)enmRectangleInfo.LeftX + 103, m_intY+1);//2
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 113, 28 , (int)enmRectangleInfo.LeftX + 113, m_intY+1);//3
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 123, 28, (int)enmRectangleInfo.LeftX + 123, m_intY+1);//4
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 133, 28 , (int)enmRectangleInfo.LeftX + 133, m_intY+1);//5
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 143 ,28 , (int)enmRectangleInfo.LeftX + 143, m_intY+1);//6
                    p_objGrp.DrawLine(m_pen, (int)enmRectangleInfo.LeftX + 153, 28, (int)enmRectangleInfo.LeftX + 153, m_intY+1);//7
                }
                else
                {
        ...
        private class clsPrintLine14 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                Rectangle rtg = new Rectangle((int)enmRectangleInfo.LeftX + 23, p_intPosY, 80, 25);
                int intRealHeight = 0;
                m_objText1.m_mthSetContextWithAllCorrect(m_objDataArr[0].ToString(), m_objDataArr[1].ToString());
                m_objText1.m_blnPrintAllBySimSun(10.5f, rtg, p_objGrp, out intRealHeight, false);
                m_blnHaveMoreLine = false;
                p_intPosY += (int)enmRectangleInfo.RowStep;
                if (p_intPosY >= 289)
        ...
        private class clsPrintLine16 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                Rectangle rtg = new Rectangle((int)enmRectangleInfo.LeftX + 18, p_intPosY, 80, 25);
                int intRealHeight = 0;
                m_objText1.m_mthSetContextWithAllCorrect(m_objDataArr[0].ToString(), m_objDataArr[4].ToString());
                m_objText1.m_blnPrintAllBySimSun(10.5f, rtg, p_objGrp, out intRealHeight, false);
                m_blnHaveMoreLine = false;
                p_intPosY += (int)enmRectangleInfo.RowStep;
                if (p_intPosY >= 289)
        ...
        private class clsPrintLine100 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                if (s_blnPrintTitle)
                {
                    ...
                    p_objGrp.DrawLine(m_pen, m_intLeftX + 104, p_intPosY + 5, m_intLeftX + 104, p_intPosY + 65);
                    p_objGrp.DrawLine(m_pen, m_intLeftX + 117, p_intPosY + 5, m_intLeftX + 117, p_intPosY + 65);
                    ...
                    p_objGrp.DrawLine(m_pen, m_intLeftX + 22, p_intPosY-1, m_intLeftX + 22, p_intPosY + 65);
                    p_objGrp.DrawString("手术、操作", m_fotPrintFont, Brushes.Black, m_intLeftX + 27, p_intPosY + 2);

                    p_objGrp.DrawLine(m_pen, m_intLeftX + 47, p_intPosY-1, m_intLeftX + 47, p_intPosY + 65);
                    p_objGrp.DrawString("手术、操作名称", m_fotPrintFont, Brushes.Black, m_intLeftX + 58, p_intPosY + 4);

                    p_objGrp.DrawLine(m_pen, m_intLeftX + 91, p_intPosY-1, m_intLeftX + 91, p_intPosY + 65);
                    p_objGrp.DrawString("手术、操作医师", m_fotPrintFont, Brushes.Black, m_intLeftX + 99, p_intPosY + 1);

                    p_objGrp.DrawLine(m_pen, m_intLeftX + 130, p_intPosY-1, m_intLeftX + 130, p_intPosY + 65);
                    p_objGrp.DrawString("麻醉", m_fotPrintFont, Brushes.Black, m_intLeftX + 134, p_intPosY + 2);

                    p_objGrp.DrawLine(m_pen, m_intLeftX + 145, p_intPosY-1, m_intLeftX + 145, p_intPosY + 65);
                    p_objGrp.DrawString("切口愈", m_fotPrintFont, Brushes.Black, m_intLeftX + 148, p_intPosY + 2);

                    p_objGrp.DrawLine(m_pen, m_intLeftX + 162, p_intPosY-1, m_intLeftX + 162, p_intPosY + 65);
                    p_objGrp.DrawString("麻醉医师", m_fotPrintFont, Brushes.Black, m_intLeftX + 166, p_intPosY + 4);

                    p_objGrp.DrawLine(m_pen, m_intRightX, 28, m_intRightX, 276);
                    p_objGrp.DrawLine(m_pen, m_intLeftX, 28, m_intLeftX, 276);
                    //p_objGrp.DrawLine(m_pen, m_intLeftX, 288, m_intRightX, 288);
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_objDataArr != null && m_objDataArr.Length > 0)
                {
                    ...
                    for (int i = 0; i < m_objDataArr.Length; i++)
                    {
                        ...
                        if (m_objSubDataArr[3].ToString() == "")
                        {
                            strSign = "/";
                            intPosX = m_intLeftX + 95;
                        }
                        else
                        {
                            strSign = m_objSubDataArr[3].ToString();
                            intPosX = m_intLeftX + 92;
                        }
                        p_objGrp.DrawString(strSign, m_fotPrintFont, Brushes.Black, intPosX, p_intPosY + intIncreaseHeight);
                        if (m_objSubDataArr[4].ToString() == "")
                        {
                            strSign = "/";
                            intPosX = m_intLeftX + 109;
                        }
                        else
                        {
                            strSign = m_objSubDataArr[4].ToString();
                            intPosX = m_intLeftX + 106;
                        }
                        p_objGrp.DrawString(strSign, m_fotPrintFont, Brushes.Black, intPosX, p_intPosY + intIncreaseHeight);
                        if (m_objSubDataArr[5].ToString() == "")
                        {
                            strSign = "/";
                            intPosX = m_intLeftX + 122;
                        }
                        else
                        {
                            strSign = m_objSubDataArr[5].ToString();
                            intPosX = m_intLeftX + 119;
                        }
                        p_objGrp.DrawString(strSign, m_fotPrintFont, Brushes.Black, intPosX, p_intPosY + intIncreaseHeight);
                        p_objGrp.DrawString(m_objSubDataArr[7].ToString(), m_fotPrintFont, Brushes.Black, m_intLeftX + 146, p_intPosY + intIncreaseHeight);
                        if (m_objSubDataArr[8].ToString() == "")
                        {
                            strSign = "/";
                            intPosX = m_intLeftX + 173;
                        }
                        else
                        {
                            strSign = m_objSubDataArr[8].ToString();
                            intPosX = m_intLeftX + 165;
                        }
                        p_objGrp.DrawString(strSign, m_fotPrintFont, Brushes.Black, intPosX, p_intPosY + intIncreaseHeight);
        ...
        private class clsPrintLine115 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (s_blnPrintTitle)
                {
                    p_objGrp.DrawString("II.化疗：方式：根治性、姑息性、新辅助性、辅助性、新药  化疗方法：全化、半化、A插管、胸腔注、腹腔注、髓注、其他", m_fotPrintFont, Brushes.Black, m_intLeftX + 2, p_intPosY + 26);
                    //				p_objGrp.DrawLine(m_pen,m_intRightX,p_intPosY,m_intRightX,p_intPosY+(int)enmRectangleInfo.RowStep);
                }
        ...
        private class clsPrintLine123 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (s_blnPrintTitle)
                {
                    p_objGrp.DrawString("随诊      1.是 2.否          随诊期限        周    月    年        示教病例          1.是 2.否", m_fotPrintFont, Brushes.Black, m_intLeftX + 5, m_intPosY);
                ...
                p_objGrp.DrawString(m_objDataArr[1].ToString(), m_fotPrintFont, Brushes.Black, m_intLeftX + 80, m_intPosY);
        ...
        private class clsPrintLine129 : com.digitalwave.Utility.Controls.clsPrintLineBase
        {
            ...
            public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
            {
                ...
                if (m_intPages > 2)
                {
                    p_objGrp.DrawLine(m_pen, m_intLeftX, 28, m_intRightX, 28);
                    p_objGrp.DrawLine(m_pen, m_intRightX, 28, m_intRightX, 288);
                    p_objGrp.DrawLine(m_pen, m_intLeftX, 28, m_intLeftX, 288);
                    p_objGrp.DrawLine(m_pen, m_intLeftX, 288, m_intRightX, 288);
                }
        ...
        //		/// </summary>
        //		[Serializable]			
        //		private class clsPrintInfo_InHospitalMainRecord
        //		{
        ...
        //			
        //			public clsPeopleInfo m_objPeopleInfo;//病人的基本信息

        //
        //			public clsInHospitalMainRecord_Collection m_objCollection;	
        //			public DateTime m_dtmFirstPrintTime;
        //
        //			public string m_strTimes;//第几次住院

        //			public string m_strInHosptialSetionName;//入院部门
        //			public string m_strInSickRoomName;//入院病房
        //			public string m_strOutHosptialSetionName;//出院部门
        //			public string m_strOutSickRoomName;//出院病房
        //			public string m_strInHospitalDays;//住院天数
        //			public DateTime m_dtmOutHospitalDate;//出院日期
        //			public string m_strChangeDept;//转换的部门
