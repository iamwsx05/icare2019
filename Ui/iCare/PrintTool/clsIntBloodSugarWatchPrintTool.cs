...
namespace iCare
{
    ...
    public partial class clsIntBloodSugarWatchPrintTool : infPrintRecord
    {
     ...
     DateTime[] p_dtmFirstPrintDate)
        ...
        {
            e.Graphics.DrawString(clsSystemContext.s_ObjCurrentContext.m_ObjHospitalInfo.m_StrHospitalTitle, m_fotSmallFont, m_slbBrush, 320, 60);
            e.Graphics.DrawString("内分泌科血糖观察表", m_fotTitleFont, m_slbBrush, 250, 100);

            e.Graphics.DrawString("姓名：", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX, 150);
            //e.Graphics.DrawLine(m_GridPen,(int)enmRectangleInfo.LeftX+50,120,(int)enmRectangleInfo.LeftX+120,120);
            e.Graphics.DrawString((m_objPatient == null ? "" : m_objPatient.m_ObjPeopleInfo.m_StrFirstName), m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 45, 150);

            e.Graphics.DrawString("性别：", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 125, 150);
            //e.Graphics.DrawLine(m_GridPen,(int)enmRectangleInfo.LeftX+165,120,(int)enmRectangleInfo.LeftX+185,120);
            e.Graphics.DrawString((m_objPatient == null ? "" : m_objPatient.m_ObjPeopleInfo.m_StrSex), m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 165, 150);

            e.Graphics.DrawString("年龄：", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 200, 150);
            //e.Graphics.DrawLine(m_GridPen,(int)enmRectangleInfo.LeftX+230,120,(int)enmRectangleInfo.LeftX+275,120);
            e.Graphics.DrawString((m_objPatient == null ? "" : m_objPatient.m_ObjPeopleInfo.m_StrAge), m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 240, 150);
            ...
            e.Graphics.DrawString("病区：", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 335, 150);
            //e.Graphics.DrawLine(m_GridPen,(int)enmRectangleInfo.LeftX+430,120,(int)enmRectangleInfo.LeftX+450,120);
            e.Graphics.DrawString((m_objPatient == null ? "" : m_objPatient.m_ObjInBedInfo.m_objGetSessionByInDate(m_objPatient.m_DtmSelectedInDate).m_ObjLastDept.m_ObjLastArea.m_ObjArea.m_StrAreaName), m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 375, 150);

            e.Graphics.DrawString("住院号：", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 605, 150);
            //e.Graphics.DrawLine(m_GridPen,(int)enmRectangleInfo.LeftX+560,120,(int)enmRectangleInfo.LeftX+640,120);
            e.Graphics.DrawString((m_objPatient == null ? "" : m_objPatient.m_StrInPatientID.Trim()), m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 665, 150);

            e.Graphics.DrawString("床号：", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 525, 150);
            ...
            e.Graphics.DrawString(strTemp, m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 565, 150);
        }
        ...
        private void m_mthPrintRectangleInfo(PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("     日期", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX, 178);
            e.Graphics.DrawString("空腹", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("早餐后\n2小时", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("中餐前", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("中餐后\n2小时", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("晚餐前", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("晚餐后\n2小时", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("睡前", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("备注", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            intXPos += m_intLineStep;
            e.Graphics.DrawLine(m_GridPen, (int)enmRectangleInfo.LeftX + intXPos, intYPos, (int)enmRectangleInfo.LeftX + intXPos, (int)enmRectangleInfo.BottomY);
            e.Graphics.DrawString("   签名", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + intXPos + 1, 178);
            for (int i = 0; i < 34; i++)
            {
                if (i == 0)
                {
            ...
            e.Graphics.DrawString("第 " + m_intPages.ToString() + " 页", m_fotSmallFont, m_slbBrush, (int)enmRectangleInfo.LeftX + 600, intYPos + 3);
        }
