...
namespace iCare
{
	...
	/// 住院病历按广西要求的打印工具类
	/// </summary>
	public class clsInPatientCaseHistory_GXPrintTool: infPrintRecord
	{	
		...
		private  void m_mthSetPrintContent(clsInPatientCaseHistoryContent p_objContent,DateTime p_dtmFirstPrintDate)
		{
			m_objPrintLineContext = new com.digitalwave.Utility.Controls.clsPrintContext(
				new com.digitalwave.Utility.Controls.clsPrintLineBase[]{
																		   ...
																		   new clsPrintModifyDiagnoseTitleInfo(),
																		   new clsPrintModifyDiagnoseInfo(),
																		   new clsPrintModifyDiagnoseNameAndDate(),
...
#region Title
                ...
                //p_objGrp.DrawString("入 院 记 录",clsInPatientCaseHistory_GXPrintTool.m_fotItemHead,Brushes.Black,m_intRecBaseX+310,p_intPosY - 10);
                ...
                if (m_objPrintInfo.m_dtmInPatientDate != DateTime.MinValue)
                {
                    p_objGrp.DrawString("入院日期：" + m_objPrintInfo.m_dtmHISInDate.ToString("yyyy年MM月dd日"), p_fntNormalText, Brushes.Black, m_intPatientInfoX + 350, p_intPosY);
                }
                else
                {
		...
		private class clsPrintInPatientCaseMain : clsPrintInPatientCaseInfo
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_blnIsFirstPrint)
				{
                    ...
                    if (clsInPatientCaseHistory_GXPrintTool.m_blnIsPrintMark)
                    {
...
//							p_intPosY += 30;
		...
		private class clsPrintInPatientBodyChekcFixStatus : clsPrintInPatientCaseInfo
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				{
					//					p_intPosY += 30;
					p_objGrp.DrawString("体 格 检 查",clsInPatientCaseHistory_GXPrintTool.m_fotItemHead,Brushes.Black,m_intRecBaseX+330,p_intPosY);
...
//					if(p_intPosY != 145) p_intPosY += 30;
					...
					p_objGrp.DrawString("专 科 检 查",clsInPatientCaseHistory_GXPrintTool.m_fotItemHead,Brushes.Black,m_intRecBaseX+330,p_intPosY);
...
//					}
		...
		private class clsPrintPatientPrimaryDiagnoseInfo : clsPrintInPatientCaseInfo
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_objContent == null || m_objContent.m_strPrimaryDiagnoseAll == "")
				{
//					p_intPosY += 30;
					m_blnHaveMoreLine = false;
				...
				{
					m_objPrintContext1.m_mthPrintLine((int)enmRectangleInfoInPatientCaseInfo.PrintWidth,m_intRecBaseX+50,p_intPosY,p_objGrp);
		...
		/// 修正诊断Title
		/// </summary>
		private class  clsPrintModifyDiagnoseTitleInfo : clsPrintInPatientCaseInfo
		{
			private clsPrintRichTextContext m_objPrintContext = new clsPrintRichTextContext(Color.Black,new Font("",10));

			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				if(m_objContent != null && m_objContent.m_strModifyDiagnoseAll != null && m_objContent.m_strModifyDiagnoseAll.Trim() != "")
				{
					p_intPosY += 20;
		...
		/// 修正诊断
		/// </summary>
		private class  clsPrintModifyDiagnoseInfo : clsPrintInPatientCaseInfo
		{
            ...
            public clsPrintModifyDiagnoseInfo()
            {
                if(clsEMRLogin.m_StrCurrentHospitalNO != "450101001")//南宁
                    clr = Color.Black;
                m_objPrintContext1 = new clsPrintRichTextContext(clr, new Font("", 10));
            }
		
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				if(m_objContent == null || m_objContent.m_strModifyDiagnoseAll == ""/* && m_objContent.m_strCarePlan == "")*/)
				{
//					p_intPosY += 30;
					m_blnHaveMoreLine = false;
				...
				if(m_blnIsFirstPrint)
				{	
					if(m_objContent.m_strModifyDiagnoseAll != null && m_objContent.m_strModifyDiagnoseAll.Trim() != "")
					{
                        if (clsInPatientCaseHistory_GXPrintTool.m_blnIsPrintMark)
                        {
                            m_objPrintContext1.m_mthSetContextWithCorrectBefore((m_objContent == null ? "" : m_objContent.m_strModifyDiagnoseAll), (m_objContent == null ? "<root />" : m_objContent.m_strModifyDiagnoseXML), m_dtmFirstPrintTime, m_objContent != null, clr);
                            m_mthAddSign2("修正诊断：", m_objPrintContext1.m_ObjModifyUserArr);
                        }
                        else
                        {
                            m_objPrintContext1.m_mthSetContextWithAllCorrect((m_objContent == null ? "" : m_objContent.m_strModifyDiagnoseAll), (m_objContent == null ? "<root />" : m_objContent.m_strModifyDiagnoseXML));
                        }
					}
					m_blnIsFirstPrint = false;					
...
//					p_intPosY += 30;
				...
				{	
					if(m_objContent.m_strAddDiagnoseALL != null && m_objContent.m_strAddDiagnoseALL.Trim() != "")
					{
                        if (clsInPatientCaseHistory_GXPrintTool.m_blnIsPrintMark)
                        {
                            m_objPrintContext1.m_mthSetContextWithCorrectBefore((m_objContent == null ? "" : m_objContent.m_strAddDiagnoseALL), (m_objContent == null ? "<root />" : m_objContent.m_strAddDiagnoseXML), m_dtmFirstPrintTime, m_objContent != null, clr);
                            m_mthAddSign2("补充诊断：", m_objPrintContext1.m_ObjModifyUserArr);
                        }
                        else
                        {
		...
		/// 修正诊断签名、日期
		/// </summary>
		private class   clsPrintModifyDiagnoseNameAndDate : clsPrintInPatientCaseInfo
		{
			private clsPrintRichTextContext m_objPrintContext1 = new clsPrintRichTextContext(Color.Black,new Font("",10));
            private com.digitalwave.emr.BEDExplorer.clsHospitalManagerDomain m_objEmployeeSign = new com.digitalwave.emr.BEDExplorer.clsHospitalManagerDomain();
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_objContent!=null)
                {
                    m_objEmployeeSign.m_lngGetEmpByNO(m_objContent.m_strModifyDiagnoseDoctorID, out objEmpVO);
                    if (objEmpVO != null)
                        strPrimaryDoctorName = objEmpVO.m_strGetTechnicalRankAndName;
                    objEmpVO = null;
					if(m_objContent.m_datModifyDiagnose != DateTime.MinValue && m_objContent.m_datModifyDiagnose != new DateTime(1900,1,1))
						strSignDate = m_objContent.m_datModifyDiagnose.ToString("yyyy年MM月dd日");
				}
                if (m_objContent != null && m_objContent.m_strModifyDiagnoseAll != null && m_objContent.m_strModifyDiagnoseAll.Trim() != "")
				{
					...
					p_intPosY += 20;
					p_objGrp.DrawString(strSignDate,p_fntNormalText,Brushes.Black,m_intRecBaseX+580,p_intPosY);
					p_intPosY += 20;
				}
		...
		private class   clsPrintAddDiagnoseNameAndDate : clsPrintInPatientCaseInfo
		{
			...
			public override void m_mthPrintNextLine(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				if(m_objContent!=null)
                {
					...
					if (objEmpVO != null)
                        strPrimaryDoctorName = objEmpVO.m_strGetTechnicalRankAndName;
                    objEmpVO = null;
					if(m_objContent.m_datAddDiagnose != DateTime.MinValue && m_objContent.m_datAddDiagnose != new DateTime(1900,1,1))
						strSignDate = m_objContent.m_datAddDiagnose.ToString("yyyy年MM月dd日");
				}
                if (m_objContent != null && m_objContent.m_strAddDiagnoseALL != null && m_objContent.m_strAddDiagnoseALL.Trim() != "")
				{
					p_objGrp.DrawString("医师签名："+strPrimaryDoctorName ,p_fntNormalText,Brushes.Black,m_intRecBaseX+500,p_intPosY);
			...
			private void m_mthPrintDocSign(ref int p_intPosY, System.Drawing.Graphics p_objGrp, System.Drawing.Font p_fntNormalText)
			{
				...
				string strCreateDoc = "";
                clsEmrEmployeeBase_VO objEmpVO = null;
				if(m_objContent != null && m_objContent.m_strDiretDoctor != null)
                {
                    m_objEmployeeSign.m_lngGetEmpByNO(m_objContent.m_strDiretDoctor, out objEmpVO);
                    if (objEmpVO != null)
                        strDirDoc = objEmpVO.m_strGetTechnicalRankAndName;
				}
				if(m_objContent != null && m_objContent.m_strChargeDoctor != null)
				{
                    m_objEmployeeSign.m_lngGetEmpByNO(m_objContent.m_strChargeDoctor, out objEmpVO);
                    if (objEmpVO != null)
                        strChargeDoc = objEmpVO.m_strGetTechnicalRankAndName;
                }
                if (m_objContent != null && m_objContent.m_strCreateUserID != null)
                {
                    m_objEmployeeSign.m_lngGetEmpByNO(m_objContent.m_strCreateUserID, out objEmpVO);
                    if (objEmpVO != null)
                        strCreateDoc = objEmpVO.m_strGetTechnicalRankAndName;
                }
                objEmpVO = null;
				p_objGrp.DrawString("主任医师："+strDirDoc ,p_fntNormalText,Brushes.Black,m_intRecBaseX+10,p_intPosY);
				p_objGrp.DrawString("主治医师："+strChargeDoc ,p_fntNormalText,Brushes.Black,m_intRecBaseX+250,p_intPosY);
                p_objGrp.DrawString("住院医师：" + strCreateDoc, p_fntNormalText, Brushes.Black, m_intRecBaseX + 500, p_intPosY);
		...
		private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
		{
            ...
            SizeF m_szfChildTitle = e.Graphics.MeasureString("普 通 住 院 病 历", m_fotTitleFont);
            ...
            e.Graphics.DrawString("普 通 住 院 病 历", m_fotTitleFont, Brushes.Black, m_intChildTitleNameOffSetX, m_objPageSetting.m_getCoordinatePoint((int)enmItemDefination.Page_Name_Title).Y);
