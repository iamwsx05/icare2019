...
{
	/// <summary>
	/// Summary description for clsSubDiseaseTrackPrintTool. 病程记录
	/// </summary>
...
//		}
		...
		private void m_mthPrintTitleInfo(System.Drawing.Printing.PrintPageEventArgs e)
		{
            ...
            //管床医师签名
            //e.Graphics.DrawString("管床医师：____________", m_fotSmallFont, m_slbBrush, (int)enmRecordRectangleInfo.LeftX + (int)enmRecordRectangleInfo.ColumnsMark2-80,
		...
		{			
            ...
            e.Graphics.DrawString("（第" + intNowPage.ToString() + "页）", m_fotSmallFont, m_slbBrush, ((int)enmRecordRectangleInfo.RightX - (int)enmRecordRectangleInfo.LeftX )/ 2,
