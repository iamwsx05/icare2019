...
namespace com.digitalwave.DiseaseTrackService
{
	...
	public class clsCheckRoomService: clsDiseaseTrackService
	{
		...
		#region RegionName
		// 从CheckRoomRecord获取指定病人的所有没有删除记录的时间。
		...
		// 根据指定表单的信息，从CheckRoomRecord和CheckRoomRecordContent查找表单的内容。
		...
		//
		//		// 从CheckRoomRecord获取已经存在记录的主要信息
		//		private const string c_strGetExistInfoSQL="";

		// 从CheckRoomRecordContent获取指定表单的最后修改时间。
		...
		//		// 从CheckRoomRecordContent获取修改表单的主要信息。
		//		private const string c_strGetModifyRecordSQL="";

		// 从CheckRoomRecord获取删除表单的主要信息。
		...
		// 修改记录到CheckRoomRecordContent
		private const string c_strModifyRecordContentSQL=c_strAddNewRecordContentSQL;

		// 设置CheckRoomRecord中删除记录的信息
		...
		// 从CheckRoomRecord和CheckRoomRecordContent获取LastModifyDate和FirstPrintDate
		...
		// 更新CheckRoomRecord中FirstPrintDate
		...
		// 从CheckRoomRecord获取指定病人的所有指定删除者删除的记录时间。
		...
		// 从CheckRoomRecord获取指定病人的所有已经删除的记录时间。
		// 用 InPatientID ,InPatientDate ,Status = 1 查得所有可用的CreateDate和OpenDate时间
