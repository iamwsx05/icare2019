...
namespace com.digitalwave.DiseaseTrackService
{
	...
	public class clsConveyService: clsDiseaseTrackService
	{
		...
		#region RegionName
		// 从ConveyRecord获取指定病人的所有没有删除记录的时间。
		...
		// 根据指定表单的信息，从ConveyRecord和ConveyRecordContent查找表单的内容。
		...
		//
		//		// 从ConveyRecord获取已经存在记录的主要信息
		//		private const string c_strGetExistInfoSQL="";

		// 从ConveyRecordContent获取指定表单的最后修改时间。
		...
		//		// 从ConveyRecordContent获取修改表单的主要信息。
		//		private const string c_strGetModifyRecordSQL="";

		// 从ConveyRecord获取删除表单的主要信息。
		...
		// 修改记录到ConveyRecordContent
		private const string c_strModifyRecordContentSQL=c_strAddNewRecordContentSQL;

		// 设置ConveyRecord中删除记录的信息
		...
		// 从ConveyRecord和ConveyRecordContent获取LastModifyDate和FirstPrintDate
		...
		// 从ConveyRecord获取指定病人的所有指定删除者删除的记录时间。
		...
		// 从ConveyRecord获取指定病人的所有已经删除的记录时间。
		// 用 InPatientID ,InPatientDate ,Status = 1 查得所有可用的CreateDate和OpenDate时间
