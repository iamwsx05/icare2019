...
namespace MAGLUMI_4000_plus
{
    ...
    public class MAGLUMI_X8_Duplex
    {
        #region 变量
        /// <summary>
        /// 仪器代号
        ...
        /// 
        /// </summary>
        MAGLUMI_X8_ControlCode ControlCode = null;
        /// <summary>
        /// 数据分析类
        /// </summary>
        DataAnalysis_MAGLUMI_X8 DateAnalysis = null;
        ...
        public MAGLUMI_X8_Duplex()
        {
            ...
            ControlCode = new MAGLUMI_X8_ControlCode();
            DateAnalysis = new DataAnalysis_MAGLUMI_X8();
        ...
        /// </summary>
        /// <param name="p_objConfig"></param>
        public MAGLUMI_X8_Duplex(clsLIS_Equip_ConfigVO p_objConfig)
            : this()
        {
        ...
        private void axMSComm_OnComm(object sender, EventArgs e)
        {
            ...
            if (LastReceive.Contains(MAGLUMI_X8_ControlCode.ReqCode) )
            {
                axMSComm.Output = MAGLUMI_X8_ControlCode.AckCode;
            }

            int idxStart = strTemp.IndexOf(MAGLUMI_X8_ControlCode.StartCode);
            int idxEnd = strTemp.IndexOf(MAGLUMI_X8_ControlCode.EndCode);
        ...
        private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            int idxStart2 = currData.IndexOf(MAGLUMI_X8_ControlCode.StartCode);
            int idxEnd2 = currData.IndexOf(MAGLUMI_X8_ControlCode.EndCode);
            ...
            do
            {
                ...
                idxStart2 = currData.IndexOf(MAGLUMI_X8_ControlCode.StartCode);
                idxEnd2 = currData.IndexOf(MAGLUMI_X8_ControlCode.EndCode);
