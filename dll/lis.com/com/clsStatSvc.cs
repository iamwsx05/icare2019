...
namespace com.digitalwave.iCare.middletier.LIS
{
	...
	/// clsStatSvc 的摘要说明。
	/// </summary>
	[Transaction(TransactionOption.Required,Timeout=3600)]
	[ObjectPooling(Enabled=true)]
	public class clsStatSvc : com.digitalwave.iCare.middletier.clsMiddleTierBase
	{
		#region 构造函数
		public clsStatSvc()
		{
...
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetScienceStatByCondition");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #endregion
        ...
        //    clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
        //    lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetAllWorkGroupInfo");
        //    if(lngRes < 0)
        //    {
        //        return -1;
        //    }
		...
		public long m_lngAddNewWorkGroup(clsLisWorkGroup_VO p_objRecord)
		{
			...
			com.digitalwave.iCare.middletier.HRPService.clsHRPTableService objHRPSvc = new clsHRPTableService();
			lngRes = objHRPSvc.lngGenerateID(4,"WORK_GROUP_ID_CHR","T_BSE_LIS_WORK_GROUP",out p_objRecord.m_strWORK_GROUP_ID_CHR);
			if(lngRes < 0)
				return lngRes;
			string strSQL = "INSERT INTO T_BSE_LIS_WORK_GROUP (WORK_GROUP_ID_CHR,WORK_GROUP_NO_CHR,WORK_GROUP_NAME_VCHR,PRINT_NAME_VCHR,PY_CODE_CHR,ASSIST_CODE01_CHR,WB_CODE_CHR,ASSIST_CODE02_CHR,STATUS_INT,SUMMARY_VCHR) VALUES (?,?,?,?,?,?,?,?,?,?)";
			try
			{
				System.Data.IDataParameter[] objLisAddItemRefArr = null;
				objHRPSvc.CreateDatabaseParameter(10,out objLisAddItemRefArr);
				//Please change the datetime and reocrdid 
				objLisAddItemRefArr[0].Value = p_objRecord.m_strWORK_GROUP_ID_CHR;
				objLisAddItemRefArr[1].Value = p_objRecord.m_strWORK_GROUP_NO_CHR;
				objLisAddItemRefArr[2].Value = p_objRecord.m_strWORK_GROUP_NAME_VCHR;
				objLisAddItemRefArr[3].Value = p_objRecord.m_strPRINT_NAME_VCHR;
				objLisAddItemRefArr[4].Value = p_objRecord.m_strPY_CODE_CHR;
				objLisAddItemRefArr[5].Value = p_objRecord.m_strASSIST_CODE01_CHR;
				objLisAddItemRefArr[6].Value = p_objRecord.m_strWB_CODE_CHR;
				objLisAddItemRefArr[7].Value = p_objRecord.m_strASSIST_CODE02_CHR;
				objLisAddItemRefArr[8].Value = p_objRecord.m_intSTATUS_INT;
				objLisAddItemRefArr[9].Value = p_objRecord.m_strSUMMARY_VCHR;
				long lngRecEff = -1;
				//往表增加记录
		...
		public long m_lngModifyWorkGroup(clsLisWorkGroup_VO p_objRecord)
		{
			...
			string strSQL = @"UPDATE t_bse_lis_work_group
								 SET work_group_no_chr = '"+p_objRecord.m_strWORK_GROUP_NO_CHR+@"',
									 work_group_name_vchr = '"+p_objRecord.m_strWORK_GROUP_NAME_VCHR+@"',
									 print_name_vchr = '"+p_objRecord.m_strPRINT_NAME_VCHR+@"',
									 py_code_chr = '"+p_objRecord.m_strPY_CODE_CHR+@"',
									 assist_code01_chr = '"+p_objRecord.m_strASSIST_CODE01_CHR+@"',
									 wb_code_chr = '"+p_objRecord.m_strWB_CODE_CHR+@"',
									 assist_code02_chr = '"+p_objRecord.m_strASSIST_CODE02_CHR+@"',
									 summary_vchr = '"+p_objRecord.m_strSUMMARY_VCHR+@"'
							   WHERE work_group_id_chr = '"+p_objRecord.m_strWORK_GROUP_ID_CHR+@"'";
			try
			{
				com.digitalwave.iCare.middletier.HRPService.clsHRPTableService objHRPSvc = new clsHRPTableService();
		...
		public long m_lngDelWorkGroup(string p_strWorkGroupID,string p_strStatus)
		{
			...
			string strSQL = @"UPDATE t_bse_lis_work_group
								 SET status_int = 0
							   WHERE work_group_id_chr = '"+p_strWorkGroupID+@"'";
            string strSQL2 = @"DELETE FROM t_bse_lis_stat_group_unit a
                                WHERE a.stat_group_id_chr IN (SELECT b.stat_group_id_chr
                                      FROM t_bse_lis_stat_group b
                                     WHERE b.work_group_id_chr = '" + p_strWorkGroupID + @"'";
            string strSQL3 = @"DELETE FROM t_bse_lis_stat_group a
                               WHERE a.work_group_id_chr = '" + p_strWorkGroupID + @"'";
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetAllStatGroupInfo");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetAllStatGroupUnitInfo");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #endregion
		...
		public long m_lngAddNewStatGroupBaseInfo(clsLisStatGroup_VO p_objRecord)
		{
			...
			com.digitalwave.iCare.middletier.HRPService.clsHRPTableService objHRPSvc = new clsHRPTableService();
			lngRes = objHRPSvc.lngGenerateID(6,"STAT_GROUP_ID_CHR","T_BSE_LIS_STAT_GROUP",out p_objRecord.m_strSTAT_GROUP_ID_CHR);
			if(lngRes < 0)
				return lngRes;
			string strSQL = "INSERT INTO T_BSE_LIS_STAT_GROUP (STAT_GROUP_ID_CHR,STAT_GROUP_NAME_VCHR,PRINT_NAME_VCHR,WORK_COEFFICIENT_NUM,PY_CODE_CHR,ASSIST_CODE01_CHR,WB_CODE_CHR,ASSIST_CODE02_CHR,STATUS_INT,SUMMARY_VCHR,WORK_GROUP_ID_CHR) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
			try
			{
				System.Data.IDataParameter[] objLisAddItemRefArr = null;
				objHRPSvc.CreateDatabaseParameter(11,out objLisAddItemRefArr);
				//Please change the datetime and reocrdid 
				objLisAddItemRefArr[0].Value = p_objRecord.m_strSTAT_GROUP_ID_CHR;
				objLisAddItemRefArr[1].Value = p_objRecord.m_strSTAT_GROUP_NAME_VCHR;
				objLisAddItemRefArr[2].Value = p_objRecord.m_strPRINT_NAME_VCHR;
				objLisAddItemRefArr[3].Value = p_objRecord.m_fltWORK_COEFFICIENT_NUM;
				objLisAddItemRefArr[4].Value = p_objRecord.m_strPY_CODE_CHR;
				objLisAddItemRefArr[5].Value = p_objRecord.m_strASSIST_CODE01_CHR;
				objLisAddItemRefArr[6].Value = p_objRecord.m_strWB_CODE_CHR;
				objLisAddItemRefArr[7].Value = p_objRecord.m_strASSIST_CODE02_CHR;
				objLisAddItemRefArr[8].Value = p_objRecord.m_intSTATUS_INT;
				objLisAddItemRefArr[9].Value = p_objRecord.m_strSUMMARY_VCHR;
				objLisAddItemRefArr[10].Value = p_objRecord.m_strWORK_GROUP_ID_CHR;
				long lngRecEff = -1;
				//往表增加记录
				lngRes = objHRPSvc.lngExecuteParameterSQL(strSQL,ref lngRecEff,objLisAddItemRefArr);
				objHRPSvc.Dispose();				
		...
		#region 新增统计组和申请单元的关系 
		[AutoComplete]
		public long m_lngAddNewStatGroupUnit(clsLisStatGroupUnit_VO p_objRecord)
		{
			long lngRes = 0; 

			string strSQL = "INSERT INTO T_BSE_LIS_STAT_GROUP_UNIT (STAT_GROUP_ID_CHR,APPLY_UNIT_ID_CHR) VALUES (?,?)";
			try
			{
				com.digitalwave.iCare.middletier.HRPService.clsHRPTableService objHRPSvc = new clsHRPTableService();
				System.Data.IDataParameter[] objLisAddItemRefArr = null;
				...
				//Please change the datetime and reocrdid 
				objLisAddItemRefArr[0].Value = p_objRecord.m_strSTAT_GROUP_ID_CHR;
				objLisAddItemRefArr[1].Value = p_objRecord.m_strAPPLY_UNIT_ID_CHR;
				long lngRecEff = -1;
				//往表增加记录
				lngRes = objHRPSvc.lngExecuteParameterSQL(strSQL,ref lngRecEff,objLisAddItemRefArr);
				objHRPSvc.Dispose();				
		...
		#region 新增统计组及其明细 
		[AutoComplete]
		public long m_lngAddNewStatGroup(clsLisStatGroup_VO p_objStatGroup,
			clsLisStatGroupUnit_VO[] p_objStatGroupUnitArr)
		{
			long lngRes = 0; 
			
			lngRes = m_lngAddNewStatGroupBaseInfo(p_objStatGroup);
			if(lngRes > 0)
			{
				for(int i=0;i<p_objStatGroupUnitArr.Length;i++)
				{
					p_objStatGroupUnitArr[i].m_strSTAT_GROUP_ID_CHR = p_objStatGroup.m_strSTAT_GROUP_ID_CHR;
					lngRes = m_lngAddNewStatGroupUnit(p_objStatGroupUnitArr[i]);
				}
			}
			return lngRes;
		}
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetApplUnitByStatGroupID");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//        #endregion
		...
		public long m_lngSetStatGroupBaseInfo(clsLisStatGroup_VO p_objRecord)
		{
			...
			string strSQL = @"UPDATE t_bse_lis_stat_group
								 SET stat_group_name_vchr = '"+p_objRecord.m_strSTAT_GROUP_NAME_VCHR+@"',
									 print_name_vchr = '"+p_objRecord.m_strPRINT_NAME_VCHR+@"',
									 work_coefficient_num = "+p_objRecord.m_fltWORK_COEFFICIENT_NUM+@",
									 py_code_chr = '"+p_objRecord.m_strPY_CODE_CHR+@"',
									 assist_code01_chr = '"+p_objRecord.m_strASSIST_CODE01_CHR+@"',
									 wb_code_chr = '"+p_objRecord.m_strWB_CODE_CHR+@"',
									 assist_code02_chr = '"+p_objRecord.m_strASSIST_CODE02_CHR+@"',
									 status_int = '"+p_objRecord.m_intSTATUS_INT+@"',
									 summary_vchr = '"+p_objRecord.m_strSUMMARY_VCHR+@"',
									 work_group_id_chr = '"+p_objRecord.m_strWORK_GROUP_ID_CHR+@"'
							   WHERE stat_group_id_chr = '"+p_objRecord.m_strSTAT_GROUP_ID_CHR+@"'";
			try
			{
				com.digitalwave.iCare.middletier.HRPService.clsHRPTableService objHRPSvc = new clsHRPTableService();
				lngRes = objHRPSvc.DoExcute(strSQL);
		...
		#region 根据统计组ID删除该组下的申请单元 
		[AutoComplete]
		public long m_lngDelStatGroupUnitByStatGroupID(string p_strStatGroupID)
		{
			long lngRes = 0; 

			string strSQL = @"DELETE FROM t_bse_lis_stat_group_unit
								    WHERE stat_group_id_chr = '"+p_strStatGroupID+@"'";
		...
		#region 更新统计组及明细
		[AutoComplete]
		public long m_lngModifyStatGroup(clsLisStatGroup_VO p_objStatGroup,
			clsLisStatGroupUnit_VO[] p_objStatGroupUnitArr)
		{
			long lngRes = 0; 
			...
			try
			{
				lngRes = m_lngSetStatGroupBaseInfo(p_objStatGroup);
				if(lngRes > 0)
				{
					lngRes = m_lngDelStatGroupUnitByStatGroupID(p_objStatGroup.m_strSTAT_GROUP_ID_CHR);
					if(lngRes > 0)
					{
						for(int i=0;i<p_objStatGroupUnitArr.Length;i++)
						{
		...
		public long m_lngDelStatGroup(string p_strStatGroupID)
		{
			...
			string strSQL = @"UPDATE t_bse_lis_stat_group SET status_int = 0 WHERE stat_group_id_chr = '"+p_strStatGroupID+@"'";
			try
			{
				com.digitalwave.iCare.middletier.HRPService.clsHRPTableService objHRPSvc = new clsHRPTableService();
				lngRes = objHRPSvc.DoExcute(strSQL);
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetStatTotalReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetStatDetailReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetCheckPriceTotalReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege("com.digitalwave.iCare.middletier.LIS.clsStatSvc","m_lngGetCheckPriceDetailReport");
//            if(lngRes < 0)
//            {
//                return -1;
//            }
...
//           /// <returns></returns>
//        [AutoComplete]
//        public long m_lngGetAnimalculeCheckTotal( out DataTable p_dtbResult, string strDateFrom, string strDateTo,ArrayList listSamples,ArrayList listPatientArea)
//        {
//            #region Sql语句
//            string strSQL = @"
...
//        /// <returns></returns>
//        private static string m_strConstructSql(ArrayList listSamples, ArrayList listPatientArea)
//        {
...
//            p_dtbResult = null;
//            clsPrivilegeHandleService objPrivilege = new clsPrivilegeHandleService();
//            lngRes = objPrivilege.m_lngCheckCallPrivilege( "com.digitalwave.iCare.middletier.LIS.clsStatSvc", "m_lngGetSamplesCheckTotal");
//            if (lngRes < 0)
//            {
//                return -1;
//            }
