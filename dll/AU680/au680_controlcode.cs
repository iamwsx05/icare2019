...
namespace AU680
{
    ...
    /// 定义控制代码
    /// </summary>
    public class AU680_ControlCode
    {
        /// <summary>
        /// 包起始字符 02H
        /// </summary>
        public const string StartCode = "";//"DB"; //"";

        /// <summary>
        /// 包结束字符 03H
        /// </summary>
        public const string EndCode = "";//"DE";   //"";

        public const string ReqCode = "R";  //请求起始符
        public const string ResCode = "S";  //应答起始符
        public const string ChnanelE = "E";  //通道号起始符
        public const string DataCode = "D";  //数据起始符
        ///// <summary>
        ///// 确认字符 ACK 06H
        ///// </summary>
        ...
        ///// 超时或出错字符 NAK 15H
        ///// </summary>
        //public const string NAKCode = "";
        ///// <summary>
        ///// BCC 字符
        ///// </summary>
        //public const string BCCCode = "";

        //public const string StopSampleInquiry = "SE";
        /// <summary>
        /// 每项两位
        /// </summary>
        int CheckItems = 16;
